...
index.controller("useActiveCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,e,l,o,a,r){function f(){t.btnText="一键生成海报",t.showcanvas=!0;var e=new Date,l=e.getFullYear()+"/"+(e.getMonth()+1)+"/"+e.getDate(),o=e.getMonth()+1;switch(o){case 1:o="JAN";break;case 2:o="FEB";break;case 3:o="MAR";break;case 4:o="APR";break;case 5:o="MAY";break;case 6:o="JUN";break;case 7:o="JUL";break;case 8:o="AUG";break;case 9:o="SEP";break;case 10:o="OCT";break;case 11:o="NOV";break;case 12:o="DEC"}var a=e.getDay();switch(a){case 0:a="Sunday";break;case 1:a="Monday";break;case 2:a="Tuesday";break;case 3:a="Wednesday";break;case 4:a="Thursday";break;case 5:a="Friday";break;case 6:a="Saturday"}var r=new Image;r.src=t.showImg,r.onload=function(){if(M.drawImage(r,0,0,h*u,d*u),navigator.userAgent.match(/iphone/i)){if(1==x){M.drawImage(p,.048*h*u,1142/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold "+.08*h+"px myFirstFont",M.fillStyle="#fff",M.textAlign="left";var o=Math.floor(.212*s),a=Math.floor(.5767*s),f=Math.floor(.5*s),i=Math.floor(.394*d),n=Math.floor(.3284*d);M.fillText(t.startTime,o,i),M.fillText(t.endTime,a,i),M.fillStyle="#000",M.textAlign="center",M.fillText(t.name,f,n)}else if(2==x){M.drawImage(p,.408*h*u,1152/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold "+34/750*h+"px myFirstFont",M.fillStyle="#fff",M.textAlign="center";var m=Math.floor(.5*s),c=(Math.floor(.5667*s),Math.floor(.2267*s)),g=Math.floor(.3017*s),T=Math.floor(.3767*s),y=Math.floor(.6296*s),F=Math.floor(.6996*s),w=Math.floor(.7696*s),b=Math.floor(.1147*d),v=Math.floor(.3082*d),S=Math.floor(.737*d);M.fillText(l,m,b),M.font="normal bold "+.064*h+"px myFirstFont",M.fillStyle="#000",M.fillText(t.name,m,v),M.fillText(t.startHour,c,S),M.fillText(t.startMinute,T,S),M.fillText(t.endHour,y,S),M.fillText(t.endMinute,w,S),M.fillStyle="#fff",M.fillText(":",g,S),M.fillText(":",F,S)}else if(3==x){M.drawImage(p,.408*h*u,1114/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold "+.064*h+"px myFirstFont",M.fillStyle="#000",M.textAlign="center";var I=(Math.floor(.5*s),Math.floor(.5667*s),Math.floor(.2267*s)),A=Math.floor(.3017*s),$=Math.floor(.3767*s),P=Math.floor(.6296*s),k=Math.floor(.6996*s),D=Math.floor(.7696*s),O=(Math.floor(.1147*d),Math.floor(.3082*d),Math.floor(.802*d));M.fillText(t.startHour,I,O),M.fillText(t.startMinute,$,O),M.fillText(t.endHour,P,O),M.fillText(t.endMinute,D,O),M.fillText(":",A,O),M.fillText(":",k,O)}else if(4==x){M.drawImage(p,64/750*h*u,1126/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold "+.048*h+"px myFirstFont",M.fillStyle="#fff";var H=Math.floor(.747*s),R=Math.floor(.922*d);M.fillText(t.name,H,R)}else if(5==x){M.drawImage(p,.408*h*u,1110/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold "+.096*h+"px myFirstFont",M.fillStyle="#244678",M.textAlign="left";var B=Math.floor(.2693*s),E=Math.floor(.522*s),U=Math.floor(.69*s),C=Math.floor(.3355*d),J=Math.floor(.4669*d),L=Math.floor(.616*d),N=Math.floor(.701*d);M.fillText(t.startMonth,B,C),M.fillText(t.startDate,E,C),M.fillText(t.endMonth,B,J),M.fillText(t.endDate,E,J),M.textAlign="center",M.fillStyle="#fff",M.fillText(t.colorPrice,U,L),M.fillText(t.permPrice,U,N)}else if(6==x){M.drawImage(p,52/750*h*u,1130/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold "+.06*h+"px myFirstFont",M.fillStyle="#fff",M.textAlign="right";var Y=Math.floor(.951*s),j=Math.floor(.244*d);M.fillText(t.name,Y,j)}else if(7==x){M.drawImage(p,.408*h*u,1143/1334*d*u,14/75*h*u,14/75*h*u);var W=e.getDate()+"/"+(e.getMonth()+1)+"/"+e.getFullYear();M.font="normal bold "+.064*h+"px myFirstFont",M.fillStyle="#000",M.textAlign="center";var q=Math.floor(.5*s),z=Math.floor(.6587*d);M.fillText(W,q,z)}else if(8==x){M.drawImage(p,.408*h*u,1136/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold "+.4*h+"px myFirstFont",M.fillStyle="#af0008",M.textAlign="center";var G=Math.floor(.5*s),V=Math.floor(.7261*d);M.fillText(t.day,G,V)}else if(9==x){M.drawImage(p,.408*h*u,1109/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold "+.064*h+"px myFirstFont",M.fillStyle="#000",M.textAlign="center";var _=Math.floor(.51*s),K=Math.floor(.509*d),Q=Math.floor(.589*d);M.fillText(t.colorPrice,_,K),M.fillText(t.permPrice,_,Q)}else if(10==x){M.drawImage(p,.408*h*u,1148/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold "+.064*h+"px myFirstFont",M.fillStyle="#000",M.textAlign="center";var X=Math.floor(.5*s),Z=Math.floor(.14*s),tt=Math.floor(.7364*d),et=Math.floor(.8052*d);M.fillText(t.name,X,tt),M.font="normal bold "+.096*h+"px myFirstFont",M.fillStyle="#324ee9",M.textAlign="left",M.fillText(t.startDate,Z,et)}}else if(1==x){M.drawImage(p,.048*h*u,1142/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold 0.8rem myFirstFont",M.fillStyle="#fff",M.textAlign="left";var lt=Math.floor(.212*s),ot=Math.floor(.5767*s),at=Math.floor(.5*s),rt=Math.floor(.394*d),ft=Math.floor(.3284*d);M.fillText(t.startTime,lt,rt),M.fillText(t.endTime,ot,rt),M.fillStyle="#000",M.textAlign="center",M.fillText(t.name,at,ft)}else if(2==x){M.drawImage(p,.408*h*u,1152/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold 0.453333rem myFirstFont",M.fillStyle="#fff",M.textAlign="center";var it=Math.floor(.5*s),nt=(Math.floor(.5667*s),Math.floor(.2267*s)),mt=Math.floor(.3017*s),st=Math.floor(.3767*s),ht=Math.floor(.6296*s),dt=Math.floor(.6996*s),xt=Math.floor(.7696*s),Mt=Math.floor(.1147*d),ct=Math.floor(.3082*d),ut=Math.floor(.737*d);M.fillText(l,it,Mt),M.font="normal bold 0.533333rem myFirstFont",M.fillStyle="#000",M.fillText(t.name,it,ct),M.fillText(t.startHour,nt,ut),M.fillText(t.startMinute,st,ut),M.fillText(t.endHour,ht,ut),M.fillText(t.endMinute,xt,ut),M.fillStyle="#fff",M.fillText(":",mt,ut),M.fillText(":",dt,ut)}else if(3==x){M.drawImage(p,.408*h*u,1114/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold 0.64rem myFirstFont",M.fillStyle="#000",M.textAlign="center";var gt=(Math.floor(.5*s),Math.floor(.5667*s),Math.floor(.2267*s)),Tt=Math.floor(.3017*s),yt=Math.floor(.3767*s),pt=Math.floor(.6296*s),Ft=Math.floor(.6996*s),wt=Math.floor(.7696*s),bt=(Math.floor(.1147*d),Math.floor(.3082*d),Math.floor(.802*d));M.fillText(t.startHour,gt,bt),M.fillText(t.startMinute,yt,bt),M.fillText(t.endHour,pt,bt),M.fillText(t.endMinute,wt,bt),M.fillText(":",Tt,bt),M.fillText(":",Ft,bt)}else if(4==x){M.drawImage(p,64/750*h*u,1126/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold 0.48rem myFirstFont",M.fillStyle="#fff";var vt=Math.floor(.747*s),St=Math.floor(.922*d);M.fillText(t.name,vt,St)}else if(5==x){M.drawImage(p,.408*h*u,1110/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold 0.96rem myFirstFont",M.fillStyle="#244678",M.textAlign="left";var It=Math.floor(.2693*s),At=Math.floor(.522*s),$t=Math.floor(.69*s),Pt=Math.floor(.3355*d),kt=Math.floor(.4669*d),Dt=Math.floor(.616*d),Ot=Math.floor(.701*d);M.fillText(t.startMonth,It,Pt),M.fillText(t.startDate,At,Pt),M.fillText(t.endMonth,It,kt),M.fillText(t.endDate,At,kt),M.textAlign="center",M.fillStyle="#fff",M.fillText(t.colorPrice,$t,Dt),M.fillText(t.permPrice,$t,Ot)}else if(6==x){M.drawImage(p,52/750*h*u,1130/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold 0.6rem myFirstFont",M.fillStyle="#fff",M.textAlign="right";var Ht=Math.floor(.951*s),Rt=Math.floor(.244*d);M.fillText(t.name,Ht,Rt)}else if(7==x){M.drawImage(p,.408*h*u,1143/1334*d*u,14/75*h*u,14/75*h*u);var Bt=e.getDate()+"/"+(e.getMonth()+1)+"/"+e.getFullYear();M.font="normal bold 0.6rem myFirstFont",M.fillStyle="#000",M.textAlign="center";var Et=Math.floor(.5*s),Ut=Math.floor(.6587*d);M.fillText(Bt,Et,Ut)}else if(8==x){M.drawImage(p,.408*h*u,1136/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold 4.0rem myFirstFont",M.fillStyle="#af0008",M.textAlign="center";var Ct=Math.floor(.5*s),Jt=Math.floor(.7261*d);M.fillText(t.day,Ct,Jt)}else if(9==x){M.drawImage(p,.408*h*u,1109/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold 0.64rem myFirstFont",M.fillStyle="#000",M.textAlign="center";var Lt=Math.floor(.51*s),Nt=Math.floor(.509*d),Yt=Math.floor(.589*d);M.fillText(t.colorPrice,Lt,Nt),M.fillText(t.permPrice,Lt,Yt)}else if(10==x){M.drawImage(p,.408*h*u,1148/1334*d*u,14/75*h*u,14/75*h*u),M.font="normal bold 0.64rem myFirstFont",M.fillStyle="#000",M.textAlign="center";var jt=Math.floor(.5*s),Wt=Math.floor(.14*s),qt=Math.floor(.7364*d),zt=Math.floor(.8052*d);M.fillText(t.name,jt,qt),M.font="normal bold 0.96rem myFirstFont",M.fillStyle="#324ee9",M.textAlign="left",M.fillText(t.startDate,Wt,zt)}}}function i(t){return document.getElementById(t).getContext("2d")}function n(){t.showcanvas=!1;var e=document.getElementById("main"),l=e.toDataURL("image/jpeg",.7);t.canvasImg=l,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var m=JSON.parse(sessionStorage.getItem("user"));t.fastuse=!0,t.user=m,t.btnText="一键生成海报",t.loading=!1,t.showcanvas=!0,t.showmodel=!1,t.canvasImg="",t.name="请添加",t.startTime="13:00",t.endTime="18:00",t.startHour="13",t.startMinute="00",t.endHour="18",t.endMinute="00",t.startMonth="05",t.startDate="01",t.endMonth="05",t.endDate="15",t.colorPrice="88",t.permPrice="88",t.day="2";var s=document.documentElement.clientWidth,h=Math.floor(s),d=Math.floor(1.83*s);$("#main").attr("width",h+"px"),$("#main").attr("height",d+"px"),console.log(t.user);var x=r.num;t.page=1,t.showImg="../../assets/images/notice/type6/img_"+x+".png",t.editInformation=function(t){t.stopPropagation(),o.path("editInformation")},t.useTemplatePage=function(e){e.stopPropagation(),n(),t.showmodel=!0,t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(t){t.stopPropagation(),l.history.back()},t.chengeText=function(){if(t.fastuse=!0,t.name="",t.startTime="",t.endTime="",t.startHour="",t.startMinute="",t.endHour="",t.endMinute="",t.startMonth="",t.startDate="",t.endMonth="",t.endDate="",t.colorPrice="",t.permPrice="",t.day="",!t.showmodel)if(1==x)$(".name-input-fixed").show();else if(2==x)$(".name-input-fixed-1").show();else if(3==x)$(".name-input-fixed-2").show();else if(4==x)$(".name-input-fixed-3").show();else if(5==x)$(".name-input-fixed-4").show();else if(6==x)$(".name-input-fixed-5").show();else{if(7==x)return t.fastuse=!1,void f();8==x?$(".name-input-fixed-7").show():9==x?$(".name-input-fixed-8").show():10==x?$(".name-input-fixed-9").show():11==x&&$(".name-input-fixed-10").show()}},t.updateText=function(){f(),1==x?$(".name-input-fixed").fadeOut(50):2==x?$(".name-input-fixed-1").fadeOut(50):3==x?$(".name-input-fixed-2").fadeOut(50):4==x?$(".name-input-fixed-3").fadeOut(50):5==x?$(".name-input-fixed-4").fadeOut(50):6==x?$(".name-input-fixed-5").fadeOut(50):7==x?$(".name-input-fixed-6").fadeOut(50):8==x?$(".name-input-fixed-7").fadeOut(50):9==x?$(".name-input-fixed-8").fadeOut(50):10==x?$(".name-input-fixed-9").fadeOut(50):11==x&&$(".name-input-fixed-10").fadeOut(50),t.fastuse=!1},t.closeText=function(e){e.stopPropagation(),t.user.iscomplete=!0};var M=i("main");M.width=h,M.height=d;var c=function(t){var e=t.backingStorePixelRatio||t.webkitBackingStorePixelRatio||t.mozBackingStorePixelRatio||t.msBackingStorePixelRatio||t.oBackingStorePixelRatio||t.backingStorePixelRatio||1;return(window.devicePixelRatio||1)/e},u=c(M);$(function(){f()});var g=$(".hideImg").qrcode({width:200,height:200,correctLevel:0,text:"http://syrapi.yueyishujia.com/yueAssistant/build/html/homePage/"+t.user.uuid}).hide(),T=g.find("canvas").get(0),y=T.toDataURL("image/jpg"),p=new Image;p.src=y}]);
...
index.controller("useMornCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,e,l,o,a,r){function n(){t.btnText="立即使用",t.showcanvas=!0;var e=new Date,l=e.getFullYear()+"/"+(e.getMonth()+1)+"/"+e.getDate(),o=e.getMonth()+1;switch(o){case 1:o="J A N";break;case 2:o="F E B";break;case 3:o="M A R";break;case 4:o="A P R";break;case 5:o="M A Y";break;case 6:o="J U N";break;case 7:o="J U L";break;case 8:o="A U G";break;case 9:o="S E P";break;case 10:o="O C T";break;case 11:o="N O V";break;case 12:o="D E C"}var a=e.getDay();switch(a){case 0:a="S U N D A Y";break;case 1:a="M O N D A Y";break;case 2:a="T U E S D A Y";break;case 3:a="W E D N E S D A Y";break;case 4:a="T H U R S D A Y";break;case 5:a="F R I D A Y";break;case 6:a="S A T U R D A Y"}var r=new Image;r.src=t.showImg,r.onload=function(){if(b.drawImage(r,0,0,h*u,c*u),navigator.userAgent.match(/iphone/i)){if(1==x){b.font="normal bold "+.048*h+"px myFirstFont",b.fillStyle="black",b.textAlign="right";var n=Math.floor(.744*m),i=Math.floor(.95*c);b.fillText("BY"+t.user.name,n,i)}else if(2==x){b.font="normal bold "+.04*h+"px myFirstFont",b.fillStyle="black";var f=Math.floor(.07*m),s=Math.floor(.906*c),M=Math.floor(.943*c);b.fillText("BY"+t.user.name,f,s),b.fillText(l,f,M)}else if(3==x){b.font="normal bold "+100/750*h+"px myFirstFont",b.fillStyle="white";var g=Math.floor(.103*m),T=Math.floor(.87*c),F=Math.floor(.91*c),y=Math.floor(.947*c);b.fillText(e.getDate(),g,T),b.font="normal bold "+.04*h+"px myFirstFont",b.fillText(o+"."+a,g,F),b.fillText("BY"+t.user.name,g,y)}else if(4==x){b.font="normal bold "+34/750*h+"px myFirstFont",b.fillStyle="black",b.textAlign="right";var d=Math.floor(.924*m),v=Math.floor(.145*c),k=Math.floor(.184*c),S=Math.floor(.223*c);b.fillText(l,d,v),b.fillText(a,d,k),b.fillText("BY"+t.user.name,d,S)}else if(5==x){b.font="normal bold "+34/750*h+"px myFirstFont",b.fillStyle="#7a8776",b.textAlign="right";var Y=Math.floor(.933*m),p=Math.floor(.736*c);b.fillText("BY"+t.user.name,Y,p)}else if(6==x){b.font="normal bold "+34/750*h+"px myFirstFont",b.fillStyle="#fff";var B=Math.floor(.047*m),w=Math.floor(.915*c);b.fillText("BY"+t.user.name,B,w)}else if(7==x){b.font="normal bold "+.04*h+"px myFirstFont",b.fillStyle="#000";var A=Math.floor(.07*m),D=Math.floor(.856*c),R=Math.floor(.883*c),I=Math.floor(.91*c);b.fillText(l,A,D),b.fillText(a,A,R),b.fillText("BY"+t.user.name,A,I)}else if(8==x){b.font="normal bold "+100/750*h+"px myFirstFont",b.fillStyle="#96bfad";var P=Math.floor(.07*m),E=Math.floor(.106*c),$=Math.floor(.146*c),U=Math.floor(.186*c);b.fillText(e.getDate(),P,E),b.font="normal bold "+.04*h+"px myFirstFont",b.fillText(a,P,$),b.fillText("BY"+t.user.name,P,U)}}else if(1==x){b.font="normal bold 0.48rem myFirstFont",b.fillStyle="black";var N=Math.floor(.544*m),C=Math.floor(.95*c);b.fillText("BY"+t.user.name,N,C)}else if(2==x){b.font="normal bold 0.4rem myFirstFont",b.fillStyle="black";var J=Math.floor(.07*m),O=Math.floor(.906*c),L=Math.floor(.943*c);b.fillText("BY"+t.user.name,J,O),b.fillText(l,J,L)}else if(3==x){b.font="normal bold 1.333333rem myFirstFont",b.fillStyle="white";var W=Math.floor(.103*m),j=Math.floor(.87*c),z=Math.floor(.91*c),G=Math.floor(.947*c);b.fillText(e.getDate(),W,j),b.font="normal bold 0.4rem myFirstFont",b.fillText(o+"."+a,W,z),b.fillText("BY"+t.user.name,W,G)}else if(4==x){b.font="normal bold 0.453333rem myFirstFont",b.fillStyle="black",b.textAlign="right";var H=Math.floor(.924*m),V=Math.floor(.145*c),_=Math.floor(.184*c),q=Math.floor(.223*c);b.fillText(l,H,V),b.fillText(a,H,_),b.fillText("BY"+t.user.name,H,q)}else if(5==x){b.font="normal bold 0.453333rem myFirstFont",b.fillStyle="#7a8776",b.textAlign="right";var K=Math.floor(.933*m),Q=Math.floor(.736*c);b.fillText("BY"+t.user.name,K,Q)}else if(6==x){b.font="normal bold 0.46rem myFirstFont",b.fillStyle="#fff";var X=Math.floor(.047*m),Z=Math.floor(.915*c);b.fillText("BY"+t.user.name,X,Z)}else if(7==x){b.font="normal bold 0.4rem myFirstFont",b.fillStyle="#000";var tt=Math.floor(.07*m),et=Math.floor(.856*c),lt=Math.floor(.883*c),ot=Math.floor(.91*c);b.fillText(l,tt,et),b.fillText(a,tt,lt),b.fillText("BY"+t.user.name,tt,ot)}else if(8==x){b.font="normal bold 1.333333rem myFirstFont",b.fillStyle="#96bfad";var at=Math.floor(.07*m),rt=Math.floor(.106*c),nt=Math.floor(.146*c),it=Math.floor(.186*c);b.fillText(e.getDate(),at,rt),b.font="normal bold 0.4rem myFirstFont",b.fillText(a,at,nt),b.fillText("BY"+t.user.name,at,it)}}}function i(t){return document.getElementById(t).getContext("2d")}function f(){t.showcanvas=!1;var e=document.getElementById("main"),l=e.toDataURL("image/jpeg",.7);t.canvasImg=l,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var s=JSON.parse(sessionStorage.getItem("user"));t.user=s,t.btnText="立即使用",t.loading=!1,t.showcanvas=!0,t.canvasImg="";var m=document.documentElement.clientWidth,h=Math.floor(m),c=Math.floor(1.83*m);$("#main").attr("width",h+"px"),$("#main").attr("height",c+"px"),console.log(t.user),t.user.name.length>=4&&(t.user.name=t.user.name[0]+t.user.name[1]+t.user.name[2]+t.user.name[3]);var x=r.type,M=r.num;t.showImg="../../assets/images/morning/type"+x+"/img_"+M+".png",t.editInformation=function(){o.path("editInformation")},t.useTemplatePage=function(){f(),t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(){l.history.back()},t.closeText=function(){t.user.iscomplete=!0};var b=i("main");b.width=h,b.height=c;var g=function(t){var e=t.backingStorePixelRatio||t.webkitBackingStorePixelRatio||t.mozBackingStorePixelRatio||t.msBackingStorePixelRatio||t.oBackingStorePixelRatio||t.backingStorePixelRatio||1;return(window.devicePixelRatio||1)/e},u=g(b);$(function(){n()})}]);
index.controller("useNightCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,l,o,e,a,r){function f(){t.btnText="立即使用",t.showcanvas=!0;var l=new Date,o=l.getFullYear()+"/"+(l.getMonth()+1)+"/"+l.getDate(),e=l.getMonth()+1;switch(e){case 1:e="J A N";break;case 2:e="F E B";break;case 3:e="M A R";break;case 4:e="A P R";break;case 5:e="M A Y";break;case 6:e="J U N";break;case 7:e="J U L";break;case 8:e="A U G";break;case 9:e="S E P";break;case 10:e="O C T";break;case 11:e="N O V";break;case 12:e="D E C"}var a=l.getDay();switch(a){case 0:a="Sunday";break;case 1:a="Monday";break;case 2:a="Tuesday";break;case 3:a="Wednesday";break;case 4:a="Thursday";break;case 5:a="Friday";break;case 6:a="Saturday"}var r=new Image;r.src=t.showImg,r.onload=function(){if(u.drawImage(r,0,0,m*c,M*c),navigator.userAgent.match(/iphone/i)){if(1==x){u.font="normal bold "+.032*m+"px myFirstFont",u.fillStyle="#545454";var f=Math.floor(.07*s),i=Math.floor(.866*M),n=Math.floor(.897*M),h=Math.floor(.923*M);u.fillText(t.user.name,f,i),u.fillText(e+"."+a,f,n),u.fillText(o,f,h)}else if(2==x){u.font="normal bold "+.032*m+"px myFirstFont",u.fillStyle="#fff";for(var g=Math.floor(.625*s),T=Math.floor(.826*s),y=Math.floor(.716*M),F=Math.floor(.88*M),d=Math.floor(.92*M),b=0;b<t.user.name.length;b++)u.fillText(t.user.name[b],T,y+Math.floor(.0437*M)*b);u.fillText(e+"."+a,g,F),u.fillText(o,g,d)}else if(3==x){u.font="normal bold "+.032*m+"px myFirstFont",u.fillStyle="white";var v=Math.floor(.066*s),S=Math.floor(.8*s),k=Math.floor(.076*M),p=Math.floor(.105*M),w=Math.floor(.329*M);u.fillText(l.getMonth()+1+"/"+l.getDate(),v,k),u.fillText(a,v,p);for(var D=0;D<t.user.name.length;D++)u.fillText(t.user.name[D],S,w+Math.floor(.0437*M)*D)}else if(4==x){u.font="normal bold "+100/750*m+"px myFirstFont",u.fillStyle="white";var I=Math.floor(.103*s),P=Math.floor(.8*s),B=Math.floor(.87*M),R=Math.floor(.91*M),Y=Math.floor(.947*M),$=Math.floor(.329*M);u.fillText(l.getDate(),I,B),u.font="normal bold "+.032*m+"px myFirstFont",u.fillText(e+"."+a,I,R),u.fillText(l.getFullYear(),I,Y);for(var A=0;A<t.user.name.length;A++)u.fillText(t.user.name[A],P,$+Math.floor(.0437*M)*A)}else if(5==x){u.font="normal bold "+.032*m+"px myFirstFont",u.fillStyle="#545454";var E=Math.floor(.103*s),N=Math.floor(.8*s),C=Math.floor(.9*M),J=Math.floor(.94*M),U=Math.floor(.329*M);u.fillText(e+"."+a,E,C),u.fillText(o,E,J),u.fillStyle="#fff";for(var O=0;O<t.user.name.length;O++)u.fillText(t.user.name[O],N,U+Math.floor(.0437*M)*O)}else if(6==x){u.font="normal bold "+124/750*m+"px myFirstFont",u.fillStyle="#fff";var L=Math.floor(.07*s),W=Math.floor(.479*s),j=Math.floor(.106*M),z=Math.floor(.146*M),G=Math.floor(.186*M),V=Math.floor(.434*M);u.fillText(l.getDate(),L,j),u.font="normal bold "+.032*m+"px myFirstFont",u.fillText(e+"."+a,L,z),u.fillText(l.getFullYear(),L,G);for(var _=0;_<t.user.name.length;_++)u.fillText(t.user.name[_],W,V+Math.floor(.0437*M)*_)}else if(7==x){u.font="normal bold "+.032*m+"px myFirstFont",u.fillStyle="#545454";var q=Math.floor(.066*s),H=Math.floor(.059*M),K=Math.floor(.088*M);u.fillText(e+"."+a,q,H),u.fillText(o,q,K)}else if(8==x){u.font="normal bold "+124/750*m+"px myFirstFont",u.fillStyle="#1b273";var Q=Math.floor(.08*s),X=Math.floor(.146*M),Z=Math.floor(.186*M),tt=Math.floor(.226*M),lt=Math.floor(.9078*M);u.fillText(l.getDate(),Q,X),u.font="normal bold "+.032*m+"px myFirstFont",u.fillText(e+"."+a,Q,Z),u.fillText(l.getFullYear(),Q,tt),u.fillStyle="#535353",u.fillText("BY"+t.user.name,Q,lt)}}else if(1==x){u.font="normal bold 0.32rem myFirstFont",u.fillStyle="#545454";var ot=Math.floor(.07*s),et=Math.floor(.866*M),at=Math.floor(.897*M),rt=Math.floor(.923*M);u.fillText(t.user.name,ot,et),u.fillText(e+"."+a,ot,at),u.fillText(o,ot,rt)}else if(2==x){u.font="normal bold 0.4rem myFirstFont",u.fillStyle="#fff";for(var ft=Math.floor(.625*s),it=Math.floor(.826*s),nt=Math.floor(.716*M),ht=Math.floor(.88*M),st=Math.floor(.92*M),mt=0;mt<t.user.name.length;mt++)u.fillText(t.user.name[mt],it,nt+Math.floor(.0437*M)*mt);u.fillText(e+"."+a,ft,ht),u.fillText(o,ft,st)}else if(3==x){u.font="normal bold 0.42rem myFirstFont",u.fillStyle="white";var Mt=Math.floor(.066*s),xt=Math.floor(.8*s),gt=Math.floor(.076*M),ut=Math.floor(.105*M),Tt=Math.floor(.329*M);u.fillText(l.getMonth()+1+"/"+l.getDate(),Mt,gt),u.fillText(a,Mt,ut);for(var ct=0;ct<t.user.name.length;ct++)u.fillText(t.user.name[ct],xt,Tt+Math.floor(.0437*M)*ct)}else if(4==x){u.font="normal bold 1.333333rem myFirstFont",u.fillStyle="white";var yt=Math.floor(.103*s),Ft=Math.floor(.8*s),dt=Math.floor(.87*M),bt=Math.floor(.91*M),vt=Math.floor(.947*M),St=Math.floor(.329*M);u.fillText(l.getDate(),yt,dt),u.font="normal bold 0.4rem myFirstFont",u.fillText(e+"."+a,yt,bt),u.fillText(l.getFullYear(),yt,vt);for(var kt=0;kt<t.user.name.length;kt++)u.fillText(t.user.name[kt],Ft,St+Math.floor(.0437*M)*kt)}else if(5==x){u.font="normal bold 0.453333rem myFirstFont",u.fillStyle="#545454";var pt=Math.floor(.103*s),wt=Math.floor(.8*s),Dt=Math.floor(.9*M),It=Math.floor(.94*M),Pt=Math.floor(.329*M);u.fillText(e+"."+a,pt,Dt),u.fillText(o,pt,It),u.fillStyle="#fff";for(var Bt=0;Bt<t.user.name.length;Bt++)u.fillText(t.user.name[Bt],wt,Pt+Math.floor(.0437*M)*Bt)}else if(6==x){u.font="normal bold 1.653333rem myFirstFont",u.fillStyle="#fff";var Rt=Math.floor(.07*s),Yt=Math.floor(.479*s),$t=Math.floor(.106*M),At=Math.floor(.146*M),Et=Math.floor(.186*M),Nt=Math.floor(.434*M);u.fillText(l.getDate(),Rt,$t),u.font="normal bold 0.4rem myFirstFont",u.fillText(e+"."+a,Rt,At),u.fillText(l.getFullYear(),Rt,Et);for(var Ct=0;Ct<t.user.name.length;Ct++)u.fillText(t.user.name[Ct],Yt,Nt+Math.floor(.0437*M)*Ct)}else if(7==x){u.font="normal bold 0.42rem myFirstFont",u.fillStyle="#545454";var Jt=Math.floor(.066*s),Ut=Math.floor(.059*M),Ot=Math.floor(.088*M);u.fillText(e+"."+a,Jt,Ut),u.fillText(o,Jt,Ot)}else if(8==x){u.font="normal bold 1.653333rem myFirstFont",u.fillStyle="#1b273";var Lt=Math.floor(.08*s),Wt=Math.floor(.146*M),jt=Math.floor(.186*M),zt=Math.floor(.226*M),Gt=Math.floor(.9078*M);u.fillText(l.getDate(),Lt,Wt),u.font="normal bold 0.4rem myFirstFont",u.fillText(e+"."+a,Lt,jt),u.fillText(l.getFullYear(),Lt,zt),u.fillStyle="#535353",u.fillText("BY"+t.user.name,Lt,Gt)}}}function i(t){return document.getElementById(t).getContext("2d")}function n(){t.showcanvas=!1;var l=document.getElementById("main"),o=l.toDataURL("image/jpeg",.7);t.canvasImg=o,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var h=JSON.parse(sessionStorage.getItem("user"));t.user=h,t.btnText="立即使用",t.loading=!1,t.showcanvas=!0,t.canvasImg="";var s=document.documentElement.clientWidth,m=Math.floor(s),M=Math.floor(1.83*s);$("#main").attr("width",m+"px"),$("#main").attr("height",M+"px"),console.log(t.user);var x=r.type,g=r.num;t.page=1,t.showImg="../../assets/images/goodnight/type"+x+"/img_"+g+".png",t.editInformation=function(){e.path("editInformation")},t.useTemplatePage=function(){n(),t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(){o.history.back()},t.closeText=function(){t.user.iscomplete=!0};var u=i("main");u.width=m,u.height=M;var T=function(t){var l=t.backingStorePixelRatio||t.webkitBackingStorePixelRatio||t.mozBackingStorePixelRatio||t.msBackingStorePixelRatio||t.oBackingStorePixelRatio||t.backingStorePixelRatio||1;return(window.devicePixelRatio||1)/l},c=T(u);$(function(){f()})}]);
index.controller("useNoticeCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,o,l,e,a,i){function f(){t.btnText="一键生成海报",t.showcanvas=!0;var o=new Date,l=o.getFullYear()+"/"+(o.getMonth()+1)+"/"+o.getDate(),e=o.getMonth()+1;switch(e){case 1:e="JAN";break;case 2:e="FEB";break;case 3:e="MAR";break;case 4:e="APR";break;case 5:e="MAY";break;case 6:e="JUN";break;case 7:e="JUL";break;case 8:e="AUG";break;case 9:e="SEP";break;case 10:e="OCT";break;case 11:e="NOV";break;case 12:e="DEC"}var a=o.getDay();switch(a){case 0:a="Sunday";break;case 1:a="Monday";break;case 2:a="Tuesday";break;case 3:a="Wednesday";break;case 4:a="Thursday";break;case 5:a="Friday";break;case 6:a="Saturday"}var i=new Image;i.src=t.showImg,i.onload=function(){if(y.drawImage(i,0,0,h*b,d*b),navigator.userAgent.match(/iphone/i)){if(1==x){y.font="normal bold "+.048*h+"px myFirstFont",y.fillStyle="#fff";var o=Math.floor(.1133*s),f=Math.floor(.88*d),r=Math.floor(.91*d),n=Math.floor(.94*d);y.fillText(t.name,o,f),y.font="normal bold "+.032*h+"px myFirstFont",y.fillText(e+"."+a,o,r),y.fillText(l,o,n)}else if(2==x&&1==M){y.drawImage(T,8/75*h*b,1106/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold "+.048*h+"px myFirstFont",y.fillStyle="#fff";var m=Math.floor(.5733*s),u=Math.floor(.704*s),F=Math.floor(.3999*d),c=Math.floor(.6372*d),g=Math.floor(.6672*d),p=Math.floor(.6972*d);y.fillText(t.zhekou,m,F),y.fillStyle="#333",y.fillText(t.name,u,c),y.font="normal bold "+.032*h+"px myFirstFont",y.fillText(e+"."+a,u,g),y.fillText(l,u,p)}else if(2==x&&2==M){y.drawImage(T,.744*h*b,1120/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold "+.04*h+"px myFirstFont",y.fillStyle="#333";var w=Math.floor(.3673*s),S=Math.floor(.211*s),v=Math.floor(.6567*d),I=Math.floor(.8685*d),k=Math.floor(.8985*d),$=Math.floor(.9285*d);y.fillText(t.lijian,w,v),y.font="normal bold "+.048*h+"px myFirstFont",y.fillStyle="#fff",y.fillText(t.name,S,I),y.font="normal bold "+.032*h+"px myFirstFont",y.fillStyle="#333",y.fillText(e+"."+a,S,k),y.fillText(l,S,$)}else if(3==x&&1==M){y.drawImage(T,.74*h*b,1119/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold "+100/750*h+"px myFirstFont",y.fillStyle="#b8742b";var P=Math.floor(.1917*s),O=Math.floor(.5803*s),R=Math.floor(.113*s),D=Math.floor(.608*d),B=Math.floor(.8785*d),j=Math.floor(.9085*d),A=Math.floor(.9385*d);y.fillText(t.starttime,P,D),y.fillText(t.endtime,O,D),y.font="normal bold "+.048*h+"px myFirstFont",y.fillStyle="#333",y.fillText(t.name,R,B),y.font="normal bold "+.032*h+"px myFirstFont",y.fillText(e+"."+a,R,j),y.fillText(l,R,A)}else if(3==x&&2==M){y.drawImage(T,.408*h*b,786/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold "+.064*h+"px myFirstFont",y.fillStyle="#fff";var E=Math.floor(.246*s),z=Math.floor(.5667*s),N=Math.floor(.113*s),U=Math.floor(.463*d),C=Math.floor(.8785*d),J=Math.floor(.9085*d),L=Math.floor(.9385*d);y.fillText(t.starttime1,E,U),y.fillText(t.endtime1,z,U),y.font="normal bold "+.048*h+"px myFirstFont",y.fillText(t.name,N,C),y.font="normal bold "+.032*h+"px myFirstFont",y.fillText(e+"."+a,N,J),y.fillText(l,N,L)}else if(4==x&&1==M){y.drawImage(T,.408*h*b,1079/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold "+.064*h+"px myFirstFont",y.fillStyle="#000";var _=Math.floor(.347*s),W=Math.floor(.58*d);y.fillText(t.discount,_,W)}else if(4==x&&2==M){y.drawImage(T,.408*h*b,1090/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold "+100/750*h+"px myFirstFont",y.fillStyle="#f02964";var Y=Math.floor(.246*s),q=Math.floor(.236*s),G=Math.floor(.5373*s),V=Math.floor(.422*d),H=Math.floor(.6808*d);y.fillText(t.discount,Y,V),y.font="normal bold "+.048*h+"px myFirstFont",y.fillStyle="#333",y.fillText(t.starttime2,q,H),y.fillText(t.endtime2,G,H)}else if(5==x&&1==M){y.drawImage(T,550/750*h*b,1110/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold "+100/750*h+"px myFirstFont",y.fillStyle="#000";var K=Math.floor(.1426*s),Q=Math.floor(.6013*s),X=Math.floor(.31*s),Z=Math.floor(.1333*s),tt=Math.floor(.4764*d),ot=Math.floor(.7869*d),lt=(Math.floor(.7669*d),Math.floor(.89*d)),et=Math.floor(.92*d),at=Math.floor(.95*d);y.fillText(t.starttime3,K,tt),y.fillText(t.endtime3,Q,tt),y.font="normal bold "+.048*h+"px myFirstFont",y.fillStyle="#fb5b64",y.fillText(t.business,X,ot),y.fillStyle="#333",y.fillText(t.name,Z,lt),y.font="normal bold "+.032*h+"px myFirstFont",y.fillText(e+"."+a,Z,et),y.fillText(l,Z,at)}else if(5==x&&2==M){y.drawImage(T,551/750*h*b,1111/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold "+.04*h+"px myFirstFont",y.fillStyle="#f6c33b";var it=Math.floor(.298*s),ft=Math.floor(.415*s),rt=Math.floor(.1333*s),nt=Math.floor(.801*d),mt=Math.floor(.89*d),st=Math.floor(.92*d),ht=Math.floor(.95*d);y.fillText(t.businessMonth,it,nt),y.fillText(t.businessDate,ft,nt),y.fillStyle="#333",y.fillText(t.name,rt,mt),y.font="normal bold "+.032*h+"px myFirstFont",y.fillText(e+"."+a,rt,st),y.fillText(l,rt,ht)}}else if(1==x){y.font="normal bold 0.48rem myFirstFont",y.fillStyle="#fff";var dt=Math.floor(.1133*s),xt=Math.floor(.88*d),Mt=Math.floor(.91*d),yt=Math.floor(.94*d);y.fillText(t.name,dt,xt),y.font="normal bold 0.32rem myFirstFont",y.fillText(e+"."+a,dt,Mt),y.fillText(l,dt,yt)}else if(2==x&&1==M){y.drawImage(T,8/75*h*b,1106/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold 0.48rem myFirstFont",y.fillStyle="#fff";var ut=Math.floor(.5733*s),bt=Math.floor(.704*s),Ft=Math.floor(.3999*d),ct=Math.floor(.6372*d),gt=Math.floor(.6672*d),Tt=Math.floor(.6972*d);y.fillText(t.zhekou,ut,Ft),y.fillStyle="#333",y.fillText(t.name,bt,ct),y.font="normal bold 0.32rem myFirstFont",y.fillText(e+"."+a,bt,gt),y.fillText(l,bt,Tt)}else if(2==x&&2==M){y.drawImage(T,.744*h*b,1120/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold 0.4rem myFirstFont",y.fillStyle="#333";var pt=Math.floor(.3673*s),wt=Math.floor(.211*s),St=Math.floor(.6567*d),vt=Math.floor(.8685*d),It=Math.floor(.8985*d),kt=Math.floor(.9285*d);y.fillText(t.lijian,pt,St),y.font="normal bold 0.48rem myFirstFont",y.fillStyle="#fff",y.fillText(t.name,wt,vt),y.font="normal bold 0.32rem myFirstFont",y.fillStyle="#333",y.fillText(e+"."+a,wt,It),y.fillText(l,wt,kt)}else if(3==x&&1==M){y.drawImage(T,.74*h*b,1119/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold 1.133333rem myFirstFont",y.fillStyle="#b8742b";var $t=Math.floor(.2017*s),Pt=Math.floor(.5803*s),Ot=Math.floor(.113*s),Rt=Math.floor(.608*d),Dt=Math.floor(.8785*d),Bt=Math.floor(.9085*d),jt=Math.floor(.9385*d);y.fillText(t.starttime,$t,Rt),y.fillText(t.endtime,Pt,Rt),y.font="normal bold 0.48rem myFirstFont",y.fillStyle="#333",y.fillText(t.name,Ot,Dt),y.font="normal bold 0.32rem myFirstFont",y.fillText(e+"."+a,Ot,Bt),y.fillText(l,Ot,jt)}else if(3==x&&2==M){y.drawImage(T,.408*h*b,786/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold 0.64rem myFirstFont",y.fillStyle="#fff";var At=Math.floor(.246*s),Et=Math.floor(.5667*s),zt=Math.floor(.113*s),Nt=Math.floor(.463*d),Ut=Math.floor(.8785*d),Ct=Math.floor(.9085*d),Jt=Math.floor(.9385*d);y.fillText(t.starttime1,At,Nt),y.fillText(t.endtime1,Et,Nt),y.font="normal bold 0.48rem myFirstFont",y.fillText(t.name,zt,Ut),y.font="normal bold 0.32rem myFirstFont",y.fillText(e+"."+a,zt,Ct),y.fillText(l,zt,Jt)}else if(4==x&&1==M){y.drawImage(T,.408*h*b,1079/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold 0.64rem myFirstFont",y.fillStyle="#000";var Lt=Math.floor(.347*s),_t=Math.floor(.58*d);y.fillText(t.discount,Lt,_t)}else if(4==x&&2==M){y.drawImage(T,.408*h*b,1090/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold 1.333333rem myFirstFont",y.fillStyle="#f02964";var Wt=Math.floor(.246*s),Yt=Math.floor(.236*s),qt=Math.floor(.5373*s),Gt=Math.floor(.422*d),Vt=Math.floor(.6808*d);y.fillText(t.discount,Wt,Gt),y.font="normal bold 0.48rem myFirstFont",y.fillStyle="#333",y.fillText(t.starttime2,Yt,Vt),y.fillText(t.endtime2,qt,Vt)}else if(5==x&&1==M){y.drawImage(T,550/750*h*b,1110/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold 1.333333rem myFirstFont",y.fillStyle="#000";var Ht=Math.floor(.1426*s),Kt=Math.floor(.6013*s),Qt=Math.floor(.31*s),Xt=Math.floor(.1333*s),Zt=Math.floor(.4764*d),to=Math.floor(.7869*d),oo=(Math.floor(.7669*d),Math.floor(.89*d)),lo=Math.floor(.92*d),eo=Math.floor(.95*d);y.fillText(t.starttime3,Ht,Zt),y.fillText(t.endtime3,Kt,Zt),y.font="normal bold 0.48rem myFirstFont",y.fillStyle="#fb5b64",y.fillText(t.business,Qt,to),y.fillStyle="#333",y.fillText(t.name,Xt,oo),y.font="normal bold 0.32rem myFirstFont",y.fillText(e+"."+a,Xt,lo),y.fillText(l,Xt,eo)}else if(5==x&&2==M){y.drawImage(T,551/750*h*b,1111/1334*d*b,14/75*h*b,14/75*h*b),y.font="normal bold 0.48rem myFirstFont",y.fillStyle="#f6c33b";var ao=Math.floor(.298*s),io=Math.floor(.415*s),fo=Math.floor(.1333*s),ro=Math.floor(.801*d),no=Math.floor(.89*d),mo=Math.floor(.92*d),so=Math.floor(.95*d);y.fillText(t.businessMonth,ao,ro),y.fillText(t.businessDate,io,ro),y.fillStyle="#333",y.fillText(t.name,fo,no),y.font="normal bold 0.32rem myFirstFont",y.fillText(e+"."+a,fo,mo),y.fillText(l,fo,so)}}}function r(t){return document.getElementById(t).getContext("2d")}function n(){t.showcanvas=!1;var o=document.getElementById("main"),l=o.toDataURL("image/jpeg",.7);t.canvasImg=l,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var m=JSON.parse(sessionStorage.getItem("user"));t.fastuse=!0,t.user=m,t.btnText="一键生成海报",t.loading=!1,t.showcanvas=!0,t.showmodel=!1,t.canvasImg="",t.name="请添加",t.zhekou="八",t.lijian="000",t.starttime="08",t.endtime="24",t.starttime1="08:00",t.endtime1="24:00",t.starttime2="2017.05.01",t.endtime2="2017.05.05",t.starttime3="01",t.endtime3="05",t.discount="00",t.business="06",t.businessMonth="05",t.businessDate="01";var s=document.documentElement.clientWidth,h=Math.floor(s),d=Math.floor(1.83*s);$("#main").attr("width",h+"px"),$("#main").attr("height",d+"px"),console.log(t.user);var x=i.type,M=i.num;t.page=1,t.showImg="../../assets/images/notice/type"+x+"/img_"+M+".png",t.editInformation=function(t){t.stopPropagation(),e.path("editInformation")},t.useTemplatePage=function(o){o.stopPropagation(),n(),t.showmodel=!0,t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(t){t.stopPropagation(),l.history.back()},t.chengeText=function(){t.fastuse=!0,t.name="",t.zhekou="",t.lijian="",t.starttime="",t.endtime="",t.starttime1="",t.endtime1="",t.starttime2="",t.endtime2="",t.starttime3="",t.endtime3="",t.discount="",t.business="",t.businessMonth="",t.businessDate="",t.showmodel||(1==x?$(".name-input-fixed").show():2==x&&1==M?$(".name-input-fixed-1").show():2==x&&2==M?$(".name-input-fixed-2").show():3==x&&1==M?$(".name-input-fixed-3").show():3==x&&2==M?$(".name-input-fixed-4").show():4==x&&1==M?$(".name-input-fixed-5").show():4==x&&2==M?$(".name-input-fixed-6").show():5==x&&1==M?$(".name-input-fixed-7").show():5==x&&2==M&&$(".name-input-fixed-8").show())},t.updateText=function(){f(),1==x?$(".name-input-fixed").fadeOut(50):2==x&&1==M?$(".name-input-fixed-1").fadeOut(50):2==x&&2==M?$(".name-input-fixed-2").fadeOut(50):3==x&&1==M?$(".name-input-fixed-3").fadeOut(50):3==x&&2==M?$(".name-input-fixed-4").fadeOut(50):4==x&&1==M?$(".name-input-fixed-5").fadeOut(50):4==x&&2==M?$(".name-input-fixed-6").fadeOut(50):5==x&&1==M?$(".name-input-fixed-7").fadeOut(50):5==x&&2==M&&$(".name-input-fixed-8").fadeOut(50),t.fastuse=!1},t.closeText=function(o){o.stopPropagation(),t.user.iscomplete=!0},t.changeImg=function(o){o.stopPropagation(),t.loading=!0,t.showmodel=!1,t.page>=2?(t.page=1,t.showImg="../../assets/images/notice/type"+M+"/img_"+t.page+".png",t.loading=!1):(t.page+=1,t.showImg="../../assets/images/notice/type"+M+"/img_"+t.page+".png",t.loading=!1),f()};var y=r("main");y.width=h,y.height=d;var u=function(t){var o=t.backingStorePixelRatio||t.webkitBackingStorePixelRatio||t.mozBackingStorePixelRatio||t.msBackingStorePixelRatio||t.oBackingStorePixelRatio||t.backingStorePixelRatio||1;return(window.devicePixelRatio||1)/o},b=u(y);$(function(){f()});var F=$(".hideImg").qrcode({width:200,height:200,correctLevel:0,text:"http://syrapi.yueyishujia.com/yueAssistant/build/html/homePage/"+t.user.uuid}).hide(),c=F.find("canvas").get(0),g=c.toDataURL("image/jpg"),T=new Image;T.src=g}]);
index.controller("useGreetCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,e,o,a,i,n){function l(){t.btnText="一键生成海报",t.showcanvas=!0;var e=new Image;e.src=t.showImg,e.onload=function(){if(u.drawImage(e,0,0,c*p,d*p),navigator.userAgent.match(/iphone/i))if(1==h&&1==g){u.font="normal bold "+.096*c+"px myFirstFont",u.fillStyle="#fff";var o=Math.floor(.066*m),a=Math.floor(.1466*m),i=Math.floor(.145*d),n=Math.floor(.349*d);u.fillText(t.title,o,i),u.font="normal bold "+.04*c+"px myFirstFont",u.fillStyle="#0f0f0b",u.fillText(t.desc,a,n)}else if(1==h&&2==g){u.font="normal bold "+.04*c+"px myFirstFont",u.fillStyle="#fff";var l=Math.floor(.586*m),r=Math.floor(.731*d),f=Math.floor(.6848*d),s=Math.floor(.638*d);u.fillText(t.desc3,l,r),u.fillText(t.desc2,l,f),u.fillText(t.desc1,l,s)}else 3==h&&1==g?u.drawImage(M,.096*c*p,1099/1334*d*p,14/75*c*p,14/75*c*p):3==h&&2==g&&u.drawImage(M,.408*c*p,1099/1334*d*p,14/75*c*p,14/75*c*p);else if(1==h&&1==g){u.font="normal bold 0.96rem myFirstFont",u.fillStyle="#fff";var x=Math.floor(.066*m),w=Math.floor(.1466*m),v=Math.floor(.145*d),y=Math.floor(.349*d);u.fillText(t.title,x,v),u.font="normal bold 0.4rem myFirstFont",u.fillStyle="#0f0f0b",u.fillText(t.desc,w,y)}else if(1==h&&2==g){u.font="normal bold 0.4rem myFirstFont",u.fillStyle="#fff";var T=Math.floor(.586*m),b=Math.floor(.731*d),I=Math.floor(.6848*d),S=Math.floor(.638*d);u.fillText(t.desc3,T,b),u.fillText(t.desc2,T,I),u.fillText(t.desc1,T,S)}else 3==h&&1==g?u.drawImage(M,.096*c*p,1099/1334*d*p,14/75*c*p,14/75*c*p):3==h&&2==g&&u.drawImage(M,.408*c*p,1099/1334*d*p,14/75*c*p,14/75*c*p)}}function r(t){return document.getElementById(t).getContext("2d")}function f(){t.showcanvas=!1;var e=document.getElementById("main"),o=e.toDataURL("image/jpeg",.7);t.canvasImg=o,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var s=JSON.parse(sessionStorage.getItem("user"));t.user=s,t.btnText="一键生成海报",t.loading=!1,t.showcanvas=!0,t.showmodel=!1,t.canvasImg="",t.title="点击添加标题",t.desc="点击添加海报描述",t.desc1="点击添加海报描述",t.desc2="点击添加海报描述",t.desc3="点击添加海报描述";var m=document.documentElement.clientWidth,c=Math.floor(m),d=Math.floor(1.83*m);$("#main").attr("width",c+"px"),$("#main").attr("height",d+"px"),console.log(t.user);var h=n.type,g=n.num;t.page=1,t.showImg="../../assets/images/greet/type"+h+"/img_"+g+".png",t.editInformation=function(t){t.stopPropagation(),a.path("editInformation")},t.useTemplatePage=function(e){e.stopPropagation(),f(),t.showmodel=!0,t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(t){t.stopPropagation(),o.history.back()},t.chengeText=function(){t.showmodel||(1==h&&1==g?$(".name-input-fixed-1").show():1==h&&2==g&&$(".name-input-fixed-2").show())},t.updateText=function(){l(),1==h&&1==g?$(".name-input-fixed-1").fadeOut(50):1==h&&2==g&&$(".name-input-fixed-2").fadeOut(50)},t.closeText=function(e){e.stopPropagation(),t.user.iscomplete=!0};var u=r("main");u.width=c,u.height=d;var x=function(t){var e=t.backingStorePixelRatio||t.webkitBackingStorePixelRatio||t.mozBackingStorePixelRatio||t.msBackingStorePixelRatio||t.oBackingStorePixelRatio||t.backingStorePixelRatio||1;return(window.devicePixelRatio||1)/e},p=x(u);$(function(){l()});var w=$(".hideImg").qrcode({width:200,height:200,correctLevel:0,text:"http://syrapi.yueyishujia.com/yueAssistant/build/html/homePage/"+t.user.uuid}).hide(),v=w.find("canvas").get(0),y=v.toDataURL("image/jpg"),M=new Image;M.src=y}]);
