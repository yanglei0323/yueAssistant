...
index.controller("holidayCtrl",["$scope","$http","$window","$location","$rootScope",function(a,t,e,o,c){a.activeTab=1,c.activeTabMorn&&(a.activeTab=c.activeTabMorn),a.changeTab=function(t){switch(a.activeTab=t,t){case 1:c.activeTabMorn=1;break;case 2:c.activeTabMorn=2}},a.useMornTemplate=function(a){o.path("holidayList/"+a)},a.useNightTemplate=function(a){o.path("useGreet/"+a)}}]);
index.controller("holidayListCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(o,t,i,a,e,s){var n=s.num;o.imgList=[];for(var r=1;3>r;r++)o.imgList.push("../../assets/images/holiday/type"+n+"/img_"+r+".png");o.useMornTemplate=function(o){a.path("useHoliday/"+n+"/"+o)}}]);
