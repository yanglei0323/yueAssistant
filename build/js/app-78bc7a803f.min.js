...
index.controller("chooseQrcodeCtrl",["$scope","$http","$window","$location","$rootScope",function(a,e,t,o,s){function r(){return 0===a.localId.length?(alert("请选择图片!"),!1):void wx.uploadImage({localId:a.localId[0],isShowProgressTips:1,success:function(t){a.serverId=t.serverId;var o={qrcodemediaid:a.serverId};e.post("/user/edit.json",o,postCfg).then(function(e){if(1===e.data.code){var t=e.data.data;""===t.avatar?t.avatar="../../assets/images/head-none.png":t.avatar=picBasePath+t.avatar,t.qrcode=picBasePath+t.qrcode,a.user=t,sessionStorage.setItem("user",JSON.stringify(d))}else alert(e.data.reason)},function(a){alert("数据请求失败，请稍后再试！")})},fail:function(a){alert("上传失败！")}})}var n={url:t.location.href.split("#")[0]};e.post("/user/unl/wzinfo.json",n,postCfg).then(function(a){1===a.data.code&&wx.config({debug:!0,appId:a.data.data.appid,timestamp:a.data.data.timestamp,nonceStr:a.data.data.noncestr,signature:a.data.data.signature,jsApiList:["chooseImage","uploadImage"]})},function(a){});var d=JSON.parse(sessionStorage.getItem("user"));""===d.qrcode?d.qrcode="../../assets/images/edit-headimg.png":d.qrcode=picBasePath+d.qrcode,a.user=d,a.addPhoto=function(){wx.chooseImage({count:1,sizeType:["original","compressed"],sourceType:["album","camera"],success:function(e){return a.localId=e.localIds,0===a.localId.length?(alert("请选择图片!"),!1):void r()}})},a.upload=function(){alert("二维码上传成功"),t.history.back()}}]);
