...
index.controller("promotionCtrl",["$scope","$http","$window","$location","$rootScope",function(a,e,t,c,i){var o=JSON.parse(sessionStorage.getItem("user"));a.user=o,a.activeTab=1,i.activeTab&&(a.activeTab=i.activeTab),a.loading=!1,a.changeTab=function(e){switch(a.activeTab=e,e){case 1:i.activeTab=1;break;case 2:i.activeTab=2;break;case 3:i.activeTab=3}},a.changeHomePage=function(a){i.activeTab=1,c.path("changeHomePage/"+a)},a.useTemplate=function(a){i.activeTab=3,c.path("wechatCircle/"+a)},a.useCard=function(e){i.activeTab=2,window.location.href="../template/card/index.html?num="+e+"&uuid="+a.user.uuid}}]);
