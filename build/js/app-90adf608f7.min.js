...
index.controller("fastLoginCtrl",["$scope","$http","$window","$location","$interval","$timeout",function(e,o,t,n,a,i){function d(){return s.test(e.phone)?r.test(e.code)?1:(e.modalText="验证码输入错误",$(".prompt-container").show().fadeOut(2e3),-1):(e.modalText="手机号码有误！",$(".prompt-container").show().fadeOut(2e3),-1)}var s=/^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|18[0|1|2|3|5|6|7|8|9])\d{8}$/,r=/^\d{4}$/;e.sendCodeText="获取验证码",e.modalText="",e.getCode=function(){return e.sending?void 0:s.test(e.phone)?void o.post("/user/unl/sendlogin.json",{telephone:e.phone},postCfg).then(function(o){if(console.log(o),1===o.data.code){e.sending=!0;var t=60,n=a(function(){t>0?e.sendCodeText="重新发送("+t--+")":(e.sendCodeText="发送验证码",e.sending=!1,a.cancel(n))},1e3)}},function(e){}):(e.modalText="手机号码有误！",void $(".prompt-container").show().fadeOut(2e3))},e.confirmLogin=function(){if(console.log("点击事件执行"),-1!==d()){var t={telephone:e.phone,check:e.code,uuid:e.uuid};o.post("/user/unl/bindtelephone.json",t,postCfg).then(function(o){if(1===o.data.code){var t=o.data.data;sessionStorage.setItem("user",JSON.stringify(t)),i(function(){window.location.href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx45618195d7038b9d&redirect_uri=http://syrapi.yueyishujia.com/yueAssistant/build/html/&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect"})}else 0===o.data.code?(e.modalText=o.data.reason,$(".prompt-container").show().fadeOut(2e3)):(e.modalText=o.data.reason,$(".prompt-container").show().fadeOut(2e3))},function(e){alert(e.data.reason)})}}}]);
