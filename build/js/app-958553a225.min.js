...
index.controller("homeCtrl",["$scope","$http","$window","$location","$rootScope",function(e,t,o,a,n){document.title="小悦助手",t.post("/user/mine.json",postCfg).then(function(t){if(console.log(t),-1===t.data.code)e.isLogin=!1;else if(1===t.data.code){e.isLogin=!0;var o=t.data.data;""===o.avatar?o.avatar="../../assets/images/head-none.png":o.avatar=picBasePath+o.avatar,e.user=o,sessionStorage.setItem("user",JSON.stringify(o))}},function(e){}),e.personalCenter=function(){a.path("personalCenter")},e.setIn=function(){},e.vipCenter=function(){a.path("vipCenter")},e.showTemplate=function(t){if(e.user.iscomplete===!1)return void $(".prompt-fixed").show();switch(t){case 1:a.path("morningNight");break;case 2:a.path("guest");break;case 3:a.path("notice");break;case 4:a.path("promotion");break;case 5:a.path("holiday");break;case 6:a.path("joke");break;case 7:a.path("life")}},e.goHomePage=function(){return e.user.iscomplete===!1?void $(".prompt-fixed").show():void(window.location.href="/yueAssistant/build/html/homePage/"+e.user.uuid)},e.promptFalse=function(){$(".prompt-fixed").fadeOut(10)},e.promptTrue=function(){$(".prompt-fixed").fadeOut(),a.path("editInformation")}}]);
...
index.controller("monListCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(i,s,t,o,n,r){var e=r.num,u=JSON.parse(sessionStorage.getItem("user"));i.user=u,i.imgList=[],i.imgSunList=[];for(var m=5,g=1;m+1>g;g++)i.imgSunList.push("../../assets/images/morning/type"+e+"/img_"+g+".png");i.useMornTemplate=function(i){o.path("useMorn/"+e+"/"+i)};var a=10;if(m>=a)for(var p=0;a>p;p++)i.imgList.push(i.imgSunList[p]);else{a=m;for(var L=0;a>L;L++)i.imgList.push(i.imgSunList[L])}$(window).bind("scroll",function(s){var t=$(document).scrollTop(),o=$(document).height()-$(window).height();if(t>=o-10){if(a>=m)return;if(a+=10,i.imgList=[],m>=a)for(var n=0;a>n;n++)i.imgList.push(i.imgSunList[n]);else{a=m;for(var r=0;a>r;r++)i.imgList.push(i.imgSunList[r])}}})}]);
...
index.controller("nightListCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(i,t,s,o,n,r){var e=r.num;i.imgList=[],i.imgSunList=[];for(var g=5,u=1;g+1>u;u++)i.imgSunList.push("../../assets/images/goodnight/type"+e+"/img_"+u+".png");i.useMornTemplate=function(i){o.path("useNight/"+e+"/"+i)};var m=10;if(g>=m)for(var a=0;m>a;a++)i.imgList.push(i.imgSunList[a]);else{m=g;for(var h=0;m>h;h++)i.imgList.push(i.imgSunList[h])}$(window).bind("scroll",function(t){var s=$(document).scrollTop(),o=$(document).height()-$(window).height();if(s>=o-10){if(m>=g)return;if(m+=10,i.imgList=[],g>=m)for(var n=0;m>n;n++)i.imgList.push(i.imgSunList[n]);else{m=g;for(var r=0;m>r;r++)i.imgList.push(i.imgSunList[r])}}})}]);
...
index.controller("noticeListCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,o,e,i,n,s){var a=s.num;t.imgList=[];for(var r=1;5>r;r++)t.imgList.push("../../assets/images/notice/sample/type"+a+"/img_"+r+".png");t.useMornTemplate=function(t){i.path("useNotice/"+a+"/"+t)}}]);
...
index.controller("useActiveCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,e,l,o,a,r){function f(){t.btnText="一键生成海报",t.showcanvas=!0;var e=new Date,l=e.getFullYear()+"/"+(e.getMonth()+1)+"/"+e.getDate(),o=e.getMonth()+1;switch(o){case 1:o="JAN";break;case 2:o="FEB";break;case 3:o="MAR";break;case 4:o="APR";break;case 5:o="MAY";break;case 6:o="JUN";break;case 7:o="JUL";break;case 8:o="AUG";break;case 9:o="SEP";break;case 10:o="OCT";break;case 11:o="NOV";break;case 12:o="DEC"}var a=e.getDay();switch(a){case 0:a="Sunday";break;case 1:a="Monday";break;case 2:a="Tuesday";break;case 3:a="Wednesday";break;case 4:a="Thursday";break;case 5:a="Friday";break;case 6:a="Saturday"}var r=new Image;r.src=t.showImg,r.onload=function(){if(u.drawImage(r,0,0,2*m,2*h),1==d){u.drawImage(g,.048*m*2,1142/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.08*m*2+"px myFirstFont",u.fillStyle="#fff",u.textAlign="left";var o=Math.floor(.212*s*2),a=Math.floor(.5767*s*2),f=Math.floor(.5*s*2),i=Math.floor(.394*h*2),n=Math.floor(.3284*h*2);u.fillText(t.startTime,o,i),u.fillText(t.endTime,a,i),u.fillStyle="#000",u.textAlign="center",u.fillText(t.name,f,n)}else if(2==d){u.drawImage(g,.408*m*2,1152/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+34/750*m*2+"px myFirstFont",u.fillStyle="#fff",u.textAlign="center";var x=Math.floor(.5*s*2),M=(Math.floor(.5667*s*2),Math.floor(.2267*s*2)),c=Math.floor(.3017*s*2),p=Math.floor(.3767*s*2),y=Math.floor(.6296*s*2),T=Math.floor(.6996*s*2),F=Math.floor(.7696*s*2),w=Math.floor(.1147*h*2),b=Math.floor(.3082*h*2),v=Math.floor(.737*h*2);u.fillText(l,x,w),u.font="normal bold "+.064*m*2+"px myFirstFont",u.fillStyle="#000",u.fillText(t.name,x,b),u.fillText(t.startHour,M,v),u.fillText(t.startMinute,p,v),u.fillText(t.endHour,y,v),u.fillText(t.endMinute,F,v),u.fillStyle="#fff",u.fillText(":",c,v),u.fillText(":",T,v)}else if(3==d){u.drawImage(g,.408*m*2,1114/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.064*m*2+"px myFirstFont",u.fillStyle="#000",u.textAlign="center";var $=(Math.floor(.5*s*2),Math.floor(.5667*s*2),Math.floor(.2267*s*2)),I=Math.floor(.3017*s*2),S=Math.floor(.3767*s*2),A=Math.floor(.6296*s*2),P=Math.floor(.6996*s*2),k=Math.floor(.7696*s*2),O=(Math.floor(.1147*h*2),Math.floor(.3082*h*2),Math.floor(.802*h*2));u.fillText(t.startHour,$,O),u.fillText(t.startMinute,S,O),u.fillText(t.endHour,A,O),u.fillText(t.endMinute,k,O),u.fillText(":",I,O),u.fillText(":",P,O)}else if(4==d){u.drawImage(g,64/750*m*2,1126/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.048*m*2+"px myFirstFont",u.fillStyle="#fff";var D=Math.floor(.747*s*2),B=Math.floor(.922*h*2);u.fillText(t.name,D,B)}else if(5==d){u.drawImage(g,.408*m*2,1110/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.096*m*2+"px myFirstFont",u.fillStyle="#244678",u.textAlign="left";var Y=Math.floor(.2693*s*2),j=Math.floor(.522*s*2),H=Math.floor(.69*s*2),E=Math.floor(.3355*h*2),U=Math.floor(.4669*h*2),C=Math.floor(.616*h*2),J=Math.floor(.701*h*2);u.fillText(t.startMonth,Y,E),u.fillText(t.startDate,j,E),u.fillText(t.endMonth,Y,U),u.fillText(t.endDate,j,U),u.textAlign="center",u.fillStyle="#fff",u.fillText(t.colorPrice,H,C),u.fillText(t.permPrice,H,J)}else if(6==d){u.drawImage(g,52/750*m*2,1130/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.06*m*2+"px myFirstFont",u.fillStyle="#fff",u.textAlign="right";var L=Math.floor(.951*s*2),N=Math.floor(.244*h*2);u.fillText(t.name,L,N)}else if(7==d){u.drawImage(g,.408*m*2,1143/1334*h*2,14/75*m*2,14/75*m*2);var R=e.getDate()+"/"+(e.getMonth()+1)+"/"+e.getFullYear();u.font="normal bold "+.064*m*2+"px myFirstFont",u.fillStyle="#000",u.textAlign="center";var W=Math.floor(.5*s*2),q=Math.floor(.6587*h*2);u.fillText(R,W,q)}else if(8==d){u.drawImage(g,.408*m*2,1136/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.4*m*2+"px myFirstFont",u.fillStyle="#af0008",u.textAlign="center";var G=Math.floor(.5*s*2),V=Math.floor(.7261*h*2);u.fillText(t.day,G,V)}else if(9==d){u.drawImage(g,.408*m*2,1109/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.064*m*2+"px myFirstFont",u.fillStyle="#000",u.textAlign="center";var _=Math.floor(.51*s*2),z=Math.floor(.509*h*2),K=Math.floor(.589*h*2);u.fillText(t.colorPrice,_,z),u.fillText(t.permPrice,_,K)}else if(10==d){u.drawImage(g,.408*m*2,1148/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.064*m*2+"px myFirstFont",u.fillStyle="#000",u.textAlign="center";var Q=Math.floor(.5*s*2),X=Math.floor(.14*s*2),Z=Math.floor(.7364*h*2),tt=Math.floor(.8052*h*2);u.fillText(t.name,Q,Z),u.font="normal bold "+.096*m*2+"px myFirstFont",u.fillStyle="#324ee9",u.textAlign="left",u.fillText(t.startDate,X,tt)}else if(11==d){u.drawImage(g,.408*m*2,1102/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.048*m*2+"px myFirstFont",u.fillStyle="#000",u.textAlign="center";var et=Math.floor(.5*s*2),lt=Math.floor(.6027*s*2),ot=Math.floor(.7991*h*2),at=Math.floor(.6937*h*2);u.fillText("BY"+t.user.name,et,ot),u.font="normal bold "+.096*m*2+"px myFirstFont",u.fillStyle="#fff",u.fillText(t.permPrice,lt,at)}else if(12==d){u.drawImage(g,.408*m*2,1082/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.048*m*2+"px myFirstFont",u.fillStyle="#fff",u.textAlign="center";var rt=Math.floor(.5*s*2),ft=Math.floor(.7771*h*2);u.fillText("BY"+t.user.name,rt,ft)}else if(13==d){u.drawImage(g,.752*m*2,1082/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.048*m*2+"px myFirstFont",u.fillStyle="#494949";var it=Math.floor(.064*s*2),nt=Math.floor(.933*h*2);u.fillText("BY"+t.user.name,it,nt)}else if(14==d){u.drawImage(g,.408*m*2,1140/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.048*m*2+"px myFirstFont",u.fillStyle="#9a7060";var st=Math.floor(.0533*s*2),mt=Math.floor(.041*h*2);u.fillText("BY"+t.user.name,st,mt)}else if(15==d){u.drawImage(g,.408*m*2,1140/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.048*m*2+"px myFirstFont",u.fillStyle="#404156",u.textAlign="center";var ht=Math.floor(.5*s*2),dt=Math.floor(.8326*h*2);u.fillText("BY"+t.user.name,ht,dt)}else if(16==d){u.drawImage(g,.408*m*2,1130/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.048*m*2+"px myFirstFont",u.fillStyle="#000",u.textAlign="left";var xt=Math.floor(.0667*s*2),ut=Math.floor(.3973*s*2),Mt=Math.floor(.9675*h*2),ct=Math.floor(.7846*h*2);u.fillText("BY"+t.user.name,xt,Mt),u.font="normal bold "+.2*m*2+"px myFirstFont",u.textAlign="center",u.fillText(t.permPrice,ut,ct)}else if(17==d){u.drawImage(g,538/750*m*2,1098/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.048*m*2+"px myFirstFont",u.fillStyle="#000";var pt=Math.floor(.112*s*2),gt=Math.floor(.128*s*2),yt=Math.floor(.5267*h*2),Tt=Math.floor(.8551*h*2),Ft=Math.floor(.8901*h*2),wt=Math.floor(.9201*h*2);u.fillText("BY"+t.user.name,pt,yt),u.fillText(t.shujia1,gt,Tt),u.fillText(t.shujia2,gt,Ft),u.fillText(t.shujia3,gt,wt)}else if(18==d){u.drawImage(g,52/750*m*2,1120/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.048*m*2+"px myFirstFont",u.fillStyle="#fff",u.textAlign="left";var bt=Math.floor(.0827*s*2),vt=Math.floor(.736*s*2),$t=Math.floor(.3708*h*2),It=Math.floor(.8786*h*2),St=Math.floor(.9586*h*2);u.fillText("BY"+t.user.name,bt,$t),u.textAlign="center",u.font="normal bold "+58/750*m*2+"px myFirstFont",u.fillText(t.colorPrice,vt,It),u.fillText(t.permPrice,vt,St)}else if(19==d){u.drawImage(g,554/750*m*2,1118/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.048*m*2+"px myFirstFont",u.fillStyle="#fff",u.textAlign="left";var At=Math.floor(.064*s*2),Pt=Math.floor(.266*s*2),kt=Math.floor(.348*s*2),Ot=Math.floor(.963*h*2),Dt=Math.floor(.8651*h*2),Bt=Math.floor(.9036*h*2);u.fillText("BY"+t.user.name,At,Ot),u.font="normal bold "+.064*m*2+"px myFirstFont",u.fillText(t.startMonth,At,Dt),u.textAlign="center",u.font="normal bold "+.064*m*2+"px myFirstFont",u.fillText(t.startDate,Pt,Dt),u.font="normal bold "+.048*m*2+"px myFirstFont",u.fillText(t.permPrice,kt,Bt)}else if(20==d){u.drawImage(g,574/750*m*2,1144/1334*h*2,14/75*m*2,14/75*m*2),u.font="normal bold "+.048*m*2+"px myFirstFont",u.fillStyle="#000",u.textAlign="left";var Yt=Math.floor(.5973*s*2),jt=Math.floor(.0965*h*2);u.fillText("BY"+t.user.name,Yt,jt)}}}function i(){t.showcanvas=!1;var e=document.getElementById("main"),l=e.toDataURL("image/jpeg",.7);t.canvasImg=l,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var n=JSON.parse(sessionStorage.getItem("user"));t.fastuse=!0,t.user=n,t.btnText="一键生成海报",t.loading=!1,t.showcanvas=!0,t.showmodel=!1,t.canvasImg="",t.name="请添加",t.startTime="13:00",t.endTime="18:00",t.startHour="13",t.startMinute="00",t.endHour="18",t.endMinute="00",t.startMonth="05",t.startDate="01",t.endMonth="05",t.endDate="15",t.colorPrice="88",t.permPrice="88",t.shujia1="暑假期间凭高考证xx折",t.shujia2="暑假期间凭高考证xx折",t.shujia3="暑假期间凭高考证xx折",t.day="2";var s=document.documentElement.clientWidth,m=Math.floor(s),h=Math.floor(1.83*s);$("#main").css("width",m+"px"),$("#main").css("height",h+"px"),console.log(t.user);var d=r.num;t.page=1,t.showImg="../../assets/images/notice/type6/img_"+d+".png",t.editInformation=function(t){t.stopPropagation(),o.path("editInformation")},t.useTemplatePage=function(e){e.stopPropagation(),i(),t.showmodel=!0,t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(t){t.stopPropagation(),l.history.back()},t.chengeText=function(){if(t.fastuse=!0,t.name="",t.startTime="",t.endTime="",t.startHour="",t.startMinute="",t.endHour="",t.endMinute="",t.startMonth="",t.startDate="",t.endMonth="",t.endDate="",t.colorPrice="",t.permPrice="",t.shujia1="",t.shujia2="",t.shujia3="",t.day="",!t.showmodel)if(1==d)$(".name-input-fixed").show();else if(2==d)$(".name-input-fixed-1").show();else if(3==d)$(".name-input-fixed-2").show();else if(4==d)$(".name-input-fixed-3").show();else if(5==d)$(".name-input-fixed-4").show();else if(6==d)$(".name-input-fixed-5").show();else{if(7==d)return t.fastuse=!1,void f();8==d?$(".name-input-fixed-7").show():9==d?$(".name-input-fixed-8").show():10==d?$(".name-input-fixed-9").show():11==d?$(".name-input-fixed-10").show():16==d?$(".name-input-fixed-10").show():17==d?$(".name-input-fixed-11").show():18==d?$(".name-input-fixed-8").show():19==d?$(".name-input-fixed-12").show():(i(),t.fastuse=!1,t.showmodel=!0,t.btnText="长按保存至手机，再发到朋友圈炫耀")}},t.updateText=function(){f(),1==d?$(".name-input-fixed").fadeOut(50):2==d?$(".name-input-fixed-1").fadeOut(50):3==d?$(".name-input-fixed-2").fadeOut(50):4==d?$(".name-input-fixed-3").fadeOut(50):5==d?$(".name-input-fixed-4").fadeOut(50):6==d?$(".name-input-fixed-5").fadeOut(50):7==d?$(".name-input-fixed-6").fadeOut(50):8==d?$(".name-input-fixed-7").fadeOut(50):9==d?$(".name-input-fixed-8").fadeOut(50):10==d?$(".name-input-fixed-9").fadeOut(50):11==d?$(".name-input-fixed-10").fadeOut(50):16==d?$(".name-input-fixed-10").fadeOut(50):17==d?$(".name-input-fixed-11").fadeOut(50):18==d?$(".name-input-fixed-8").fadeOut(50):19==d&&$(".name-input-fixed-12").fadeOut(50),t.fastuse=!1},t.closeText=function(e){e.stopPropagation(),t.user.iscomplete=!0};var x=document.getElementById("main"),u=x.getContext("2d");x.width=2*m,x.height=2*h,$(function(){f()});var M=$(".hideImg").qrcode({width:200,height:200,correctLevel:0,text:"http://syrapi.yueyishujia.com/yueAssistant/build/html/homePage/"+t.user.uuid}).hide(),c=M.find("canvas").get(0),p=c.toDataURL("image/jpg"),g=new Image;g.src=p}]);
...
index.controller("useMornCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,l,o,e,a,r){function f(){t.btnText="立即使用",t.showcanvas=!0;var l=new Date,o=l.getFullYear()+"/"+(l.getMonth()+1)+"/"+l.getDate(),e=l.getMonth()+1;switch(e){case 1:e="J A N";break;case 2:e="F E B";break;case 3:e="M A R";break;case 4:e="A P R";break;case 5:e="M A Y";break;case 6:e="J U N";break;case 7:e="J U L";break;case 8:e="A U G";break;case 9:e="S E P";break;case 10:e="O C T";break;case 11:e="N O V";break;case 12:e="D E C"}var a=l.getDay();switch(a){case 0:a="S U N D A Y";break;case 1:a="M O N D A Y";break;case 2:a="T U E S D A Y";break;case 3:a="W E D N E S D A Y";break;case 4:a="T H U R S D A Y";break;case 5:a="F R I D A Y";break;case 6:a="S A T U R D A Y"}var r=new Image;r.src=t.showImg,r.onload=function(){if(c.drawImage(r,0,0,Math.floor(2*m),Math.floor(2*h)),1==x){c.font="normal bold "+.048*m*2+"px myFirstFont",c.fillStyle="black",c.textAlign="right";var f=Math.floor(.744*s*2),n=Math.floor(.95*h*2);c.fillText("BY"+t.user.name,f,n)}else if(2==x){c.font="normal bold "+.04*m*2+"px myFirstFont",c.fillStyle="black";var i=Math.floor(.07*s*2),F=Math.floor(.906*h*2),b=Math.floor(.943*h*2);c.fillText("BY"+t.user.name,i,F),c.fillText(o,i,b)}else if(3==x){c.font="normal bold "+100/750*m*2+"px myFirstFont",c.fillStyle="white";var g=Math.floor(.103*s*2),T=Math.floor(.87*h*2),u=Math.floor(.91*h*2),y=Math.floor(.947*h*2);c.fillText(l.getDate(),g,T),c.font="normal bold "+.04*m*2+"px myFirstFont",c.fillText(e+"."+a,g,u),c.fillText("BY"+t.user.name,g,y)}else if(4==x){c.font="normal bold "+34/750*m*2+"px myFirstFont",c.fillStyle="black",c.textAlign="right";var d=Math.floor(.924*s*2),p=Math.floor(.145*h*2),v=Math.floor(.184*h*2),Y=Math.floor(.223*h*2);c.fillText(o,d,p),c.fillText(a,d,v),c.fillText("BY"+t.user.name,d,Y)}else if(5==x){c.font="normal bold "+34/750*m*2+"px myFirstFont",c.fillStyle="#7a8776",c.textAlign="right";var S=Math.floor(.933*s*2),k=Math.floor(.736*h*2);c.fillText("BY"+t.user.name,S,k)}else if(6==x){c.font="normal bold "+34/750*m*2+"px myFirstFont",c.fillStyle="#fff";var B=Math.floor(.047*s*2),D=Math.floor(.915*h*2);c.fillText("BY"+t.user.name,B,D)}else if(7==x){c.font="normal bold "+.04*m*2+"px myFirstFont",c.fillStyle="#000";var A=Math.floor(.07*s*2),w=Math.floor(.856*h*2),I=Math.floor(.883*h*2),E=Math.floor(.91*h*2);c.fillText(o,A,w),c.fillText(a,A,I),c.fillText("BY"+t.user.name,A,E)}else if(8==x){c.font="normal bold "+100/750*m*2+"px myFirstFont",c.fillStyle="#96bfad";var $=Math.floor(.07*s*2),U=Math.floor(.106*h*2),N=Math.floor(.146*h*2),R=Math.floor(.186*h*2);c.fillText(l.getDate(),$,U),c.font="normal bold "+.04*m*2+"px myFirstFont",c.fillText(a,$,N),c.fillText("BY"+t.user.name,$,R)}else if(9==x&&1==M){c.font="normal bold "+.048*m*2+"px myFirstFont",c.fillStyle="black";for(var C=Math.floor(.064*s*2),J=Math.floor(.8912*h*2),O=0;O<t.user.name.length;O++)c.fillText(t.user.name[O],C,J+Math.floor(.0275*h*2)*O)}else if(9==x&&2==M){c.font="normal bold "+.06*m*2+"px myFirstFont",c.fillStyle="black";var P=Math.floor(.697*s*2),L=Math.floor(.933*s*2),W=Math.floor(.097*h*2),j=Math.floor(.1457*h*2),G=Math.floor(.4003*h*2);c.fillText(l.getMonth()+1+"/"+l.getDate(),P,W),c.fillText(l.getFullYear(),P,j),c.textAlign="right",c.font="normal bold "+.048*m*2+"px myFirstFont",c.fillText("BY"+t.user.name,L,G)}else if(9==x&&3==M){c.font="normal bold "+86/750*m*2+"px myFirstFont",c.fillStyle="black";var H=Math.floor(.163*s*2),V=Math.floor(.09*h*2),_=Math.floor(.147*h*2),q=Math.floor(.2714*h*2);c.fillText(l.getDate(),H,V),c.font="normal bold "+38/750*m*2+"px myFirstFont",c.fillText(e+"."+a,H,_),c.font="normal bold "+.04*m*2+"px myFirstFont",c.fillText("BY"+t.user.name,H,q)}else if(9==x&&4==M){c.font="normal bold "+124/750*m*2+"px myFirstFont",c.fillStyle="#fff";var z=Math.floor(.0587*s*2),K=Math.floor(.091*h*2),Q=Math.floor(.1224*h*2),X=Math.floor(.1614*h*2),Z=Math.floor(.2004*h*2);c.fillText(l.getDate(),z,K),c.font="normal bold "+.048*m*2+"px myFirstFont",c.fillText(e+"."+a,z,Q),c.fillText(l.getFullYear(),z,X),c.fillText("BY"+t.user.name,z,Z)}else if(9==x&&5==M){c.font="normal bold "+.048*m*2+"px myFirstFont",c.fillStyle="#fff",c.textAlign="center";var tt=Math.floor(.5*s*2),lt=Math.floor(.5732*h*2),ot=Math.floor(.6167*h*2);c.fillText(o,tt,lt),c.fillText("BY"+t.user.name,tt,ot)}else if(10==x&&1==M){c.font="normal bold "+.096*m*2+"px myFirstFont",c.fillStyle="#434345",c.textAlign="right";var et=Math.floor(.9387*s*2),at=Math.floor(.0795*h*2),rt=Math.floor(.1244*h*2),ft=Math.floor(.1634*h*2);c.fillText(l.getDate(),et,at),c.font="normal bold "+.04*m*2+"px myFirstFont",c.fillText(e+"."+a,et,rt),c.fillText("BY"+t.user.name,et,ft)}else if(10==x&&2==M){c.font="normal bold "+.04*m*2+"px myFirstFont",c.fillStyle="#fff";var nt=Math.floor(.1093*s*2),it=Math.floor(.8476*h*2),st=Math.floor(.8806*h*2);c.fillText(o,nt,it),c.fillText("BY"+t.user.name,nt,st)}else if(10==x&&3==M){c.font="normal bold "+.048*m*2+"px myFirstFont",c.fillStyle="#fff";var mt=Math.floor(.0613*s*2),ht=Math.floor(.3004*h*2);c.fillText("BY"+t.user.name,mt,ht)}else if(10==x&&4==M){c.font="normal bold "+124/750*m*2+"px myFirstFont",c.fillStyle="#fff",c.textAlign="right";var xt=Math.floor(.952*s*2),Mt=Math.floor(.0995*h*2),Ft=Math.floor(.1729*h*2),ct=Math.floor(.2119*h*2),bt=Math.floor(.2509*h*2);c.fillText(l.getDate(),xt,Mt),c.font="normal bold "+.048*m*2+"px myFirstFont",c.fillText(e+"."+a,xt,Ft),c.fillText(l.getFullYear(),xt,ct),c.fillText("BY"+t.user.name,xt,bt)}else if(10==x&&5==M){c.font="normal bold "+124/750*m*2+"px myFirstFont",c.fillStyle="#fff";var gt=Math.floor(.0587*s*2),Tt=Math.floor(.091*h*2),ut=Math.floor(.1224*h*2),yt=Math.floor(.1614*h*2),dt=Math.floor(.2004*h*2);c.fillText(l.getDate(),gt,Tt),c.font="normal bold "+.048*m*2+"px myFirstFont",c.fillText(e+"."+a,gt,ut),c.fillText(l.getFullYear(),gt,yt),c.fillText("BY"+t.user.name,gt,dt)}}}function n(){t.showcanvas=!1;var l=document.getElementById("main"),o=l.toDataURL("image/jpeg",.7);t.canvasImg=o,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var i=JSON.parse(sessionStorage.getItem("user"));t.user=i,t.btnText="立即使用",t.loading=!1,t.showcanvas=!0,t.canvasImg="";var s=document.documentElement.clientWidth,m=Math.floor(s),h=Math.floor(s*(1334/750));$("#main").css("width",m+"px"),$("#main").css("height",h+"px"),console.log(t.user),t.user.name.length>=4&&(t.user.name=t.user.name[0]+t.user.name[1]+t.user.name[2]+t.user.name[3]);var x=r.type,M=r.num;t.showImg="../../assets/images/morning/type"+x+"/img_"+M+".png",t.editInformation=function(){e.path("editInformation")},t.useTemplatePage=function(){n(),t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(){o.history.back()},t.closeText=function(){t.user.iscomplete=!0};var F=document.getElementById("main"),c=F.getContext("2d");F.width=2*m,F.height=2*h,$(function(){f()})}]);
index.controller("useNightCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,l,o,e,a,f){function r(){t.btnText="立即使用",t.showcanvas=!0;var l=new Date,o=l.getFullYear()+"/"+(l.getMonth()+1)+"/"+l.getDate(),e=l.getMonth()+1;switch(e){case 1:e="J A N";break;case 2:e="F E B";break;case 3:e="M A R";break;case 4:e="A P R";break;case 5:e="M A Y";break;case 6:e="J U N";break;case 7:e="J U L";break;case 8:e="A U G";break;case 9:e="S E P";break;case 10:e="O C T";break;case 11:e="N O V";break;case 12:e="D E C"}var a=l.getDay();switch(a){case 0:a="Sunday";break;case 1:a="Monday";break;case 2:a="Tuesday";break;case 3:a="Wednesday";break;case 4:a="Thursday";break;case 5:a="Friday";break;case 6:a="Saturday"}var f=new Image;f.src=t.showImg,f.onload=function(){if(y.drawImage(f,0,0,2*h,2*m),1==x){y.font="normal bold "+.032*h*2+"px myFirstFont",y.fillStyle="#545454";var r=Math.floor(.07*s*2),n=Math.floor(.866*m*2),i=Math.floor(.897*m*2),g=Math.floor(.923*m*2);y.fillText(t.user.name,r,n),y.fillText(e+"."+a,r,i),y.fillText(o,r,g)}else if(2==x){y.font="normal bold "+.032*h*2+"px myFirstFont",y.fillStyle="#fff";for(var c=Math.floor(.625*s*2),F=Math.floor(.826*s*2),T=Math.floor(.716*m*2),u=Math.floor(.88*m*2),d=Math.floor(.92*m*2),b=0;b<t.user.name.length;b++)y.fillText(t.user.name[b],F,T+Math.floor(.0437*m*2)*b);y.fillText(e+"."+a,c,u),y.fillText(o,c,d)}else if(3==x){y.font="normal bold "+.032*h*2+"px myFirstFont",y.fillStyle="white";var p=Math.floor(.066*s*2),v=Math.floor(.8*s*2),S=Math.floor(.076*m*2),k=Math.floor(.105*m*2),w=Math.floor(.329*m*2);y.fillText(l.getMonth()+1+"/"+l.getDate(),p,S),y.fillText(a,p,k);for(var Y=0;Y<t.user.name.length;Y++)y.fillText(t.user.name[Y],v,w+Math.floor(.0437*m*2)*Y)}else if(4==x){y.font="normal bold "+100/750*h*2+"px myFirstFont",y.fillStyle="white";var B=Math.floor(.103*s*2),A=Math.floor(.8*s*2),D=Math.floor(.87*m*2),I=Math.floor(.91*m*2),$=Math.floor(.947*m*2),E=Math.floor(.329*m*2);y.fillText(l.getDate(),B,D),y.font="normal bold "+.032*h*2+"px myFirstFont",y.fillText(e+"."+a,B,I),y.fillText(l.getFullYear(),B,$);for(var N=0;N<t.user.name.length;N++)y.fillText(t.user.name[N],A,E+Math.floor(.0437*m*2)*N)}else if(5==x){y.font="normal bold "+.032*h*2+"px myFirstFont",y.fillStyle="#545454";var C=Math.floor(.103*s*2),J=Math.floor(.8*s*2),P=Math.floor(.9*m*2),U=Math.floor(.94*m*2),O=Math.floor(.329*m*2);y.fillText(e+"."+a,C,P),y.fillText(o,C,U),y.fillStyle="#fff";for(var R=0;R<t.user.name.length;R++)y.fillText(t.user.name[R],J,O+Math.floor(.0437*m*2)*R)}else if(6==x){y.font="normal bold "+124/750*h*2+"px myFirstFont",y.fillStyle="#fff";var L=Math.floor(.07*s*2),W=Math.floor(.479*s*2),j=Math.floor(.106*m*2),G=Math.floor(.146*m*2),V=Math.floor(.186*m*2),_=Math.floor(.434*m*2);y.fillText(l.getDate(),L,j),y.font="normal bold "+.032*h*2+"px myFirstFont",y.fillText(e+"."+a,L,G),y.fillText(l.getFullYear(),L,V);for(var q=0;q<t.user.name.length;q++)y.fillText(t.user.name[q],W,_+Math.floor(.0437*m*2)*q)}else if(7==x){y.font="normal bold "+.032*h*2+"px myFirstFont",y.fillStyle="#545454";var z=Math.floor(.066*s*2),H=Math.floor(.059*m*2),K=Math.floor(.088*m*2);y.fillText(e+"."+a,z,H),y.fillText(o,z,K)}else if(8==x){y.font="normal bold "+124/750*h*2+"px myFirstFont",y.fillStyle="#1b273";var Q=Math.floor(.08*s*2),X=Math.floor(.146*m*2),Z=Math.floor(.186*m*2),tt=Math.floor(.226*m*2),lt=Math.floor(.9078*m*2);y.fillText(l.getDate(),Q,X),y.font="normal bold "+.032*h*2+"px myFirstFont",y.fillText(e+"."+a,Q,Z),y.fillText(l.getFullYear(),Q,tt),y.fillStyle="#535353",y.fillText("BY"+t.user.name,Q,lt)}else if(9==x&&1==M){y.font="normal bold "+38/750*h*2+"px myFirstFont",y.fillStyle="#fff";var ot=Math.floor(.224*s*2),et=Math.floor(.5792*m*2),at=Math.floor(.6197*m*2);y.fillText(o,ot,et),y.fillText("BY"+t.user.name,ot,at)}else if(9==x&&2==M){y.font="normal bold "+34/750*h*2+"px myFirstFont",y.fillStyle="#fff";var ft=Math.floor(.112*s*2),rt=Math.floor(.2614*m*2);y.fillText("BY"+t.user.name,ft,rt)}else if(9==x&&3==M){y.font="normal bold "+80/750*h*2+"px myFirstFont",y.fillStyle="#fff",y.textAlign="center";var nt=Math.floor(.5*s*2),it=Math.floor(.0705*m*2),st=Math.floor(.1169*m*2),ht=Math.floor(.1619*m*2);y.fillText(l.getDate(),nt,it),y.font="normal bold "+38/750*h*2+"px myFirstFont",y.fillText(e+"."+a,nt,st),y.fillText("BY"+t.user.name,nt,ht)}else if(9==x&&4==M){y.font="normal bold "+80/750*h*2+"px myFirstFont",y.fillStyle="#fff";var mt=Math.floor(.064*s*2),xt=Math.floor(.736*s*2),Mt=Math.floor(.0715*m*2),gt=Math.floor(.1137*m*2),yt=Math.floor(.8926*m*2);y.fillText(l.getDate(),mt,Mt),y.font="normal bold "+38/750*h*2+"px myFirstFont",y.fillText(e+"."+a,mt,gt),y.textAlign="right",y.fillText("BY"+t.user.name,xt,yt)}else if(9==x&&5==M){y.font="normal bold "+.048*h*2+"px myFirstFont",y.fillStyle="#fff",y.textAlign="center";var ct=Math.floor(.5*s*2),Ft=Math.floor(.9183*m*2),Tt=Math.floor(.9555*m*2);y.fillText(o,ct,Ft),y.fillText("BY"+t.user.name,ct,Tt)}else if(10==x&&1==M){y.font="normal bold "+.04*h*2+"px myFirstFont",y.fillStyle="#fff",y.textAlign="right";var ut=Math.floor(.8227*s*2),dt=Math.floor(.8041*m*2);y.fillText("BY"+t.user.name,ut,dt)}else if(10==x&&2==M){y.font="normal bold "+.048*h*2+"px myFirstFont",y.fillStyle="#000",y.textAlign="right";var bt=Math.floor(.9013*s*2),pt=Math.floor(.8716*m*2);y.fillText("BY"+t.user.name,bt,pt)}else if(10==x&&3==M){y.font="normal bold "+.04*h*2+"px myFirstFont",y.fillStyle="#fff",y.textAlign="center";var vt=Math.floor(.5*s*2),St=Math.floor(.9013*s*2),kt=Math.floor(.1639*m*2),wt=Math.floor(.924*m*2);y.fillText(o,vt,kt),y.textAlign="right",y.font="normal bold "+.048*h*2+"px myFirstFont",y.fillText("BY"+t.user.name,St,wt)}else if(10==x&&4==M){y.font="normal bold "+.048*h*2+"px myFirstFont",y.fillStyle="#fff",y.textAlign="right";var Yt=Math.floor(.9227*s*2),Bt=Math.floor(.96*m*2);y.fillText("BY"+t.user.name,Yt,Bt)}else if(10==x&&5==M){y.font="normal bold "+.048*h*2+"px myFirstFont",y.fillStyle="#8b775f",y.textAlign="center";var At=Math.floor(.5*s*2),Dt=Math.floor(.9645*m*2);y.fillText("BY"+t.user.name,At,Dt)}}}function n(){t.showcanvas=!1;var l=document.getElementById("main"),o=l.toDataURL("image/jpeg",.7);t.canvasImg=o,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var i=JSON.parse(sessionStorage.getItem("user"));t.user=i,t.btnText="立即使用",t.loading=!1,t.showcanvas=!0,t.canvasImg="";var s=document.documentElement.clientWidth,h=Math.floor(s),m=Math.floor(1.83*s);$("#main").css("width",h+"px"),$("#main").css("height",m+"px"),console.log(t.user);var x=f.type,M=f.num;t.page=1,t.showImg="../../assets/images/goodnight/type"+x+"/img_"+M+".png",t.editInformation=function(){e.path("editInformation")},t.useTemplatePage=function(){n(),t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(){o.history.back()},t.closeText=function(){t.user.iscomplete=!0};var g=document.getElementById("main"),y=g.getContext("2d");g.width=2*h,g.height=2*m,$(function(){r()})}]);
index.controller("useNoticeCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,e,o,l,a,i){function n(){t.btnText="一键生成海报",t.showcanvas=!0;var e=new Date,o=e.getFullYear()+"/"+(e.getMonth()+1)+"/"+e.getDate(),l=e.getMonth()+1;switch(l){case 1:l="JAN";break;case 2:l="FEB";break;case 3:l="MAR";break;case 4:l="APR";break;case 5:l="MAY";break;case 6:l="JUN";break;case 7:l="JUL";break;case 8:l="AUG";break;case 9:l="SEP";break;case 10:l="OCT";break;case 11:l="NOV";break;case 12:l="DEC"}var a=e.getDay();switch(a){case 0:a="Sunday";break;case 1:a="Monday";break;case 2:a="Tuesday";break;case 3:a="Wednesday";break;case 4:a="Thursday";break;case 5:a="Friday";break;case 6:a="Saturday"}var i=new Image;i.src=t.showImg,i.onload=function(){if(p.drawImage(i,0,0,2*m,2*d),1==h){p.font="normal bold "+.048*m*2+"px myFirstFont",p.fillStyle="#fff";var e=Math.floor(.1133*s*2),n=Math.floor(.88*d*2),f=Math.floor(.91*d*2),r=Math.floor(.94*d*2);p.fillText(t.name,e,n),p.font="normal bold "+.032*m*2+"px myFirstFont",p.fillText(l+"."+a,e,f),p.fillText(o,e,r)}else if(2==h&&1==x){p.drawImage(b,8/75*m*2,1106/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+.048*m*2+"px myFirstFont",p.fillStyle="#fff";var u=Math.floor(.5733*s*2),M=Math.floor(.704*s*2),g=Math.floor(.3999*d*2),y=Math.floor(.6372*d*2),c=Math.floor(.6672*d*2),F=Math.floor(.6972*d*2);p.fillText(t.zhekou,u,g),p.fillStyle="#333",p.fillText(t.name,M,y),p.font="normal bold "+.032*m*2+"px myFirstFont",p.fillText(l+"."+a,M,c),p.fillText(o,M,F)}else if(2==h&&2==x){p.drawImage(b,.744*m*2,1120/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+.04*m*2+"px myFirstFont",p.fillStyle="#333";var T=Math.floor(.3673*s*2),w=Math.floor(.211*s*2),v=Math.floor(.6567*d*2),I=Math.floor(.8685*d*2),$=Math.floor(.8985*d*2),S=Math.floor(.9285*d*2);p.fillText(t.lijian,T,v),p.font="normal bold "+.048*m*2+"px myFirstFont",p.fillStyle="#fff",p.fillText(t.name,w,I),p.font="normal bold "+.032*m*2+"px myFirstFont",p.fillStyle="#333",p.fillText(l+"."+a,w,$),p.fillText(o,w,S)}else if(2==h&&3==x){p.drawImage(b,566/750*m*2,1136/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+.048*m*2+"px myFirstFont",p.fillStyle="#122b87",p.textAlign="right";var k=Math.floor(.9493*s*2),O=Math.floor(.044*d*2);p.fillText("BY"+t.user.name,k,O)}else if(2==h&&4==x){p.drawImage(b,.408*m*2,1122/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+.048*m*2+"px myFirstFont",p.fillStyle="#374e78";var B=Math.floor(.1173*s*2),D=Math.floor(.6512*d*2);p.fillText("BY"+t.user.name,B,D)}else if(3==h&&1==x){p.drawImage(b,.74*m*2,1119/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+100/750*m*2+"px myFirstFont",p.fillStyle="#b8742b";var P=Math.floor(.1917*s*2),Y=Math.floor(.5803*s*2),A=Math.floor(.113*s*2),j=Math.floor(.608*d*2),E=Math.floor(.8785*d*2),N=Math.floor(.9085*d*2),U=Math.floor(.9385*d*2);p.fillText(t.starttime,P,j),p.fillText(t.endtime,Y,j),p.font="normal bold "+.048*m*2+"px myFirstFont",p.fillStyle="#333",p.fillText(t.name,A,E),p.font="normal bold "+.032*m*2+"px myFirstFont",p.fillText(l+"."+a,A,N),p.fillText(o,A,U)}else if(3==h&&2==x){p.drawImage(b,.408*m*2,786/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+.064*m*2+"px myFirstFont",p.fillStyle="#fff";var C=Math.floor(.246*s*2),J=Math.floor(.5667*s*2),L=Math.floor(.113*s*2),R=Math.floor(.463*d*2),z=Math.floor(.8785*d*2),_=Math.floor(.9085*d*2),W=Math.floor(.9385*d*2);p.fillText(t.starttime1,C,R),p.fillText(t.endtime1,J,R),p.font="normal bold "+.048*m*2+"px myFirstFont",p.fillText(t.name,L,z),p.font="normal bold "+.032*m*2+"px myFirstFont",p.fillText(l+"."+a,L,_),p.fillText(o,L,W)}else if(3==h&&3==x){p.drawImage(b,566/750*m*2,1136/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+.048*m*2+"px myFirstFont",p.fillStyle="#9fe1e0";var q=Math.floor(.0613*s*2),G=Math.floor(.9705*d*2);p.fillText("BY"+t.user.name,q,G)}else if(3==h&&4==x){p.drawImage(b,560/750*m*2,1130/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+.048*m*2+"px myFirstFont",p.fillStyle="#fff";var V=Math.floor(.176*s*2),H=Math.floor(.70665*d*2);p.fillText("BY"+t.user.name,V,H)}else if(4==h&&1==x){p.drawImage(b,.408*m*2,1079/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+.064*m*2+"px myFirstFont",p.fillStyle="#000";var K=Math.floor(.347*s*2),Q=Math.floor(.58*d*2);p.fillText(t.discount,K,Q)}else if(4==h&&2==x){p.drawImage(b,.408*m*2,1090/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+100/750*m*2+"px myFirstFont",p.fillStyle="#f02964";var X=Math.floor(.246*s*2),Z=Math.floor(.236*s*2),tt=Math.floor(.5373*s*2),et=Math.floor(.422*d*2),ot=Math.floor(.6808*d*2);p.fillText(t.discount,X,et),p.font="normal bold "+.048*m*2+"px myFirstFont",p.fillStyle="#333",p.fillText(t.starttime2,Z,ot),p.fillText(t.endtime2,tt,ot)}else if(4==h&&3==x){p.drawImage(b,.408*m*2,1132/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+32/750*m*2+"px myFirstFont",p.fillStyle="#000";var lt=Math.floor(.0667*s*2),at=Math.floor(.9735*d*2);p.fillText("BY"+t.user.name,lt,at)}else if(4==h&&4==x){p.drawImage(b,.744*m*2,1130/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+.048*m*2+"px myFirstFont",p.fillStyle="#000";var it=Math.floor(.0987*s*2),nt=Math.floor(.6452*d*2);p.fillText("BY"+t.user.name,it,nt)}else if(5==h&&1==x){p.drawImage(b,550/750*m*2,1110/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+100/750*m*2+"px myFirstFont",p.fillStyle="#000";var ft=Math.floor(.1426*s*2),rt=Math.floor(.6013*s*2),st=Math.floor(.31*s*2),mt=Math.floor(.1333*s*2),dt=Math.floor(.4764*d*2),ht=Math.floor(.7869*d*2),xt=(Math.floor(.7669*d*2),Math.floor(.89*d*2)),ut=Math.floor(.92*d*2),pt=Math.floor(.95*d*2);p.fillText(t.starttime3,ft,dt),p.fillText(t.endtime3,rt,dt),p.font="normal bold "+.048*m*2+"px myFirstFont",p.fillStyle="#fb5b64",p.fillText(t.business,st,ht),p.fillStyle="#333",p.fillText(t.name,mt,xt),p.font="normal bold "+.032*m*2+"px myFirstFont",p.fillText(l+"."+a,mt,ut),p.fillText(o,mt,pt)}else if(5==h&&2==x){p.drawImage(b,551/750*m*2,1111/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+.04*m*2+"px myFirstFont",p.fillStyle="#f6c33b";var Mt=Math.floor(.298*s*2),gt=Math.floor(.415*s*2),yt=Math.floor(.1333*s*2),bt=Math.floor(.801*d*2),ct=Math.floor(.89*d*2),Ft=Math.floor(.92*d*2),Tt=Math.floor(.95*d*2);p.fillText(t.businessMonth,Mt,bt),p.fillText(t.businessDate,gt,bt),p.fillStyle="#333",p.fillText(t.name,yt,ct),p.font="normal bold "+.032*m*2+"px myFirstFont",p.fillText(l+"."+a,yt,Ft),p.fillText(o,yt,Tt)}else if(5==h&&3==x){p.drawImage(b,.408*m*2,1143/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+32/750*m*2+"px myFirstFont",p.fillStyle="#000",p.textAlign="center";var wt=Math.floor(.5*s*2),vt=Math.floor(.2367*s*2),It=Math.floor(.4387*s*2),$t=Math.floor(.8413*d*2),St=Math.floor(.7866*d*2);p.fillText("BY"+t.user.name,wt,$t),p.font="normal bold "+.064*m*2+"px myFirstFont",p.fillText(t.businessMonth,vt,St),p.fillText(t.businessDate,It,St)}else if(5==h&&4==x){p.drawImage(b,568/750*m*2,1130/1334*d*2,14/75*m*2,14/75*m*2),p.font="normal bold "+32/750*m*2+"px myFirstFont",p.fillStyle="#fff",p.textAlign="center";var kt=Math.floor(.354*s*2),Ot=Math.floor(.3573*s*2),Bt=Math.floor(.565*s*2),Dt=Math.floor(.936*d*2),Pt=Math.floor(.6672*d*2),Yt=Math.floor(.7666*d*2);p.fillText("BY"+t.user.name,kt,Dt),p.font="normal bold "+56/750*m*2+"px myFirstFont",p.fillText(t.businessMonth,Ot,Pt),p.fillText(t.businessDate,Bt,Pt),p.fillText(t.endtime3,Ot,Yt),p.fillText(t.endtime,Bt,Yt)}}}function f(){t.showcanvas=!1;var e=document.getElementById("main"),o=e.toDataURL("image/jpeg",.7);t.canvasImg=o,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var r=JSON.parse(sessionStorage.getItem("user"));t.fastuse=!0,t.user=r,t.btnText="一键生成海报",t.loading=!1,t.showcanvas=!0,t.showmodel=!1,t.canvasImg="",t.name="请添加",t.zhekou="八",t.lijian="000",t.starttime="08",t.endtime="24",t.starttime1="08:00",t.endtime1="24:00",t.starttime2="2017.05.01",t.endtime2="2017.05.05",t.starttime3="01",t.endtime3="05",t.discount="00",t.business="06",t.businessMonth="05",t.businessDate="01";var s=document.documentElement.clientWidth,m=Math.floor(s),d=Math.floor(1.83*s);$("#main").css("width",m+"px"),$("#main").css("height",d+"px"),console.log(t.user);var h=i.type,x=i.num;t.page=1,t.showImg="../../assets/images/notice/type"+h+"/img_"+x+".png",t.editInformation=function(t){t.stopPropagation(),l.path("editInformation")},t.useTemplatePage=function(e){e.stopPropagation(),f(),t.showmodel=!0,t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(t){t.stopPropagation(),o.history.back()},t.chengeText=function(){t.fastuse=!0,t.name="",t.zhekou="",t.lijian="",t.starttime="",t.endtime="",t.starttime1="",t.endtime1="",t.starttime2="",t.endtime2="",t.starttime3="",t.endtime3="",t.discount="",t.business="",t.businessMonth="",t.businessDate="",t.showmodel||(1==h?$(".name-input-fixed").show():2==h&&1==x?$(".name-input-fixed-1").show():2==h&&2==x?$(".name-input-fixed-2").show():3==h&&1==x?$(".name-input-fixed-3").show():3==h&&2==x?$(".name-input-fixed-4").show():4==h&&1==x?$(".name-input-fixed-5").show():4==h&&2==x?$(".name-input-fixed-6").show():5==h&&1==x?$(".name-input-fixed-7").show():5==h&&2==x?$(".name-input-fixed-8").show():5==h&&3==x?$(".name-input-fixed-9").show():5==h&&4==x?$(".name-input-fixed-10").show():(f(),t.fastuse=!1,t.showmodel=!0,t.btnText="长按保存至手机，再发到朋友圈炫耀"))},t.updateText=function(){n(),1==h?$(".name-input-fixed").fadeOut(50):2==h&&1==x?$(".name-input-fixed-1").fadeOut(50):2==h&&2==x?$(".name-input-fixed-2").fadeOut(50):3==h&&1==x?$(".name-input-fixed-3").fadeOut(50):3==h&&2==x?$(".name-input-fixed-4").fadeOut(50):4==h&&1==x?$(".name-input-fixed-5").fadeOut(50):4==h&&2==x?$(".name-input-fixed-6").fadeOut(50):5==h&&1==x?$(".name-input-fixed-7").fadeOut(50):5==h&&2==x?$(".name-input-fixed-8").fadeOut(50):5==h&&3==x?$(".name-input-fixed-9").fadeOut(50):5==h&&4==x&&$(".name-input-fixed-10").fadeOut(50),t.fastuse=!1},t.closeText=function(e){e.stopPropagation(),t.user.iscomplete=!0},t.changeImg=function(e){e.stopPropagation(),t.loading=!0,t.showmodel=!1,t.page>=2?(t.page=1,t.showImg="../../assets/images/notice/type"+x+"/img_"+t.page+".png",t.loading=!1):(t.page+=1,t.showImg="../../assets/images/notice/type"+x+"/img_"+t.page+".png",t.loading=!1),n()};var u=document.getElementById("main"),p=u.getContext("2d");u.width=2*m,u.height=2*d,$(function(){n()});var M=$(".hideImg").qrcode({width:200,height:200,correctLevel:0,text:"http://syrapi.yueyishujia.com/yueAssistant/build/html/homePage/"+t.user.uuid}).hide(),g=M.find("canvas").get(0),y=g.toDataURL("image/jpg"),b=new Image;b.src=y}]);
