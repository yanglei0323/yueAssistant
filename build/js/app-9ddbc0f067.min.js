...
index.controller("promotionCtrl",["$scope","$http","$window","$location","$rootScope",function(a,e,t,c,i){var o=JSON.parse(sessionStorage.getItem("user"));a.user=o,a.activeTab=2,i.activeTab&&(a.activeTab=i.activeTab),a.loading=!1,a.changeTab=function(e){switch(a.activeTab=e,e){case 1:i.activeTab=1;break;case 2:i.activeTab=2;break;case 3:i.activeTab=3}},a.changeHomePage=function(a){i.activeTab=1,c.path("changeHomePage/"+a)},a.useTemplate=function(a){i.activeTab=3,c.path("wechatCircle/"+a)},a.useCard=function(e){i.activeTab=2,window.location.href="../template/card/index.html?num="+e+"&uuid="+a.user.uuid}}]);
...
index.controller("useHolidayCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(e,a,t,o,n,i){function m(){e.btnText="一键生成海报",e.showcanvas=!0;var a=g("main");a.width,a.height;a.clearRect(0,0,1e3,1e3);var t=new Image;t.src=e.showImg,t.onload=function(){if(a.drawImage(t,0,0,p,f),navigator.userAgent.match(/iphone/i)){if(1==c&&2==e.page){a.font="normal bold 40px myFirstFont",a.fillStyle="#fff";var o=Math.floor(.153*l),n=Math.floor(.335*f);a.fillText(e.name+"祝您",o,n)}}else if(1==c&&2==e.page){a.font="normal bold 0.533333rem myFirstFont",a.fillStyle="#fff";var i=Math.floor(.153*l),m=Math.floor(.335*f);a.fillText(e.name+"祝您",i,m)}}}function g(e){return document.getElementById(e).getContext("2d")}function s(){e.showcanvas=!1;var a=document.getElementById("main"),t=a.toDataURL("image/jpg");e.canvasImg=t,e.btnText="长按保存至手机，再发到朋友圈炫耀"}var r=JSON.parse(sessionStorage.getItem("user"));e.user=r,e.btnText="一键生成海报",e.loading=!1,e.showcanvas=!0,e.showmodel=!1,e.canvasImg="",e.name="请添加";var l=document.documentElement.clientWidth,p=Math.floor(l),f=Math.floor(1.83*l);$("#main").attr("width",p+"px"),$("#main").attr("height",f+"px"),console.log(e.user),e.name.length>=4&&(e.name=e.name[0]+e.name[1]+e.name[2]);var c=i.num;e.page=1,e.showImg="../../assets/images/holiday/type"+c+"/img_"+e.page+".png";for(var h=1;3>h;h++){var d="../../assets/images/holiday/type"+c+"/img_"+h+".png";$(".hideImg").append("<img src="+d+">")}e.editInformation=function(e){e.stopPropagation(),o.path("editInformation")},e.useTemplatePage=function(a){a.stopPropagation(),s(),e.showmodel=!0,e.btnText="长按保存至手机，再发到朋友圈炫耀"},e.goBack=function(e){e.stopPropagation(),t.history.back()},e.chengeText=function(){e.showmodel||1==c&&2==e.page&&$(".name-input-fixed").show()},e.updateText=function(){e.name.length>=4&&(e.name=e.name[0]+e.name[1]+e.name[2]),m(),$(".name-input-fixed").fadeOut(50)},e.closeText=function(a){a.stopPropagation(),e.user.iscomplete=!0},e.changeImg=function(a){a.stopPropagation(),e.showmodel=!1,e.loading=!0,e.page>=2?(e.page=1,e.showImg="../../assets/images/holiday/type"+c+"/img_"+e.page+".png",e.loading=!1):(e.page+=1,e.showImg="../../assets/images/holiday/type"+c+"/img_"+e.page+".png",e.loading=!1),m()},$(function(){m()})}]);
...
index.controller("useMornCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(e,t,l,o,a,r){function n(){e.btnText="立即使用",e.showcanvas=!0;var t=new Date,l=t.getFullYear()+"/"+(t.getMonth()+1)+"/"+t.getDate(),o=t.getMonth()+1;switch(o){case 1:o="J A N";break;case 2:o="F E B";break;case 3:o="M A R";break;case 4:o="A P R";break;case 5:o="M A Y";break;case 6:o="J U N";break;case 7:o="J U L";break;case 8:o="A U G";break;case 9:o="S E P";break;case 10:o="O C T";break;case 11:o="N O V";break;case 12:o="D E C"}var a=t.getDay();switch(a){case 0:a="S U N D A Y";break;case 1:a="M O N D A Y";break;case 2:a="T U E S D A Y";break;case 3:a="W E D N E S D A Y";break;case 4:a="T H U R S D A Y";break;case 5:a="F R I D A Y";break;case 6:a="S A T U R D A Y"}var r=f("main");r.width,r.height;r.clearRect(0,0,1e3,1e3);var n=new Image;n.src=e.showImg,n.onload=function(){if(r.drawImage(n,0,0,h,g),navigator.userAgent.match(/iphone/i)){if(1==c){r.font="normal bold 36px myFirstFont",r.fillStyle="black",r.textAlign="right";var f=Math.floor(.744*m),i=Math.floor(.95*g);r.fillText("BY"+e.user.name,f,i)}else if(2==c){r.font="normal bold 30px myFirstFont",r.fillStyle="black";var s=Math.floor(.07*m),M=Math.floor(.906*g),x=Math.floor(.943*g);r.fillText("BY"+e.user.name,s,M),r.fillText(l,s,x)}else if(3==c){r.font="normal bold 100px myFirstFont",r.fillStyle="white";var b=Math.floor(.103*m),u=Math.floor(.87*g),d=Math.floor(.91*g),y=Math.floor(.947*g);r.fillText(t.getDate(),b,u),r.font="normal bold 30px myFirstFont",r.fillText(o+"."+a,b,d),r.fillText("BY"+e.user.name,b,y)}else if(4==c){r.font="normal bold 34px myFirstFont",r.fillStyle="black",r.textAlign="right";var T=Math.floor(.924*m),F=Math.floor(.145*g),p=Math.floor(.184*g),v=Math.floor(.223*g);r.fillText(l,T,F),r.fillText(a,T,p),r.fillText("BY"+e.user.name,T,v)}else if(5==c){r.font="normal bold 34px myFirstFont",r.fillStyle="#7a8776";var k=Math.floor(.773*m),S=Math.floor(.736*g);r.fillText("BY"+e.user.name,k,S)}else if(6==c){r.font="normal bold 0.46rem myFirstFont",r.fillStyle="#fff";var Y=Math.floor(.047*m),B=Math.floor(.915*g);r.fillText("BY"+e.user.name,Y,B)}else if(7==c){r.font="normal bold 30px myFirstFont",r.fillStyle="#000";var w=Math.floor(.07*m),A=Math.floor(.856*g),D=Math.floor(.883*g),I=Math.floor(.91*g);r.fillText(l,w,A),r.fillText(a,w,D),r.fillText("BY"+e.user.name,w,I)}else if(8==c){r.font="normal bold 100px myFirstFont",r.fillStyle="#96bfad";var $=Math.floor(.07*m),E=Math.floor(.106*g),U=Math.floor(.146*g),N=Math.floor(.186*g);r.fillText(t.getDate(),$,E),r.font="normal bold 30px myFirstFont",r.fillText(a,$,U),r.fillText("BY"+e.user.name,$,N)}}else if(1==c){r.font="normal bold 0.48rem myFirstFont",r.fillStyle="black";var R=Math.floor(.544*m),C=Math.floor(.95*g);r.fillText("BY"+e.user.name,R,C)}else if(2==c){r.font="normal bold 0.4rem myFirstFont",r.fillStyle="black";var J=Math.floor(.07*m),O=Math.floor(.906*g),P=Math.floor(.943*g);r.fillText("BY"+e.user.name,J,O),r.fillText(l,J,P)}else if(3==c){r.font="normal bold 1.333333rem myFirstFont",r.fillStyle="white";var _=Math.floor(.103*m),L=Math.floor(.87*g),W=Math.floor(.91*g),j=Math.floor(.947*g);r.fillText(t.getDate(),_,L),r.font="normal bold 0.4rem myFirstFont",r.fillText(o+"."+a,_,W),r.fillText("BY"+e.user.name,_,j)}else if(4==c){r.font="normal bold 0.453333rem myFirstFont",r.fillStyle="black",r.textAlign="right";var G=Math.floor(.924*m),H=Math.floor(.145*g),V=Math.floor(.184*g),q=Math.floor(.223*g);r.fillText(l,G,H),r.fillText(a,G,V),r.fillText("BY"+e.user.name,G,q)}else if(5==c){r.font="normal bold 0.453333rem myFirstFont",r.fillStyle="#7a8776";var z=Math.floor(.773*m),K=Math.floor(.736*g);r.fillText("BY"+e.user.name,z,K)}else if(6==c){r.font="normal bold 0.46rem myFirstFont",r.fillStyle="#fff";var Q=Math.floor(.047*m),X=Math.floor(.915*g);r.fillText("BY"+e.user.name,Q,X)}else if(7==c){r.font="normal bold 0.4rem myFirstFont",r.fillStyle="#000";var Z=Math.floor(.07*m),ee=Math.floor(.856*g),te=Math.floor(.883*g),le=Math.floor(.91*g);r.fillText(l,Z,ee),r.fillText(a,Z,te),r.fillText("BY"+e.user.name,Z,le)}else if(8==c){r.font="normal bold 1.333333rem myFirstFont",r.fillStyle="#96bfad";var oe=Math.floor(.07*m),ae=Math.floor(.106*g),re=Math.floor(.146*g),ne=Math.floor(.186*g);r.fillText(t.getDate(),oe,ae),r.font="normal bold 0.4rem myFirstFont",r.fillText(a,oe,re),r.fillText("BY"+e.user.name,oe,ne)}}}function f(e){return document.getElementById(e).getContext("2d")}function i(){e.showcanvas=!1;var t=document.getElementById("main"),l=t.toDataURL("image/jpg");e.canvasImg=l,e.btnText="长按保存至手机，再发到朋友圈炫耀"}var s=JSON.parse(sessionStorage.getItem("user"));e.user=s,e.btnText="立即使用",e.loading=!1,e.showcanvas=!0,e.canvasImg="";var m=document.documentElement.clientWidth,h=Math.floor(m),g=Math.floor(1.83*m);$("#main").attr("width",h+"px"),$("#main").attr("height",g+"px"),console.log(e.user),e.user.name.length>=3&&(e.user.name=e.user.name[0]+e.user.name[1]+e.user.name[2]);var c=r.num;e.page=1,e.showImg="../../assets/images/morning/type"+c+"/img_"+e.page+".png";for(var M=1;6>M;M++){var x="../../assets/images/goodnight/type"+c+"/img_"+M+".png";$(".hideImg").append("<img src="+x+">")}e.editInformation=function(){o.path("editInformation")},e.useTemplatePage=function(){i(),e.btnText="长按保存至手机，再发到朋友圈炫耀"},e.goBack=function(){l.history.back()},e.closeText=function(){e.user.iscomplete=!0},e.changeImg=function(){e.loading=!0,e.page>=5?(e.page=1,e.showImg="../../assets/images/morning/type"+c+"/img_"+e.page+".png",e.loading=!1):(e.page+=1,e.showImg="../../assets/images/morning/type"+c+"/img_"+e.page+".png",e.loading=!1),n()},$(function(){n()})}]);
index.controller("useNightCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,l,o,e,a,r){function f(){t.btnText="立即使用",t.showcanvas=!0;var l=new Date,o=l.getFullYear()+"/"+(l.getMonth()+1)+"/"+l.getDate(),e=l.getMonth()+1;switch(e){case 1:e="J A N";break;case 2:e="F E B";break;case 3:e="M A R";break;case 4:e="A P R";break;case 5:e="M A Y";break;case 6:e="J U N";break;case 7:e="J U L";break;case 8:e="A U G";break;case 9:e="S E P";break;case 10:e="O C T";break;case 11:e="N O V";break;case 12:e="D E C"}var a=l.getDay();switch(a){case 0:a="Sunday";break;case 1:a="Monday";break;case 2:a="Tuesday";break;case 3:a="Wednesday";break;case 4:a="Thursday";break;case 5:a="Friday";break;case 6:a="Saturday"}var r=n("main");r.width,r.height;r.clearRect(0,0,1e3,1e3);var f=new Image;f.src=t.showImg,f.onload=function(){if(r.drawImage(f,0,0,m,M),navigator.userAgent.match(/iphone/i)){if(1==g){r.font="normal bold 24px myFirstFont",r.fillStyle="#545454";var n=Math.floor(.07*s),i=Math.floor(.866*M),h=Math.floor(.897*M),x=Math.floor(.923*M);r.fillText(t.user.name,n,i),r.fillText(e+"."+a,n,h),r.fillText(o,n,x)}else if(2==g){r.font="normal bold 24px myFirstFont",r.fillStyle="#fff";for(var T=Math.floor(.625*s),u=Math.floor(.826*s),c=Math.floor(.716*M),y=Math.floor(.88*M),d=Math.floor(.92*M),F=0;F<t.user.name.length;F++)r.fillText(t.user.name[F],u,c+Math.floor(.0437*M)*F);r.fillText(e+"."+a,T,y),r.fillText(o,T,d)}else if(3==g){r.font="normal bold 24px myFirstFont",r.fillStyle="white";var b=Math.floor(.066*s),v=Math.floor(.8*s),p=Math.floor(.076*M),S=Math.floor(.105*M),w=Math.floor(.329*M);r.fillText(l.getMonth()+1+"/"+l.getDate(),b,p),r.fillText(a,b,S);for(var k=0;k<t.user.name.length;k++)r.fillText(t.user.name[k],v,w+Math.floor(.0437*M)*k)}else if(4==g){r.font="normal bold 100px myFirstFont",r.fillStyle="white";var I=Math.floor(.103*s),D=Math.floor(.8*s),Y=Math.floor(.87*M),$=Math.floor(.91*M),A=Math.floor(.947*M),B=Math.floor(.329*M);r.fillText(l.getDate(),I,Y),r.font="normal bold 24px myFirstFont",r.fillText(e+"."+a,I,$),r.fillText(l.getFullYear(),I,A);for(var E=0;E<t.user.name.length;E++)r.fillText(t.user.name[E],D,B+Math.floor(.0437*M)*E)}else if(5==g){r.font="normal bold 24px myFirstFont",r.fillStyle="#545454";var N=Math.floor(.103*s),C=Math.floor(.8*s),J=Math.floor(.9*M),P=Math.floor(.94*M),R=Math.floor(.329*M);r.fillText(e+"."+a,N,J),r.fillText(o,N,P),r.fillStyle="#fff";for(var U=0;U<t.user.name.length;U++)r.fillText(t.user.name[U],C,R+Math.floor(.0437*M)*U)}else if(6==g){r.font="normal bold 124px myFirstFont",r.fillStyle="#fff";var _=Math.floor(.07*s),O=Math.floor(.479*s),L=Math.floor(.106*M),W=Math.floor(.146*M),j=Math.floor(.186*M),G=Math.floor(.434*M);r.fillText(l.getDate(),_,L),r.font="normal bold 24px myFirstFont",r.fillText(e+"."+a,_,W),r.fillText(l.getFullYear(),_,j);for(var V=0;V<t.user.name.length;V++)r.fillText(t.user.name[V],O,G+Math.floor(.0437*M)*V)}else if(7==g){r.font="normal bold 24px myFirstFont",r.fillStyle="#545454";var q=Math.floor(.066*s),z=Math.floor(.059*M),H=Math.floor(.088*M);r.fillText(e+"."+a,q,z),r.fillText(o,q,H)}else if(8==g){r.font="normal bold 124px myFirstFont",r.fillStyle="#1b273";var K=Math.floor(.08*s),Q=Math.floor(.146*M),X=Math.floor(.186*M),Z=Math.floor(.226*M),tt=Math.floor(.9078*M);r.fillText(l.getDate(),K,Q),r.font="normal bold 24px myFirstFont",r.fillText(e+"."+a,K,X),r.fillText(l.getFullYear(),K,Z),r.fillStyle="#535353",r.fillText("BY"+t.user.name,K,tt)}}else if(1==g){r.font="normal bold 0.32rem myFirstFont",r.fillStyle="#545454";var lt=Math.floor(.07*s),ot=Math.floor(.866*M),et=Math.floor(.897*M),at=Math.floor(.923*M);r.fillText(t.user.name,lt,ot),r.fillText(e+"."+a,lt,et),r.fillText(o,lt,at)}else if(2==g){r.font="normal bold 0.4rem myFirstFont",r.fillStyle="#fff";for(var rt=Math.floor(.625*s),ft=Math.floor(.826*s),nt=Math.floor(.716*M),it=Math.floor(.88*M),ht=Math.floor(.92*M),st=0;st<t.user.name.length;st++)r.fillText(t.user.name[st],ft,nt+Math.floor(.0437*M)*st);r.fillText(e+"."+a,rt,it),r.fillText(o,rt,ht)}else if(3==g){r.font="normal bold 0.42rem myFirstFont",r.fillStyle="white";var mt=Math.floor(.066*s),Mt=Math.floor(.8*s),gt=Math.floor(.076*M),xt=Math.floor(.105*M),Tt=Math.floor(.329*M);r.fillText(l.getMonth()+1+"/"+l.getDate(),mt,gt),r.fillText(a,mt,xt);for(var ut=0;ut<t.user.name.length;ut++)r.fillText(t.user.name[ut],Mt,Tt+Math.floor(.0437*M)*ut)}else if(4==g){r.font="normal bold 1.333333rem myFirstFont",r.fillStyle="white";var ct=Math.floor(.103*s),yt=Math.floor(.8*s),dt=Math.floor(.87*M),Ft=Math.floor(.91*M),bt=Math.floor(.947*M),vt=Math.floor(.329*M);r.fillText(l.getDate(),ct,dt),r.font="normal bold 0.4rem myFirstFont",r.fillText(e+"."+a,ct,Ft),r.fillText(l.getFullYear(),ct,bt);for(var pt=0;pt<t.user.name.length;pt++)r.fillText(t.user.name[pt],yt,vt+Math.floor(.0437*M)*pt)}else if(5==g){r.font="normal bold 0.453333rem myFirstFont",r.fillStyle="#545454";var St=Math.floor(.103*s),wt=Math.floor(.8*s),kt=Math.floor(.9*M),It=Math.floor(.94*M),Dt=Math.floor(.329*M);r.fillText(e+"."+a,St,kt),r.fillText(o,St,It),r.fillStyle="#fff";for(var Yt=0;Yt<t.user.name.length;Yt++)r.fillText(t.user.name[Yt],wt,Dt+Math.floor(.0437*M)*Yt)}else if(6==g){r.font="normal bold 1.653333rem myFirstFont",r.fillStyle="#fff";var $t=Math.floor(.07*s),At=Math.floor(.479*s),Bt=Math.floor(.106*M),Et=Math.floor(.146*M),Nt=Math.floor(.186*M),Ct=Math.floor(.434*M);r.fillText(l.getDate(),$t,Bt),r.font="normal bold 0.4rem myFirstFont",r.fillText(e+"."+a,$t,Et),r.fillText(l.getFullYear(),$t,Nt);for(var Jt=0;Jt<t.user.name.length;Jt++)r.fillText(t.user.name[Jt],At,Ct+Math.floor(.0437*M)*Jt)}else if(7==g){r.font="normal bold 0.42rem myFirstFont",r.fillStyle="#545454";var Pt=Math.floor(.066*s),Rt=Math.floor(.059*M),Ut=Math.floor(.088*M);r.fillText(e+"."+a,Pt,Rt),r.fillText(o,Pt,Ut)}else if(8==g){r.font="normal bold 1.653333rem myFirstFont",r.fillStyle="#1b273";var _t=Math.floor(.08*s),Ot=Math.floor(.146*M),Lt=Math.floor(.186*M),Wt=Math.floor(.226*M),jt=Math.floor(.9078*M);r.fillText(l.getDate(),_t,Ot),r.font="normal bold 0.4rem myFirstFont",r.fillText(e+"."+a,_t,Lt),r.fillText(l.getFullYear(),_t,Wt),r.fillStyle="#535353",r.fillText("BY"+t.user.name,_t,jt)}}}function n(t){return document.getElementById(t).getContext("2d")}function i(){t.showcanvas=!1;var l=document.getElementById("main"),o=l.toDataURL("image/jpg");t.canvasImg=o,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var h=JSON.parse(sessionStorage.getItem("user"));t.user=h,t.btnText="立即使用",t.loading=!1,t.showcanvas=!0,t.canvasImg="";var s=document.documentElement.clientWidth,m=Math.floor(s),M=Math.floor(1.83*s);$("#main").attr("width",m+"px"),$("#main").attr("height",M+"px"),console.log(t.user);var g=r.num;t.page=1,t.showImg="../../assets/images/goodnight/type"+g+"/img_"+t.page+".png";for(var x=1;6>x;x++){var T="../../assets/images/goodnight/type"+g+"/img_"+x+".png";$(".hideImg").append("<img src="+T+">")}t.editInformation=function(){e.path("editInformation")},t.useTemplatePage=function(){i(),t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(){o.history.back()},t.closeText=function(){t.user.iscomplete=!0},t.changeImg=function(){t.loading=!0,t.page>=5?(t.page=1,t.showImg="../../assets/images/goodnight/type"+g+"/img_"+t.page+".png",t.loading=!1):(t.page+=1,t.showImg="../../assets/images/goodnight/type"+g+"/img_"+t.page+".png",t.loading=!1),f()},$(function(){f()})}]);
index.controller("useNoticeCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,o,l,e,a,f){function i(){t.btnText="一键生成海报",t.showcanvas=!0;var o=new Date,l=o.getFullYear()+"/"+(o.getMonth()+1)+"/"+o.getDate(),e=o.getMonth()+1;switch(e){case 1:e="JAN";break;case 2:e="FEB";break;case 3:e="MAR";break;case 4:e="APR";break;case 5:e="MAY";break;case 6:e="JUN";break;case 7:e="JUL";break;case 8:e="AUG";break;case 9:e="SEP";break;case 10:e="OCT";break;case 11:e="NOV";break;case 12:e="DEC"}var a=o.getDay();switch(a){case 0:a="Sunday";break;case 1:a="Monday";break;case 2:a="Tuesday";break;case 3:a="Wednesday";break;case 4:a="Thursday";break;case 5:a="Friday";break;case 6:a="Saturday"}var f=r("main");f.width,f.height;f.clearRect(0,0,1e3,1e3);var i=new Image;i.src=t.showImg,i.onload=function(){if(f.drawImage(i,0,0,h,x),navigator.userAgent.match(/iphone/i)){if(1==d){f.font="normal bold 36px myFirstFont",f.fillStyle="#fff";var o=Math.floor(.1133*s),r=Math.floor(.88*x),n=Math.floor(.91*x),m=Math.floor(.94*x);f.fillText(t.name,o,r),f.font="normal bold 24px myFirstFont",f.fillText(e+"."+a,o,n),f.fillText(l,o,m)}else if(2==d&&1==t.page){f.font="normal bold 36px myFirstFont",f.fillStyle="#fff";var M=Math.floor(.5733*s),p=Math.floor(.704*s),g=Math.floor(.3999*x),y=Math.floor(.6372*x),F=Math.floor(.6672*x),b=Math.floor(.6972*x);f.fillText(t.zhekou,M,g),f.fillStyle="#333",f.fillText(t.name,p,y),f.font="normal bold 24px myFirstFont",f.fillText(e+"."+a,p,F),f.fillText(l,p,b)}else if(2==d&&2==t.page){f.font="normal bold 30px myFirstFont",f.fillStyle="#333";var T=Math.floor(.3673*s),u=Math.floor(.211*s),c=Math.floor(.6567*x),S=Math.floor(.8685*x),v=Math.floor(.8985*x),w=Math.floor(.9285*x);f.fillText(t.lijian,T,c),f.font="normal bold 36px myFirstFont",f.fillStyle="#fff",f.fillText(t.name,u,S),f.font="normal bold 24px myFirstFont",f.fillStyle="#333",f.fillText(e+"."+a,u,v),f.fillText(l,u,w)}else if(3==d&&1==t.page){f.font="normal bold 100px myFirstFont",f.fillStyle="#b8742b";var $=Math.floor(.1917*s),k=Math.floor(.5803*s),I=Math.floor(.113*s),O=Math.floor(.608*x),P=Math.floor(.8785*x),D=Math.floor(.9085*x),A=Math.floor(.9385*x);f.fillText(t.starttime,$,O),f.fillText(t.endtime,k,O),f.font="normal bold 36px myFirstFont",f.fillStyle="#333",f.fillText(t.name,I,P),f.font="normal bold 24px myFirstFont",f.fillText(e+"."+a,I,D),f.fillText(l,I,A)}else if(3==d&&2==t.page){f.font="normal bold 48px myFirstFont",f.fillStyle="#fff";var E=Math.floor(.246*s),N=Math.floor(.5667*s),j=Math.floor(.113*s),B=Math.floor(.463*x),C=Math.floor(.8785*x),J=Math.floor(.9085*x),R=Math.floor(.9385*x);f.fillText(t.starttime1,E,B),f.fillText(t.endtime1,N,B),f.font="normal bold 36px myFirstFont",f.fillText(t.name,j,C),f.font="normal bold 24px myFirstFont",f.fillText(e+"."+a,j,J),f.fillText(l,j,R)}else if(4==d&&1==t.page){f.font="normal bold 48px myFirstFont",f.fillStyle="#000";var U=Math.floor(.347*s),_=Math.floor(.58*x);f.fillText(t.discount,U,_)}else if(4==d&&2==t.page){f.font="normal bold 100px myFirstFont",f.fillStyle="#f02964";var z=Math.floor(.246*s),L=Math.floor(.236*s),W=Math.floor(.5373*s),Y=Math.floor(.422*x),G=Math.floor(.6808*x);f.fillText(t.discount,z,Y),f.font="normal bold 36px myFirstFont",f.fillStyle="#333",f.fillText(t.starttime2,L,G),f.fillText(t.endtime2,W,G)}else if(5==d&&1==t.page){f.font="normal bold 100px myFirstFont",f.fillStyle="#000";var V=Math.floor(.1426*s),q=Math.floor(.6013*s),H=Math.floor(.31*s),K=Math.floor(.1333*s),Q=Math.floor(.4764*x),X=Math.floor(.7869*x),Z=(Math.floor(.7669*x),Math.floor(.89*x)),tt=Math.floor(.92*x),ot=Math.floor(.95*x);f.fillText(t.starttime3,V,Q),f.fillText(t.endtime3,q,Q),f.font="normal bold 36px myFirstFont",f.fillStyle="#fb5b64",f.fillText(t.business,H,X),f.fillStyle="#333",f.fillText(t.name,K,Z),f.font="normal bold 24px myFirstFont",f.fillText(e+"."+a,K,tt),f.fillText(l,K,ot)}else if(5==d&&2==t.page){f.font="normal bold 30px myFirstFont",f.fillStyle="#f6c33b";var lt=Math.floor(.298*s),et=Math.floor(.415*s),at=Math.floor(.1333*s),ft=Math.floor(.801*x),it=Math.floor(.89*x),rt=Math.floor(.92*x),nt=Math.floor(.95*x);f.fillText(t.businessMonth,lt,ft),f.fillText(t.businessDate,et,ft),f.fillStyle="#333",f.fillText(t.name,at,it),f.font="normal bold 24px myFirstFont",f.fillText(e+"."+a,at,rt),f.fillText(l,at,nt)}}else if(1==d){f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#fff";var mt=Math.floor(.1133*s),st=Math.floor(.88*x),ht=Math.floor(.91*x),xt=Math.floor(.94*x);f.fillText(t.name,mt,st),f.font="normal bold 0.32rem myFirstFont",f.fillText(e+"."+a,mt,ht),f.fillText(l,mt,xt)}else if(2==d&&1==t.page){f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#fff";var dt=Math.floor(.5733*s),Mt=Math.floor(.704*s),pt=Math.floor(.3999*x),gt=Math.floor(.6372*x),yt=Math.floor(.6672*x),Ft=Math.floor(.6972*x);f.fillText(t.zhekou,dt,pt),f.fillStyle="#333",f.fillText(t.name,Mt,gt),f.font="normal bold 0.32rem myFirstFont",f.fillText(e+"."+a,Mt,yt),f.fillText(l,Mt,Ft)}else if(2==d&&2==t.page){f.font="normal bold 0.4rem myFirstFont",f.fillStyle="#333";var bt=Math.floor(.3673*s),Tt=Math.floor(.211*s),ut=Math.floor(.6567*x),ct=Math.floor(.8685*x),St=Math.floor(.8985*x),vt=Math.floor(.9285*x);f.fillText(t.lijian,bt,ut),f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#fff",f.fillText(t.name,Tt,ct),f.font="normal bold 0.32rem myFirstFont",f.fillStyle="#333",f.fillText(e+"."+a,Tt,St),f.fillText(l,Tt,vt)}else if(3==d&&1==t.page){f.font="normal bold 1.133333rem myFirstFont",f.fillStyle="#b8742b";var wt=Math.floor(.2017*s),$t=Math.floor(.5803*s),kt=Math.floor(.113*s),It=Math.floor(.608*x),Ot=Math.floor(.8785*x),Pt=Math.floor(.9085*x),Dt=Math.floor(.9385*x);f.fillText(t.starttime,wt,It),f.fillText(t.endtime,$t,It),f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#333",f.fillText(t.name,kt,Ot),f.font="normal bold 0.32rem myFirstFont",f.fillText(e+"."+a,kt,Pt),f.fillText(l,kt,Dt)}else if(3==d&&2==t.page){f.font="normal bold 0.64rem myFirstFont",f.fillStyle="#fff";var At=Math.floor(.246*s),Et=Math.floor(.5667*s),Nt=Math.floor(.113*s),jt=Math.floor(.463*x),Bt=Math.floor(.8785*x),Ct=Math.floor(.9085*x),Jt=Math.floor(.9385*x);f.fillText(t.starttime1,At,jt),f.fillText(t.endtime1,Et,jt),f.font="normal bold 0.48rem myFirstFont",f.fillText(t.name,Nt,Bt),f.font="normal bold 0.32rem myFirstFont",f.fillText(e+"."+a,Nt,Ct),f.fillText(l,Nt,Jt)}else if(4==d&&1==t.page){f.font="normal bold 0.64rem myFirstFont",f.fillStyle="#000";var Rt=Math.floor(.347*s),Ut=Math.floor(.58*x);f.fillText(t.discount,Rt,Ut)}else if(4==d&&2==t.page){f.font="normal bold 1.333333rem myFirstFont",f.fillStyle="#f02964";var _t=Math.floor(.246*s),zt=Math.floor(.236*s),Lt=Math.floor(.5373*s),Wt=Math.floor(.422*x),Yt=Math.floor(.6808*x);f.fillText(t.discount,_t,Wt),f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#333",f.fillText(t.starttime2,zt,Yt),f.fillText(t.endtime2,Lt,Yt)}else if(5==d&&1==t.page){f.font="normal bold 1.333333rem myFirstFont",f.fillStyle="#000";var Gt=Math.floor(.1426*s),Vt=Math.floor(.6013*s),qt=Math.floor(.31*s),Ht=Math.floor(.1333*s),Kt=Math.floor(.4764*x),Qt=Math.floor(.7869*x),Xt=(Math.floor(.7669*x),Math.floor(.89*x)),Zt=Math.floor(.92*x),to=Math.floor(.95*x);f.fillText(t.starttime3,Gt,Kt),f.fillText(t.endtime3,Vt,Kt),f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#fb5b64",f.fillText(t.business,qt,Qt),f.fillStyle="#333",f.fillText(t.name,Ht,Xt),f.font="normal bold 0.32rem myFirstFont",f.fillText(e+"."+a,Ht,Zt),f.fillText(l,Ht,to)}else if(5==d&&2==t.page){f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#f6c33b";var oo=Math.floor(.298*s),lo=Math.floor(.415*s),eo=Math.floor(.1333*s),ao=Math.floor(.801*x),fo=Math.floor(.89*x),io=Math.floor(.92*x),ro=Math.floor(.95*x);f.fillText(t.businessMonth,oo,ao),f.fillText(t.businessDate,lo,ao),f.fillStyle="#333",f.fillText(t.name,eo,fo),f.font="normal bold 0.32rem myFirstFont",f.fillText(e+"."+a,eo,io),f.fillText(l,eo,ro)}}}function r(t){return document.getElementById(t).getContext("2d")}function n(){t.showcanvas=!1;var o=document.getElementById("main"),l=o.toDataURL("image/jpg");t.canvasImg=l,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var m=JSON.parse(sessionStorage.getItem("user"));t.user=m,t.btnText="一键生成海报",t.loading=!1,t.showcanvas=!0,t.showmodel=!1,t.canvasImg="",t.name="请添加",t.zhekou="八",t.lijian="000",t.starttime="08",t.endtime="24",t.starttime1="08:00",t.endtime1="24:00",t.starttime2="2017.05.01",t.endtime2="2017.05.05",t.starttime3="01",t.endtime3="05",t.discount="00",t.business="06",t.businessMonth="05",t.businessDate="01";var s=document.documentElement.clientWidth,h=Math.floor(s),x=Math.floor(1.83*s);$("#main").attr("width",h+"px"),$("#main").attr("height",x+"px"),console.log(t.user);var d=f.num;t.page=1,t.showImg="../../assets/images/notice/type"+d+"/img_"+t.page+".png";for(var M=1;3>M;M++){var p="../../assets/images/notice/type"+d+"/img_"+M+".png";$(".hideImg").append("<img src="+p+">")}t.editInformation=function(t){t.stopPropagation(),e.path("editInformation")},t.useTemplatePage=function(o){o.stopPropagation(),n(),t.showmodel=!0,t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(t){t.stopPropagation(),l.history.back()},t.chengeText=function(){t.showmodel||(1==d?$(".name-input-fixed").show():2==d&&1==t.page?$(".name-input-fixed-1").show():2==d&&2==t.page?$(".name-input-fixed-2").show():3==d&&1==t.page?$(".name-input-fixed-3").show():3==d&&2==t.page?$(".name-input-fixed-4").show():4==d&&1==t.page?$(".name-input-fixed-5").show():4==d&&2==t.page?$(".name-input-fixed-6").show():5==d&&1==t.page?$(".name-input-fixed-7").show():5==d&&2==t.page&&$(".name-input-fixed-8").show())},t.updateText=function(){i(),1==d?$(".name-input-fixed").fadeOut(50):2==d&&1==t.page?$(".name-input-fixed-1").fadeOut(50):2==d&&2==t.page?$(".name-input-fixed-2").fadeOut(50):3==d&&1==t.page?$(".name-input-fixed-3").fadeOut(50):3==d&&2==t.page?$(".name-input-fixed-4").fadeOut(50):4==d&&1==t.page?$(".name-input-fixed-5").fadeOut(50):4==d&&2==t.page?$(".name-input-fixed-6").fadeOut(50):5==d&&1==t.page?$(".name-input-fixed-7").fadeOut(50):5==d&&2==t.page&&$(".name-input-fixed-8").fadeOut(50)},t.closeText=function(o){o.stopPropagation(),t.user.iscomplete=!0},t.changeImg=function(o){o.stopPropagation(),t.loading=!0,t.showmodel=!1,t.page>=2?(t.page=1,t.showImg="../../assets/images/notice/type"+d+"/img_"+t.page+".png",t.loading=!1):(t.page+=1,t.showImg="../../assets/images/notice/type"+d+"/img_"+t.page+".png",t.loading=!1),i()},$(function(){i()})}]);
index.controller("useGreetCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,e,o,a,n,l){function i(){t.btnText="一键生成海报",t.showcanvas=!0;var e=f("main");e.width,e.height;e.clearRect(0,0,1e3,1e3);var o=new Image;o.src=t.showImg,o.onload=function(){if(e.drawImage(o,0,0,m,p),navigator.userAgent.match(/iphone/i)){if(1==c&&1==t.page){e.font="normal bold 72px myFirstFont",e.fillStyle="#fff";var a=Math.floor(.066*g),n=Math.floor(.1466*g),l=Math.floor(.145*p),i=Math.floor(.349*p);e.fillText(t.title,a,l),e.font="normal bold 30px myFirstFont",e.fillStyle="#0f0f0b",e.fillText(t.desc,n,i)}else if(1==c&&2==t.page){e.font="normal bold 30px myFirstFont",e.fillStyle="#fff";var f=Math.floor(.586*g),r=Math.floor(.731*p),s=Math.floor(.6848*p),d=Math.floor(.638*p);e.fillText(t.desc3,f,r),e.fillText(t.desc2,f,s),e.fillText(t.desc1,f,d)}}else if(1==c&&1==t.page){e.font="normal bold 0.96rem myFirstFont",e.fillStyle="#fff";var h=Math.floor(.066*g),u=Math.floor(.1466*g),x=Math.floor(.145*p),w=Math.floor(.349*p);e.fillText(t.title,h,x),e.font="normal bold 0.4rem myFirstFont",e.fillStyle="#0f0f0b",e.fillText(t.desc,u,w)}else if(1==c&&2==t.page){e.font="normal bold 0.4rem myFirstFont",e.fillStyle="#fff";var y=Math.floor(.586*g),v=Math.floor(.731*p),M=Math.floor(.6848*p),T=Math.floor(.638*p);e.fillText(t.desc3,y,v),e.fillText(t.desc2,y,M),e.fillText(t.desc1,y,T)}}}function f(t){return document.getElementById(t).getContext("2d")}function r(){t.showcanvas=!1;var e=document.getElementById("main"),o=e.toDataURL("image/jpg");t.canvasImg=o,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var s=JSON.parse(sessionStorage.getItem("user"));t.user=s,t.btnText="一键生成海报",t.loading=!1,t.showcanvas=!0,t.showmodel=!1,t.canvasImg="",t.title="点击添加标题",t.desc="点击添加海报描述",t.desc1="点击添加海报描述",t.desc2="点击添加海报描述",t.desc3="点击添加海报描述";var g=document.documentElement.clientWidth,m=Math.floor(g),p=Math.floor(1.83*g);$("#main").attr("width",m+"px"),$("#main").attr("height",p+"px"),console.log(t.user);var c=l.num;t.page=1,t.showImg="../../assets/images/greet/type"+c+"/img_"+t.page+".png";for(var d=1;3>d;d++){var h="../../assets/images/greet/type"+c+"/img_"+d+".png";$(".hideImg").append("<img src="+h+">")}t.editInformation=function(t){t.stopPropagation(),a.path("editInformation")},t.useTemplatePage=function(e){e.stopPropagation(),r(),t.showmodel=!0,t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(t){t.stopPropagation(),o.history.back()},t.chengeText=function(){t.showmodel||(1==c&&1==t.page?$(".name-input-fixed-1").show():1==c&&2==t.page&&$(".name-input-fixed-2").show())},t.updateText=function(){i(),1==c&&1==t.page?$(".name-input-fixed-1").fadeOut(50):1==c&&2==t.page&&$(".name-input-fixed-2").fadeOut(50)},t.closeText=function(e){e.stopPropagation(),t.user.iscomplete=!0},t.changeImg=function(e){e.stopPropagation(),t.loading=!0,t.showmodel=!1,t.page>=2?(t.page=1,t.showImg="../../assets/images/greet/type"+c+"/img_"+t.page+".png",t.loading=!1):(t.page+=1,t.showImg="../../assets/images/greet/type"+c+"/img_"+t.page+".png",t.loading=!1),i()},$(function(){i()})}]);
