...
index.controller("homeCtrl",["$scope","$http","$window","$location","$rootScope",function(e,t,i,o,s){document.title="小悦助手",t.post("/user/mine.json",postCfg).then(function(t){if(console.log(t),-1===t.data.code)e.isLogin=!1;else if(1===t.data.code){e.isLogin=!0;var i=t.data.data;""===i.avatar?i.avatar="../../assets/images/head-none.png":i.avatar=picBasePath+i.avatar,e.user=i,sessionStorage.setItem("user",JSON.stringify(i))}},function(e){}),e.personalCenter=function(){o.path("personalCenter")},e.setIn=function(){},e.vipCenter=function(){o.path("vipCenter")},e.showTemplate=function(t){switch(t){case 1:if(e.user.iscomplete===!1)return void $(".prompt-fixed").show();o.path("morningNight");break;case 2:if(e.user.iscomplete===!1)return void $(".prompt-fixed").show();o.path("guest");break;case 3:if(e.user.iscomplete===!1)return void $(".prompt-fixed").show();o.path("notice");break;case 4:if(e.user.iscomplete===!1)return void $(".prompt-fixed").show();o.path("promotion");break;case 5:if(e.user.iscomplete===!1)return void $(".prompt-fixed").show();o.path("holiday");break;case 6:if(e.user.iscomplete===!1)return void $(".prompt-fixed").show();o.path("joke");break;case 7:if(e.user.iscomplete===!1)return void $(".prompt-fixed").show();o.path("life")}},e.goHomePage=function(){return e.user.iscomplete===!1?void $(".prompt-fixed").show():void(window.location.href="/yueAssistant/build/html/homePage/"+e.user.uuid)},e.promptFalse=function(){$(".prompt-fixed").fadeOut(10)},e.promptTrue=function(){$(".prompt-fixed").fadeOut(),o.path("editInformation")};var a={url:i.location.href.split("#")[0]};t.post("/user/unl/wzinfo.json",a,postCfg).then(function(e){1===e.data.code&&(wx.config({debug:!1,appId:e.data.data.appid,timestamp:e.data.data.timestamp,nonceStr:e.data.data.noncestr,signature:e.data.data.signature,jsApiList:["checkJsApi","onMenuShareAppMessage","onMenuShareTimeline"]}),wx.ready(function(){wx.onMenuShareAppMessage({title:"美图助手",desc:"美图助手",link:"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx45618195d7038b9d&redirect_uri=http://syrapi.yueyishujia.com/yueAssistant/build/html/&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect",imgUrl:"http://syrapi.yueyishujia.com/yueAssistant/assets/images/logo.png",type:"link",dataUrl:"",success:function(){},cancel:function(){}}),wx.onMenuShareTimeline({title:"美图助手",desc:"美图助手",link:"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx45618195d7038b9d&redirect_uri=http://syrapi.yueyishujia.com/yueAssistant/build/html/&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect",imgUrl:"http://syrapi.yueyishujia.com/yueAssistant/assets/images/logo.png",success:function(){},cancel:function(){}})}))},function(e){})}]);
...
index.controller("useActiveCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,e,l,o,a,f){function r(){t.btnText="一键生成海报",t.showcanvas=!0;var e=new Date,l=e.getFullYear()+"/"+(e.getMonth()+1)+"/"+e.getDate(),o=e.getMonth()+1;switch(o){case 1:o="JAN";break;case 2:o="FEB";break;case 3:o="MAR";break;case 4:o="APR";break;case 5:o="MAY";break;case 6:o="JUN";break;case 7:o="JUL";break;case 8:o="AUG";break;case 9:o="SEP";break;case 10:o="OCT";break;case 11:o="NOV";break;case 12:o="DEC"}var a=e.getDay();switch(a){case 0:a="Sunday";break;case 1:a="Monday";break;case 2:a="Tuesday";break;case 3:a="Wednesday";break;case 4:a="Thursday";break;case 5:a="Friday";break;case 6:a="Saturday"}var f=i("main");f.width,f.height;f.clearRect(0,0,1e3,1e3);var r=new Image;r.src=t.showImg,r.onload=function(){if(f.drawImage(r,0,0,m,x),navigator.userAgent.match(/iphone/i)){if(1==M){f.font="normal bold 60px myFirstFont",f.fillStyle="#fff",f.textAlign="left";var o=Math.floor(.212*h),a=Math.floor(.5767*h),i=Math.floor(.5*h),n=Math.floor(.394*x),s=Math.floor(.3284*x);f.fillText(t.startTime,o,n),f.fillText(t.endTime,a,n),f.fillStyle="#000",f.textAlign="center",f.fillText(t.name,i,s)}else if(2==M){f.font="normal bold 34px myFirstFont",f.fillStyle="#fff",f.textAlign="center";var d=Math.floor(.5*h),c=(Math.floor(.5667*h),Math.floor(.2267*h)),u=Math.floor(.3017*h),T=Math.floor(.3767*h),y=Math.floor(.6296*h),g=Math.floor(.6996*h),p=Math.floor(.7696*h),F=Math.floor(.1147*x),b=Math.floor(.3082*x),v=Math.floor(.737*x);f.fillText(l,d,F),f.font="normal bold 48px myFirstFont",f.fillStyle="#000",f.fillText(t.name,d,b),f.fillText(t.startHour,c,v),f.fillText(t.startMinute,T,v),f.fillText(t.endHour,y,v),f.fillText(t.endMinute,p,v),f.fillStyle="#fff",f.fillText(":",u,v),f.fillText(":",g,v)}else if(3==M){f.font="normal bold 48px myFirstFont",f.fillStyle="#000",f.textAlign="center";var S=(Math.floor(.5*h),Math.floor(.5667*h),Math.floor(.2267*h)),A=Math.floor(.3017*h),$=Math.floor(.3767*h),w=Math.floor(.6296*h),k=Math.floor(.6996*h),P=Math.floor(.7696*h),D=(Math.floor(.1147*x),Math.floor(.3082*x),Math.floor(.802*x));f.fillText(t.startHour,S,D),f.fillText(t.startMinute,$,D),f.fillText(t.endHour,w,D),f.fillText(t.endMinute,P,D),f.fillText(":",A,D),f.fillText(":",k,D)}else if(4==M){f.font="normal bold 36px myFirstFont",f.fillStyle="#fff";var O=Math.floor(.747*h),I=Math.floor(.922*x);f.fillText(t.name,O,I)}else if(5==M){f.font="normal bold 72px myFirstFont",f.fillStyle="#244678",f.textAlign="left";var H=Math.floor(.2693*h),E=Math.floor(.522*h),B=Math.floor(.69*h),C=Math.floor(.3355*x),J=Math.floor(.4669*x),N=Math.floor(.616*x),R=Math.floor(.701*x);f.fillText(t.startMonth,H,C),f.fillText(t.startDate,E,C),f.fillText(t.endMonth,H,J),f.fillText(t.endDate,E,J),f.textAlign="center",f.fillStyle="#fff",f.fillText(t.colorPrice,B,N),f.fillText(t.permPrice,B,R)}else if(6==M){f.font="normal bold 45px myFirstFont",f.fillStyle="#fff",f.textAlign="right";var U=Math.floor(.951*h),Y=Math.floor(.244*x);f.fillText(t.name,U,Y)}else if(7==M){var L=e.getDate()+"/"+(e.getMonth()+1)+"/"+e.getFullYear();f.font="normal bold 48px myFirstFont",f.fillStyle="#000",f.textAlign="center";var W=Math.floor(.5*h),j=Math.floor(.6587*x);f.fillText(L,W,j)}else if(8==M){f.font="normal bold 300px myFirstFont",f.fillStyle="#af0008",f.textAlign="center";var G=Math.floor(.5*h),V=Math.floor(.7261*x);f.fillText(t.day,G,V)}else if(9==M){f.font="normal bold 48px myFirstFont",f.fillStyle="#000",f.textAlign="center";var _=Math.floor(.51*h),q=Math.floor(.509*x),z=Math.floor(.589*x);f.fillText(t.colorPrice,_,q),f.fillText(t.permPrice,_,z)}else if(10==M){f.font="normal bold 48px myFirstFont",f.fillStyle="#000",f.textAlign="center";var K=Math.floor(.5*h),Q=Math.floor(.14*h),X=Math.floor(.7364*x),Z=Math.floor(.8052*x);f.fillText(t.name,K,X),f.font="normal bold 72px myFirstFont",f.fillStyle="#324ee9",f.textAlign="left",f.fillText(t.startDate,Q,Z)}}else if(1==M){f.font="normal bold 0.8rem myFirstFont",f.fillStyle="#fff",f.textAlign="left";var tt=Math.floor(.212*h),et=Math.floor(.5767*h),lt=Math.floor(.5*h),ot=Math.floor(.394*x),at=Math.floor(.3284*x);f.fillText(t.startTime,tt,ot),f.fillText(t.endTime,et,ot),f.fillStyle="#000",f.textAlign="center",f.fillText(t.name,lt,at)}else if(2==M){f.font="normal bold 0.453333rem myFirstFont",f.fillStyle="#fff",f.textAlign="center";var ft=Math.floor(.5*h),rt=(Math.floor(.5667*h),Math.floor(.2267*h)),it=Math.floor(.3017*h),nt=Math.floor(.3767*h),st=Math.floor(.6296*h),ht=Math.floor(.6996*h),mt=Math.floor(.7696*h),xt=Math.floor(.1147*x),Mt=Math.floor(.3082*x),dt=Math.floor(.737*x);f.fillText(l,ft,xt),f.font="normal bold 0.533333rem myFirstFont",f.fillStyle="#000",f.fillText(t.name,ft,Mt),f.fillText(t.startHour,rt,dt),f.fillText(t.startMinute,nt,dt),f.fillText(t.endHour,st,dt),f.fillText(t.endMinute,mt,dt),f.fillStyle="#fff",f.fillText(":",it,dt),f.fillText(":",ht,dt)}else if(3==M){f.font="normal bold 0.64rem myFirstFont",f.fillStyle="#000",f.textAlign="center";var ct=(Math.floor(.5*h),Math.floor(.5667*h),Math.floor(.2267*h)),ut=Math.floor(.3017*h),Tt=Math.floor(.3767*h),yt=Math.floor(.6296*h),gt=Math.floor(.6996*h),pt=Math.floor(.7696*h),Ft=(Math.floor(.1147*x),Math.floor(.3082*x),Math.floor(.802*x));f.fillText(t.startHour,ct,Ft),f.fillText(t.startMinute,Tt,Ft),f.fillText(t.endHour,yt,Ft),f.fillText(t.endMinute,pt,Ft),f.fillText(":",ut,Ft),f.fillText(":",gt,Ft)}else if(4==M){f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#fff";var bt=Math.floor(.747*h),vt=Math.floor(.922*x);f.fillText(t.name,bt,vt)}else if(5==M){f.font="normal bold 0.96rem myFirstFont",f.fillStyle="#244678",f.textAlign="left";var St=Math.floor(.2693*h),At=Math.floor(.522*h),$t=Math.floor(.69*h),wt=Math.floor(.3355*x),kt=Math.floor(.4669*x),Pt=Math.floor(.616*x),Dt=Math.floor(.701*x);f.fillText(t.startMonth,St,wt),f.fillText(t.startDate,At,wt),f.fillText(t.endMonth,St,kt),f.fillText(t.endDate,At,kt),f.textAlign="center",f.fillStyle="#fff",f.fillText(t.colorPrice,$t,Pt),f.fillText(t.permPrice,$t,Dt)}else if(6==M){f.font="normal bold 0.6rem myFirstFont",f.fillStyle="#fff",f.textAlign="right";var Ot=Math.floor(.951*h),It=Math.floor(.244*x);f.fillText(t.name,Ot,It)}else if(7==M){var Ht=e.getDate()+"/"+(e.getMonth()+1)+"/"+e.getFullYear();f.font="normal bold 0.6rem myFirstFont",f.fillStyle="#000",f.textAlign="center";var Et=Math.floor(.5*h),Bt=Math.floor(.6587*x);f.fillText(Ht,Et,Bt)}else if(8==M){f.font="normal bold 4.0rem myFirstFont",f.fillStyle="#af0008",f.textAlign="center";var Ct=Math.floor(.5*h),Jt=Math.floor(.7261*x);f.fillText(t.day,Ct,Jt)}else if(9==M){f.font="normal bold 0.64rem myFirstFont",f.fillStyle="#000",f.textAlign="center";var Nt=Math.floor(.51*h),Rt=Math.floor(.509*x),Ut=Math.floor(.589*x);f.fillText(t.colorPrice,Nt,Rt),f.fillText(t.permPrice,Nt,Ut)}else if(10==M){f.font="normal bold 0.64rem myFirstFont",f.fillStyle="#000",f.textAlign="center";var Yt=Math.floor(.5*h),Lt=Math.floor(.14*h),Wt=Math.floor(.7364*x),jt=Math.floor(.8052*x);f.fillText(t.name,Yt,Wt),f.font="normal bold 0.96rem myFirstFont",f.fillStyle="#324ee9",f.textAlign="left",f.fillText(t.startDate,Lt,jt)}}}function i(t){return document.getElementById(t).getContext("2d")}function n(){t.showcanvas=!1;var e=document.getElementById("main"),l=e.toDataURL("image/jpg");t.canvasImg=l,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var s=JSON.parse(sessionStorage.getItem("user"));t.fastuse=!0,t.user=s,t.btnText="一键生成海报",t.loading=!1,t.showcanvas=!0,t.showmodel=!1,t.canvasImg="",t.name="请添加",t.startTime="13:00",t.endTime="18:00",t.startHour="13",t.startMinute="00",t.endHour="18",t.endMinute="00",t.startMonth="05",t.startDate="01",t.endMonth="05",t.endDate="15",t.colorPrice="88",t.permPrice="88",t.day="2";var h=document.documentElement.clientWidth,m=Math.floor(h),x=Math.floor(1.83*h);$("#main").attr("width",m+"px"),$("#main").attr("height",x+"px"),console.log(t.user);var M=f.num;t.page=1,t.showImg="../../assets/images/notice/type6/img_"+M+".png",t.editInformation=function(t){t.stopPropagation(),o.path("editInformation")},t.useTemplatePage=function(e){e.stopPropagation(),n(),t.showmodel=!0,t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(t){t.stopPropagation(),l.history.back()},t.chengeText=function(){if(t.fastuse=!0,!t.showmodel)if(1==M)$(".name-input-fixed").show();else if(2==M)$(".name-input-fixed-1").show();else if(3==M)$(".name-input-fixed-2").show();else if(4==M)$(".name-input-fixed-3").show();else if(5==M)$(".name-input-fixed-4").show();else if(6==M)$(".name-input-fixed-5").show();else{if(7==M)return;8==M?$(".name-input-fixed-7").show():9==M?$(".name-input-fixed-8").show():10==M?$(".name-input-fixed-9").show():11==M&&$(".name-input-fixed-10").show()}},t.updateText=function(){r(),1==M?$(".name-input-fixed").fadeOut(50):2==M?$(".name-input-fixed-1").fadeOut(50):3==M?$(".name-input-fixed-2").fadeOut(50):4==M?$(".name-input-fixed-3").fadeOut(50):5==M?$(".name-input-fixed-4").fadeOut(50):6==M?$(".name-input-fixed-5").fadeOut(50):7==M?$(".name-input-fixed-6").fadeOut(50):8==M?$(".name-input-fixed-7").fadeOut(50):9==M?$(".name-input-fixed-8").fadeOut(50):10==M?$(".name-input-fixed-9").fadeOut(50):11==M&&$(".name-input-fixed-10").fadeOut(50),t.fastuse=!1},t.closeText=function(e){e.stopPropagation(),t.user.iscomplete=!0},$(function(){r()})}]);
