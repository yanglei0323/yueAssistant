...
index.controller("useActiveCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,e,l,o,a,f){function r(){t.btnText="一键生成海报",t.showcanvas=!0;var e=new Date,l=e.getFullYear()+"/"+(e.getMonth()+1)+"/"+e.getDate(),o=e.getMonth()+1;switch(o){case 1:o="JAN";break;case 2:o="FEB";break;case 3:o="MAR";break;case 4:o="APR";break;case 5:o="MAY";break;case 6:o="JUN";break;case 7:o="JUL";break;case 8:o="AUG";break;case 9:o="SEP";break;case 10:o="OCT";break;case 11:o="NOV";break;case 12:o="DEC"}var a=e.getDay();switch(a){case 0:a="Sunday";break;case 1:a="Monday";break;case 2:a="Tuesday";break;case 3:a="Wednesday";break;case 4:a="Thursday";break;case 5:a="Friday";break;case 6:a="Saturday"}var f=i("main");f.width,f.height;f.clearRect(0,0,1e3,1e3);var r=new Image;r.src=t.showImg,r.onload=function(){if(f.drawImage(r,0,0,h,d),navigator.userAgent.match(/iphone/i)){if(1==x){f.drawImage(g,.048*h,1142/1334*d,14/75*h,14/75*h),f.font="normal bold 60px myFirstFont",f.fillStyle="#fff",f.textAlign="left";var o=Math.floor(.212*s),a=Math.floor(.5767*s),i=Math.floor(.5*s),n=Math.floor(.394*d),m=Math.floor(.3284*d);f.fillText(t.startTime,o,n),f.fillText(t.endTime,a,n),f.fillStyle="#000",f.textAlign="center",f.fillText(t.name,i,m)}else if(2==x){f.drawImage(g,.408*h,1152/1334*d,14/75*h,14/75*h),f.font="normal bold 34px myFirstFont",f.fillStyle="#fff",f.textAlign="center";var M=Math.floor(.5*s),u=(Math.floor(.5667*s),Math.floor(.2267*s)),c=Math.floor(.3017*s),T=Math.floor(.3767*s),y=Math.floor(.6296*s),p=Math.floor(.6996*s),F=Math.floor(.7696*s),w=Math.floor(.1147*d),b=Math.floor(.3082*d),v=Math.floor(.737*d);f.fillText(l,M,w),f.font="normal bold 48px myFirstFont",f.fillStyle="#000",f.fillText(t.name,M,b),f.fillText(t.startHour,u,v),f.fillText(t.startMinute,T,v),f.fillText(t.endHour,y,v),f.fillText(t.endMinute,F,v),f.fillStyle="#fff",f.fillText(":",c,v),f.fillText(":",p,v)}else if(3==x){f.drawImage(g,.408*h,1114/1334*d,14/75*h,14/75*h),f.font="normal bold 48px myFirstFont",f.fillStyle="#000",f.textAlign="center";var S=(Math.floor(.5*s),Math.floor(.5667*s),Math.floor(.2267*s)),I=Math.floor(.3017*s),A=Math.floor(.3767*s),$=Math.floor(.6296*s),k=Math.floor(.6996*s),P=Math.floor(.7696*s),D=(Math.floor(.1147*d),Math.floor(.3082*d),Math.floor(.802*d));f.fillText(t.startHour,S,D),f.fillText(t.startMinute,A,D),f.fillText(t.endHour,$,D),f.fillText(t.endMinute,P,D),f.fillText(":",I,D),f.fillText(":",k,D)}else if(4==x){f.drawImage(g,64/750*h,1126/1334*d,14/75*h,14/75*h),f.font="normal bold 36px myFirstFont",f.fillStyle="#fff";var O=Math.floor(.747*s),H=Math.floor(.922*d);f.fillText(t.name,O,H)}else if(5==x){f.drawImage(g,.408*h,1110/1334*d,14/75*h,14/75*h),f.font="normal bold 72px myFirstFont",f.fillStyle="#244678",f.textAlign="left";var E=Math.floor(.2693*s),R=Math.floor(.522*s),U=Math.floor(.69*s),B=Math.floor(.3355*d),C=Math.floor(.4669*d),J=Math.floor(.616*d),L=Math.floor(.701*d);f.fillText(t.startMonth,E,B),f.fillText(t.startDate,R,B),f.fillText(t.endMonth,E,C),f.fillText(t.endDate,R,C),f.textAlign="center",f.fillStyle="#fff",f.fillText(t.colorPrice,U,J),f.fillText(t.permPrice,U,L)}else if(6==x){f.drawImage(g,52/750*h,1130/1334*d,14/75*h,14/75*h),f.font="normal bold 45px myFirstFont",f.fillStyle="#fff",f.textAlign="right";var N=Math.floor(.951*s),Y=Math.floor(.244*d);f.fillText(t.name,N,Y)}else if(7==x){f.drawImage(g,.408*h,1143/1334*d,14/75*h,14/75*h);var j=e.getDate()+"/"+(e.getMonth()+1)+"/"+e.getFullYear();f.font="normal bold 48px myFirstFont",f.fillStyle="#000",f.textAlign="center";var W=Math.floor(.5*s),q=Math.floor(.6587*d);f.fillText(j,W,q)}else if(8==x){f.drawImage(g,.408*h,1136/1334*d,14/75*h,14/75*h),f.font="normal bold 300px myFirstFont",f.fillStyle="#af0008",f.textAlign="center";var G=Math.floor(.5*s),V=Math.floor(.7261*d);f.fillText(t.day,G,V)}else if(9==x){f.drawImage(g,.408*h,1109/1334*d,14/75*h,14/75*h),f.font="normal bold 48px myFirstFont",f.fillStyle="#000",f.textAlign="center";var _=Math.floor(.51*s),z=Math.floor(.509*d),K=Math.floor(.589*d);f.fillText(t.colorPrice,_,z),f.fillText(t.permPrice,_,K)}else if(10==x){f.drawImage(g,.408*h,1148/1334*d,14/75*h,14/75*h),f.font="normal bold 48px myFirstFont",f.fillStyle="#000",f.textAlign="center";var Q=Math.floor(.5*s),X=Math.floor(.14*s),Z=Math.floor(.7364*d),tt=Math.floor(.8052*d);f.fillText(t.name,Q,Z),f.font="normal bold 72px myFirstFont",f.fillStyle="#324ee9",f.textAlign="left",f.fillText(t.startDate,X,tt)}}else if(1==x){f.drawImage(g,.048*h,1142/1334*d,14/75*h,14/75*h),f.font="normal bold 0.8rem myFirstFont",f.fillStyle="#fff",f.textAlign="left";var et=Math.floor(.212*s),lt=Math.floor(.5767*s),ot=Math.floor(.5*s),at=Math.floor(.394*d),ft=Math.floor(.3284*d);f.fillText(t.startTime,et,at),f.fillText(t.endTime,lt,at),f.fillStyle="#000",f.textAlign="center",f.fillText(t.name,ot,ft)}else if(2==x){f.drawImage(g,.408*h,1152/1334*d,14/75*h,14/75*h),f.font="normal bold 0.453333rem myFirstFont",f.fillStyle="#fff",f.textAlign="center";var rt=Math.floor(.5*s),it=(Math.floor(.5667*s),Math.floor(.2267*s)),nt=Math.floor(.3017*s),mt=Math.floor(.3767*s),st=Math.floor(.6296*s),ht=Math.floor(.6996*s),dt=Math.floor(.7696*s),xt=Math.floor(.1147*d),Mt=Math.floor(.3082*d),ut=Math.floor(.737*d);f.fillText(l,rt,xt),f.font="normal bold 0.533333rem myFirstFont",f.fillStyle="#000",f.fillText(t.name,rt,Mt),f.fillText(t.startHour,it,ut),f.fillText(t.startMinute,mt,ut),f.fillText(t.endHour,st,ut),f.fillText(t.endMinute,dt,ut),f.fillStyle="#fff",f.fillText(":",nt,ut),f.fillText(":",ht,ut)}else if(3==x){f.drawImage(g,.408*h,1114/1334*d,14/75*h,14/75*h),f.font="normal bold 0.64rem myFirstFont",f.fillStyle="#000",f.textAlign="center";var ct=(Math.floor(.5*s),Math.floor(.5667*s),Math.floor(.2267*s)),gt=Math.floor(.3017*s),Tt=Math.floor(.3767*s),yt=Math.floor(.6296*s),pt=Math.floor(.6996*s),Ft=Math.floor(.7696*s),wt=(Math.floor(.1147*d),Math.floor(.3082*d),Math.floor(.802*d));f.fillText(t.startHour,ct,wt),f.fillText(t.startMinute,Tt,wt),f.fillText(t.endHour,yt,wt),f.fillText(t.endMinute,Ft,wt),f.fillText(":",gt,wt),f.fillText(":",pt,wt)}else if(4==x){f.drawImage(g,64/750*h,1126/1334*d,14/75*h,14/75*h),f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#fff";var bt=Math.floor(.747*s),vt=Math.floor(.922*d);f.fillText(t.name,bt,vt)}else if(5==x){f.drawImage(g,.408*h,1110/1334*d,14/75*h,14/75*h),f.font="normal bold 0.96rem myFirstFont",f.fillStyle="#244678",f.textAlign="left";var St=Math.floor(.2693*s),It=Math.floor(.522*s),At=Math.floor(.69*s),$t=Math.floor(.3355*d),kt=Math.floor(.4669*d),Pt=Math.floor(.616*d),Dt=Math.floor(.701*d);f.fillText(t.startMonth,St,$t),f.fillText(t.startDate,It,$t),f.fillText(t.endMonth,St,kt),f.fillText(t.endDate,It,kt),f.textAlign="center",f.fillStyle="#fff",f.fillText(t.colorPrice,At,Pt),f.fillText(t.permPrice,At,Dt)}else if(6==x){f.drawImage(g,52/750*h,1130/1334*d,14/75*h,14/75*h),f.font="normal bold 0.6rem myFirstFont",f.fillStyle="#fff",f.textAlign="right";var Ot=Math.floor(.951*s),Ht=Math.floor(.244*d);f.fillText(t.name,Ot,Ht)}else if(7==x){f.drawImage(g,.408*h,1143/1334*d,14/75*h,14/75*h);var Et=e.getDate()+"/"+(e.getMonth()+1)+"/"+e.getFullYear();f.font="normal bold 0.6rem myFirstFont",f.fillStyle="#000",f.textAlign="center";var Rt=Math.floor(.5*s),Ut=Math.floor(.6587*d);f.fillText(Et,Rt,Ut)}else if(8==x){f.drawImage(g,.408*h,1136/1334*d,14/75*h,14/75*h),f.font="normal bold 4.0rem myFirstFont",f.fillStyle="#af0008",f.textAlign="center";var Bt=Math.floor(.5*s),Ct=Math.floor(.7261*d);f.fillText(t.day,Bt,Ct)}else if(9==x){f.drawImage(g,.408*h,1109/1334*d,14/75*h,14/75*h),f.font="normal bold 0.64rem myFirstFont",f.fillStyle="#000",f.textAlign="center";var Jt=Math.floor(.51*s),Lt=Math.floor(.509*d),Nt=Math.floor(.589*d);f.fillText(t.colorPrice,Jt,Lt),f.fillText(t.permPrice,Jt,Nt)}else if(10==x){f.drawImage(g,.408*h,1148/1334*d,14/75*h,14/75*h),f.font="normal bold 0.64rem myFirstFont",f.fillStyle="#000",f.textAlign="center";var Yt=Math.floor(.5*s),jt=Math.floor(.14*s),Wt=Math.floor(.7364*d),qt=Math.floor(.8052*d);f.fillText(t.name,Yt,Wt),f.font="normal bold 0.96rem myFirstFont",f.fillStyle="#324ee9",f.textAlign="left",f.fillText(t.startDate,jt,qt)}}}function i(t){return document.getElementById(t).getContext("2d")}function n(){t.showcanvas=!1;var e=document.getElementById("main"),l=e.toDataURL("image/jpg");t.canvasImg=l,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var m=JSON.parse(sessionStorage.getItem("user"));t.fastuse=!0,t.user=m,t.btnText="一键生成海报",t.loading=!1,t.showcanvas=!0,t.showmodel=!1,t.canvasImg="",t.name="请添加",t.startTime="13:00",t.endTime="18:00",t.startHour="13",t.startMinute="00",t.endHour="18",t.endMinute="00",t.startMonth="05",t.startDate="01",t.endMonth="05",t.endDate="15",t.colorPrice="88",t.permPrice="88",t.day="2";var s=document.documentElement.clientWidth,h=Math.floor(s),d=Math.floor(1.83*s);$("#main").attr("width",h+"px"),$("#main").attr("height",d+"px"),console.log(t.user);var x=f.num;t.page=1,t.showImg="../../assets/images/notice/type6/img_"+x+".png",t.editInformation=function(t){t.stopPropagation(),o.path("editInformation")},t.useTemplatePage=function(e){e.stopPropagation(),n(),t.showmodel=!0,t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(t){t.stopPropagation(),l.history.back()},t.chengeText=function(){if(t.fastuse=!0,!t.showmodel)if(1==x)$(".name-input-fixed").show();else if(2==x)$(".name-input-fixed-1").show();else if(3==x)$(".name-input-fixed-2").show();else if(4==x)$(".name-input-fixed-3").show();else if(5==x)$(".name-input-fixed-4").show();else if(6==x)$(".name-input-fixed-5").show();else{if(7==x)return;8==x?$(".name-input-fixed-7").show():9==x?$(".name-input-fixed-8").show():10==x?$(".name-input-fixed-9").show():11==x&&$(".name-input-fixed-10").show()}},t.updateText=function(){r(),1==x?$(".name-input-fixed").fadeOut(50):2==x?$(".name-input-fixed-1").fadeOut(50):3==x?$(".name-input-fixed-2").fadeOut(50):4==x?$(".name-input-fixed-3").fadeOut(50):5==x?$(".name-input-fixed-4").fadeOut(50):6==x?$(".name-input-fixed-5").fadeOut(50):7==x?$(".name-input-fixed-6").fadeOut(50):8==x?$(".name-input-fixed-7").fadeOut(50):9==x?$(".name-input-fixed-8").fadeOut(50):10==x?$(".name-input-fixed-9").fadeOut(50):11==x&&$(".name-input-fixed-10").fadeOut(50),t.fastuse=!1},t.closeText=function(e){e.stopPropagation(),t.user.iscomplete=!0},$(function(){r()});var M=$(".hideImg").qrcode({width:200,height:200,correctLevel:0,text:"http://syrapi.yueyishujia.com/yueAssistant/build/html/homePage/"+t.user.uuid}).hide(),u=M.find("canvas").get(0),c=u.toDataURL("image/jpg"),g=new Image;g.src=c}]);
...
index.controller("useHolidayCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(e,t,a,n,o,i){function m(){e.btnText="一键生成海报",e.showcanvas=!0;var t=r("main");t.width,t.height;t.clearRect(0,0,1e3,1e3);var a=new Image;a.src=e.showImg,a.onload=function(){if(t.drawImage(a,0,0,d,c),navigator.userAgent.match(/iphone/i))if(1==h&&2==f){t.font="normal bold 40px myFirstFont",t.fillStyle="#fff";var n=Math.floor(.153*g),o=Math.floor(.335*c);t.fillText(e.name+"祝您",n,o)}else 3==h&&1==f?t.drawImage(I,.764*d,1137/1334*c,14/75*d,14/75*d):3==h&&2==f?t.drawImage(I,44/750*d,1134/1334*c,14/75*d,14/75*d):5==h&&1==f?t.drawImage(I,.048*d,1138/1334*c,14/75*d,14/75*d):5==h&&2==f&&t.drawImage(I,.048*d,1122/1334*c,14/75*d,14/75*d);else if(1==h&&2==f){t.font="normal bold 0.533333rem myFirstFont",t.fillStyle="#fff";var i=Math.floor(.153*g),m=Math.floor(.335*c);t.fillText(e.name+"祝您",i,m)}else 3==h&&1==f?t.drawImage(I,.764*d,1137/1334*c,14/75*d,14/75*d):3==h&&2==f?t.drawImage(I,44/750*d,1134/1334*c,14/75*d,14/75*d):5==h&&1==f?t.drawImage(I,.048*d,1138/1334*c,14/75*d,14/75*d):5==h&&2==f&&t.drawImage(I,.048*d,1122/1334*c,14/75*d,14/75*d)}}function r(e){return document.getElementById(e).getContext("2d")}function s(){e.showcanvas=!1;var t=document.getElementById("main"),a=t.toDataURL("image/jpg");e.canvasImg=a,e.btnText="长按保存至手机，再发到朋友圈炫耀"}var l=JSON.parse(sessionStorage.getItem("user"));e.user=l,e.btnText="一键生成海报",e.loading=!1,e.showcanvas=!0,e.showmodel=!1,e.canvasImg="",e.name="请添加";var g=document.documentElement.clientWidth,d=Math.floor(g),c=Math.floor(1.83*g);$("#main").attr("width",d+"px"),$("#main").attr("height",c+"px"),console.log(e.user),e.name.length>=4&&(e.name=e.name[0]+e.name[1]+e.name[2]);var h=i.type,f=i.num;e.page=1,e.showImg="../../assets/images/holiday/type"+h+"/img_"+f+".png",e.editInformation=function(e){e.stopPropagation(),n.path("editInformation")},e.useTemplatePage=function(t){t.stopPropagation(),s(),e.showmodel=!0,e.btnText="长按保存至手机，再发到朋友圈炫耀"},e.goBack=function(e){e.stopPropagation(),a.history.back()},e.chengeText=function(){e.showmodel||1==h&&2==f&&$(".name-input-fixed").show()},e.updateText=function(){e.name.length>=4&&(e.name=e.name[0]+e.name[1]+e.name[2]),m(),$(".name-input-fixed").fadeOut(50)},e.closeText=function(t){t.stopPropagation(),e.user.iscomplete=!0},$(function(){m()});var u=$(".hideImg").qrcode({width:200,height:200,correctLevel:0,text:"http://syrapi.yueyishujia.com/yueAssistant/build/html/homePage/"+e.user.uuid}).hide(),p=u.find("canvas").get(0),w=p.toDataURL("image/jpg"),I=new Image;I.src=w}]);
index.controller("usejokeCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(e,a,t,n,o,m){function i(){e.btnText="一键生成海报",e.showcanvas=!0;var a=r("main");a.width,a.height;a.clearRect(0,0,1e3,1e3);var t=new Image;t.src=e.showImg,t.onload=function(){a.drawImage(t,0,0,d,u),navigator.userAgent.match(/iphone/i)?1==h?a.drawImage(f,.408*d,1146/1334*u,14/75*d,14/75*d):2==h?a.drawImage(f,.408*d,1128/1334*u,14/75*d,14/75*d):3==h?a.drawImage(f,577/750*d,1137/1334*u,14/75*d,14/75*d):4==h?a.drawImage(f,.756*d,1130/1334*u,14/75*d,14/75*d):5==h&&a.drawImage(f,.408*d,1086/1334*u,14/75*d,14/75*d):1==h?a.drawImage(f,.408*d,1146/1334*u,14/75*d,14/75*d):2==h?a.drawImage(f,.408*d,1128/1334*u,14/75*d,14/75*d):3==h?a.drawImage(f,577/750*d,1137/1334*u,14/75*d,14/75*d):4==h?a.drawImage(f,.756*d,1130/1334*u,14/75*d,14/75*d):5==h&&a.drawImage(f,.408*d,1086/1334*u,14/75*d,14/75*d)}}function r(e){return document.getElementById(e).getContext("2d")}function g(){e.showcanvas=!1;var a=document.getElementById("main"),t=a.toDataURL("image/jpg");e.canvasImg=t,e.btnText="长按保存至手机，再发到朋友圈炫耀"}var s=JSON.parse(sessionStorage.getItem("user"));e.user=s,e.btnText="一键生成海报",e.loading=!1,e.showcanvas=!0,e.showmodel=!1,e.canvasImg="",e.name="请添加";var c=document.documentElement.clientWidth,d=Math.floor(c),u=Math.floor(1.83*c);$("#main").attr("width",d+"px"),$("#main").attr("height",u+"px"),console.log(e.user),e.name.length>=4&&(e.name=e.name[0]+e.name[1]+e.name[2]);var h=m.type,p=m.num;e.page=1,e.showImg="../../assets/images/joke/type"+h+"/img_"+p+".png",e.editInformation=function(e){e.stopPropagation(),n.path("editInformation")},e.useTemplatePage=function(a){a.stopPropagation(),g(),e.showmodel=!0,e.btnText="长按保存至手机，再发到朋友圈炫耀"},e.goBack=function(e){e.stopPropagation(),t.history.back()},e.chengeText=function(){e.showmodel||1==h&&2==p&&$(".name-input-fixed").show()},e.updateText=function(){e.name.length>=4&&(e.name=e.name[0]+e.name[1]+e.name[2]),i(),$(".name-input-fixed").fadeOut(50)},e.closeText=function(a){a.stopPropagation(),e.user.iscomplete=!0},$(function(){i()});var w=$(".hideImg").qrcode({width:200,height:200,correctLevel:0,text:"http://syrapi.yueyishujia.com/yueAssistant/build/html/homePage/"+e.user.uuid}).hide(),l=w.find("canvas").get(0),I=l.toDataURL("image/jpg"),f=new Image;f.src=I}]);
...
index.controller("useNoticeCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,o,l,e,a,f){function r(){t.btnText="一键生成海报",t.showcanvas=!0;var o=new Date,l=o.getFullYear()+"/"+(o.getMonth()+1)+"/"+o.getDate(),e=o.getMonth()+1;switch(e){case 1:e="JAN";break;case 2:e="FEB";break;case 3:e="MAR";break;case 4:e="APR";break;case 5:e="MAY";break;case 6:e="JUN";break;case 7:e="JUL";break;case 8:e="AUG";break;case 9:e="SEP";break;case 10:e="OCT";break;case 11:e="NOV";break;case 12:e="DEC"}var a=o.getDay();switch(a){case 0:a="Sunday";break;case 1:a="Monday";break;case 2:a="Tuesday";break;case 3:a="Wednesday";break;case 4:a="Thursday";break;case 5:a="Friday";break;case 6:a="Saturday"}var f=i("main");f.width,f.height;f.clearRect(0,0,1e3,1e3);var r=new Image;r.src=t.showImg,r.onload=function(){if(f.drawImage(r,0,0,h,d),navigator.userAgent.match(/iphone/i)){if(1==x){f.font="normal bold 36px myFirstFont",f.fillStyle="#fff";var o=Math.floor(.1133*s),i=Math.floor(.88*d),n=Math.floor(.91*d),m=Math.floor(.94*d);f.fillText(t.name,o,i),f.font="normal bold 24px myFirstFont",f.fillText(e+"."+a,o,n),f.fillText(l,o,m)}else if(2==x&&1==M){f.drawImage(b,8/75*h,1106/1334*d,14/75*h,14/75*h),f.font="normal bold 36px myFirstFont",f.fillStyle="#fff";var y=Math.floor(.5733*s),u=Math.floor(.704*s),F=Math.floor(.3999*d),T=Math.floor(.6372*d),g=Math.floor(.6672*d),p=Math.floor(.6972*d);f.fillText(t.zhekou,y,F),f.fillStyle="#333",f.fillText(t.name,u,T),f.font="normal bold 24px myFirstFont",f.fillText(e+"."+a,u,g),f.fillText(l,u,p)}else if(2==x&&2==M){f.drawImage(b,.744*h,1120/1334*d,14/75*h,14/75*h),f.font="normal bold 30px myFirstFont",f.fillStyle="#333";var c=Math.floor(.3673*s),w=Math.floor(.211*s),S=Math.floor(.6567*d),v=Math.floor(.8685*d),I=Math.floor(.8985*d),$=Math.floor(.9285*d);f.fillText(t.lijian,c,S),f.font="normal bold 36px myFirstFont",f.fillStyle="#fff",f.fillText(t.name,w,v),f.font="normal bold 24px myFirstFont",f.fillStyle="#333",f.fillText(e+"."+a,w,I),f.fillText(l,w,$)}else if(3==x&&1==M){f.drawImage(b,.74*h,1119/1334*d,14/75*h,14/75*h),f.font="normal bold 100px myFirstFont",f.fillStyle="#b8742b";var k=Math.floor(.1917*s),O=Math.floor(.5803*s),P=Math.floor(.113*s),D=Math.floor(.608*d),A=Math.floor(.8785*d),j=Math.floor(.9085*d),E=Math.floor(.9385*d);f.fillText(t.starttime,k,D),f.fillText(t.endtime,O,D),f.font="normal bold 36px myFirstFont",f.fillStyle="#333",f.fillText(t.name,P,A),f.font="normal bold 24px myFirstFont",f.fillText(e+"."+a,P,j),f.fillText(l,P,E)}else if(3==x&&2==M){f.drawImage(b,.408*h,786/1334*d,14/75*h,14/75*h),f.font="normal bold 48px myFirstFont",f.fillStyle="#fff";var N=Math.floor(.246*s),R=Math.floor(.5667*s),U=Math.floor(.113*s),B=Math.floor(.463*d),C=Math.floor(.8785*d),J=Math.floor(.9085*d),L=Math.floor(.9385*d);f.fillText(t.starttime1,N,B),f.fillText(t.endtime1,R,B),f.font="normal bold 36px myFirstFont",f.fillText(t.name,U,C),f.font="normal bold 24px myFirstFont",f.fillText(e+"."+a,U,J),f.fillText(l,U,L)}else if(4==x&&1==M){f.drawImage(b,.408*h,1079/1334*d,14/75*h,14/75*h),f.font="normal bold 48px myFirstFont",f.fillStyle="#000";var z=Math.floor(.347*s),_=Math.floor(.58*d);f.fillText(t.discount,z,_)}else if(4==x&&2==M){f.drawImage(b,.408*h,1090/1334*d,14/75*h,14/75*h),f.font="normal bold 100px myFirstFont",f.fillStyle="#f02964";var W=Math.floor(.246*s),Y=Math.floor(.236*s),q=Math.floor(.5373*s),G=Math.floor(.422*d),V=Math.floor(.6808*d);f.fillText(t.discount,W,G),f.font="normal bold 36px myFirstFont",f.fillStyle="#333",f.fillText(t.starttime2,Y,V),f.fillText(t.endtime2,q,V)}else if(5==x&&1==M){f.drawImage(b,550/750*h,1110/1334*d,14/75*h,14/75*h),f.font="normal bold 100px myFirstFont",f.fillStyle="#000";var H=Math.floor(.1426*s),K=Math.floor(.6013*s),Q=Math.floor(.31*s),X=Math.floor(.1333*s),Z=Math.floor(.4764*d),tt=Math.floor(.7869*d),ot=(Math.floor(.7669*d),Math.floor(.89*d)),lt=Math.floor(.92*d),et=Math.floor(.95*d);f.fillText(t.starttime3,H,Z),f.fillText(t.endtime3,K,Z),f.font="normal bold 36px myFirstFont",f.fillStyle="#fb5b64",f.fillText(t.business,Q,tt),f.fillStyle="#333",f.fillText(t.name,X,ot),f.font="normal bold 24px myFirstFont",f.fillText(e+"."+a,X,lt),f.fillText(l,X,et)}else if(5==x&&2==M){f.drawImage(b,551/750*h,1111/1334*d,14/75*h,14/75*h),f.font="normal bold 30px myFirstFont",f.fillStyle="#f6c33b";var at=Math.floor(.298*s),ft=Math.floor(.415*s),rt=Math.floor(.1333*s),it=Math.floor(.801*d),nt=Math.floor(.89*d),mt=Math.floor(.92*d),st=Math.floor(.95*d);f.fillText(t.businessMonth,at,it),f.fillText(t.businessDate,ft,it),f.fillStyle="#333",f.fillText(t.name,rt,nt),f.font="normal bold 24px myFirstFont",f.fillText(e+"."+a,rt,mt),f.fillText(l,rt,st)}}else if(1==x){f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#fff";var ht=Math.floor(.1133*s),dt=Math.floor(.88*d),xt=Math.floor(.91*d),Mt=Math.floor(.94*d);f.fillText(t.name,ht,dt),f.font="normal bold 0.32rem myFirstFont",f.fillText(e+"."+a,ht,xt),f.fillText(l,ht,Mt)}else if(2==x&&1==M){f.drawImage(b,8/75*h,1106/1334*d,14/75*h,14/75*h),f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#fff";var yt=Math.floor(.5733*s),ut=Math.floor(.704*s),Ft=Math.floor(.3999*d),bt=Math.floor(.6372*d),Tt=Math.floor(.6672*d),gt=Math.floor(.6972*d);f.fillText(t.zhekou,yt,Ft),f.fillStyle="#333",f.fillText(t.name,ut,bt),f.font="normal bold 0.32rem myFirstFont",f.fillText(e+"."+a,ut,Tt),f.fillText(l,ut,gt)}else if(2==x&&2==M){f.drawImage(b,.744*h,1120/1334*d,14/75*h,14/75*h),f.font="normal bold 0.4rem myFirstFont",f.fillStyle="#333";var pt=Math.floor(.3673*s),ct=Math.floor(.211*s),wt=Math.floor(.6567*d),St=Math.floor(.8685*d),vt=Math.floor(.8985*d),It=Math.floor(.9285*d);f.fillText(t.lijian,pt,wt),f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#fff",f.fillText(t.name,ct,St),f.font="normal bold 0.32rem myFirstFont",f.fillStyle="#333",f.fillText(e+"."+a,ct,vt),f.fillText(l,ct,It)}else if(3==x&&1==M){f.drawImage(b,.74*h,1119/1334*d,14/75*h,14/75*h),f.font="normal bold 1.133333rem myFirstFont",f.fillStyle="#b8742b";var $t=Math.floor(.2017*s),kt=Math.floor(.5803*s),Ot=Math.floor(.113*s),Pt=Math.floor(.608*d),Dt=Math.floor(.8785*d),At=Math.floor(.9085*d),jt=Math.floor(.9385*d);f.fillText(t.starttime,$t,Pt),f.fillText(t.endtime,kt,Pt),f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#333",f.fillText(t.name,Ot,Dt),f.font="normal bold 0.32rem myFirstFont",f.fillText(e+"."+a,Ot,At),f.fillText(l,Ot,jt)}else if(3==x&&2==M){f.drawImage(b,.408*h,786/1334*d,14/75*h,14/75*h),f.font="normal bold 0.64rem myFirstFont",f.fillStyle="#fff";var Et=Math.floor(.246*s),Nt=Math.floor(.5667*s),Rt=Math.floor(.113*s),Ut=Math.floor(.463*d),Bt=Math.floor(.8785*d),Ct=Math.floor(.9085*d),Jt=Math.floor(.9385*d);f.fillText(t.starttime1,Et,Ut),f.fillText(t.endtime1,Nt,Ut),f.font="normal bold 0.48rem myFirstFont",f.fillText(t.name,Rt,Bt),f.font="normal bold 0.32rem myFirstFont",f.fillText(e+"."+a,Rt,Ct),f.fillText(l,Rt,Jt)}else if(4==x&&1==M){f.drawImage(b,.408*h,1079/1334*d,14/75*h,14/75*h),f.font="normal bold 0.64rem myFirstFont",f.fillStyle="#000";var Lt=Math.floor(.347*s),zt=Math.floor(.58*d);f.fillText(t.discount,Lt,zt)}else if(4==x&&2==M){f.drawImage(b,.408*h,1090/1334*d,14/75*h,14/75*h),f.font="normal bold 1.333333rem myFirstFont",f.fillStyle="#f02964";var _t=Math.floor(.246*s),Wt=Math.floor(.236*s),Yt=Math.floor(.5373*s),qt=Math.floor(.422*d),Gt=Math.floor(.6808*d);f.fillText(t.discount,_t,qt),f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#333",f.fillText(t.starttime2,Wt,Gt),f.fillText(t.endtime2,Yt,Gt)}else if(5==x&&1==M){f.drawImage(b,550/750*h,1110/1334*d,14/75*h,14/75*h),f.font="normal bold 1.333333rem myFirstFont",f.fillStyle="#000";var Vt=Math.floor(.1426*s),Ht=Math.floor(.6013*s),Kt=Math.floor(.31*s),Qt=Math.floor(.1333*s),Xt=Math.floor(.4764*d),Zt=Math.floor(.7869*d),to=(Math.floor(.7669*d),Math.floor(.89*d)),oo=Math.floor(.92*d),lo=Math.floor(.95*d);f.fillText(t.starttime3,Vt,Xt),f.fillText(t.endtime3,Ht,Xt),f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#fb5b64",f.fillText(t.business,Kt,Zt),f.fillStyle="#333",f.fillText(t.name,Qt,to),f.font="normal bold 0.32rem myFirstFont",f.fillText(e+"."+a,Qt,oo),f.fillText(l,Qt,lo)}else if(5==x&&2==M){f.drawImage(b,551/750*h,1111/1334*d,14/75*h,14/75*h),f.font="normal bold 0.48rem myFirstFont",f.fillStyle="#f6c33b";var eo=Math.floor(.298*s),ao=Math.floor(.415*s),fo=Math.floor(.1333*s),ro=Math.floor(.801*d),io=Math.floor(.89*d),no=Math.floor(.92*d),mo=Math.floor(.95*d);f.fillText(t.businessMonth,eo,ro),f.fillText(t.businessDate,ao,ro),f.fillStyle="#333",f.fillText(t.name,fo,io),f.font="normal bold 0.32rem myFirstFont",f.fillText(e+"."+a,fo,no),f.fillText(l,fo,mo)}}}function i(t){return document.getElementById(t).getContext("2d")}function n(){t.showcanvas=!1;var o=document.getElementById("main"),l=o.toDataURL("image/jpg");t.canvasImg=l,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var m=JSON.parse(sessionStorage.getItem("user"));t.fastuse=!0,t.user=m,t.btnText="一键生成海报",t.loading=!1,t.showcanvas=!0,t.showmodel=!1,t.canvasImg="",t.name="请添加",t.zhekou="八",t.lijian="000",t.starttime="08",t.endtime="24",t.starttime1="08:00",t.endtime1="24:00",t.starttime2="2017.05.01",t.endtime2="2017.05.05",t.starttime3="01",t.endtime3="05",t.discount="00",t.business="06",t.businessMonth="05",t.businessDate="01";var s=document.documentElement.clientWidth,h=Math.floor(s),d=Math.floor(1.83*s);$("#main").attr("width",h+"px"),$("#main").attr("height",d+"px"),console.log(t.user);var x=f.type,M=f.num;t.page=1,t.showImg="../../assets/images/notice/type"+x+"/img_"+M+".png",t.editInformation=function(t){t.stopPropagation(),e.path("editInformation")},t.useTemplatePage=function(o){o.stopPropagation(),n(),t.showmodel=!0,t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(t){t.stopPropagation(),l.history.back()},t.chengeText=function(){t.fastuse=!0,t.showmodel||(1==x?$(".name-input-fixed").show():2==x&&1==M?$(".name-input-fixed-1").show():2==x&&2==M?$(".name-input-fixed-2").show():3==x&&1==M?$(".name-input-fixed-3").show():3==x&&2==M?$(".name-input-fixed-4").show():4==x&&1==M?$(".name-input-fixed-5").show():4==x&&2==M?$(".name-input-fixed-6").show():5==x&&1==M?$(".name-input-fixed-7").show():5==x&&2==M&&$(".name-input-fixed-8").show())},t.updateText=function(){r(),1==x?$(".name-input-fixed").fadeOut(50):2==x&&1==M?$(".name-input-fixed-1").fadeOut(50):2==x&&2==M?$(".name-input-fixed-2").fadeOut(50):3==x&&1==M?$(".name-input-fixed-3").fadeOut(50):3==x&&2==M?$(".name-input-fixed-4").fadeOut(50):4==x&&1==M?$(".name-input-fixed-5").fadeOut(50):4==x&&2==M?$(".name-input-fixed-6").fadeOut(50):5==x&&1==M?$(".name-input-fixed-7").fadeOut(50):5==x&&2==M&&$(".name-input-fixed-8").fadeOut(50),t.fastuse=!1},t.closeText=function(o){o.stopPropagation(),t.user.iscomplete=!0},t.changeImg=function(o){o.stopPropagation(),t.loading=!0,t.showmodel=!1,t.page>=2?(t.page=1,t.showImg="../../assets/images/notice/type"+M+"/img_"+t.page+".png",t.loading=!1):(t.page+=1,t.showImg="../../assets/images/notice/type"+M+"/img_"+t.page+".png",t.loading=!1),r()},$(function(){r()});var y=$(".hideImg").qrcode({width:200,height:200,correctLevel:0,text:"http://syrapi.yueyishujia.com/yueAssistant/build/html/homePage/"+t.user.uuid}).hide(),u=y.find("canvas").get(0),F=u.toDataURL("image/jpg"),b=new Image;b.src=F}]);
index.controller("useGreetCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(t,e,o,a,n,l){function i(){t.btnText="一键生成海报",t.showcanvas=!0;var e=r("main");e.width,e.height;e.clearRect(0,0,1e3,1e3);var o=new Image;o.src=t.showImg,o.onload=function(){if(e.drawImage(o,0,0,d,c),navigator.userAgent.match(/iphone/i))if(1==h&&1==g){e.font="normal bold 72px myFirstFont",e.fillStyle="#fff";var a=Math.floor(.066*m),n=Math.floor(.1466*m),l=Math.floor(.145*c),i=Math.floor(.349*c);e.fillText(t.title,a,l),e.font="normal bold 30px myFirstFont",e.fillStyle="#0f0f0b",e.fillText(t.desc,n,i)}else if(1==h&&2==g){e.font="normal bold 30px myFirstFont",e.fillStyle="#fff";var r=Math.floor(.586*m),f=Math.floor(.731*c),s=Math.floor(.6848*c),u=Math.floor(.638*c);e.fillText(t.desc3,r,f),e.fillText(t.desc2,r,s),e.fillText(t.desc1,r,u)}else 3==h&&1==g?e.drawImage(w,.096*d,1099/1334*c,14/75*d,14/75*d):3==h&&2==g&&e.drawImage(w,.408*d,1099/1334*c,14/75*d,14/75*d);else if(1==h&&1==g){e.font="normal bold 0.96rem myFirstFont",e.fillStyle="#fff";var p=Math.floor(.066*m),x=Math.floor(.1466*m),y=Math.floor(.145*c),v=Math.floor(.349*c);e.fillText(t.title,p,y),e.font="normal bold 0.4rem myFirstFont",e.fillStyle="#0f0f0b",e.fillText(t.desc,x,v)}else if(1==h&&2==g){e.font="normal bold 0.4rem myFirstFont",e.fillStyle="#fff";var M=Math.floor(.586*m),T=Math.floor(.731*c),I=Math.floor(.6848*c),b=Math.floor(.638*c);e.fillText(t.desc3,M,T),e.fillText(t.desc2,M,I),e.fillText(t.desc1,M,b)}else 3==h&&1==g?e.drawImage(w,.096*d,1099/1334*c,14/75*d,14/75*d):3==h&&2==g&&e.drawImage(w,.408*d,1099/1334*c,14/75*d,14/75*d)}}function r(t){return document.getElementById(t).getContext("2d")}function f(){t.showcanvas=!1;var e=document.getElementById("main"),o=e.toDataURL("image/jpg");t.canvasImg=o,t.btnText="长按保存至手机，再发到朋友圈炫耀"}var s=JSON.parse(sessionStorage.getItem("user"));t.user=s,t.btnText="一键生成海报",t.loading=!1,t.showcanvas=!0,t.showmodel=!1,t.canvasImg="",t.title="点击添加标题",t.desc="点击添加海报描述",t.desc1="点击添加海报描述",t.desc2="点击添加海报描述",t.desc3="点击添加海报描述";var m=document.documentElement.clientWidth,d=Math.floor(m),c=Math.floor(1.83*m);$("#main").attr("width",d+"px"),$("#main").attr("height",c+"px"),console.log(t.user);var h=l.type,g=l.num;t.page=1,t.showImg="../../assets/images/greet/type"+h+"/img_"+g+".png",t.editInformation=function(t){t.stopPropagation(),a.path("editInformation")},t.useTemplatePage=function(e){e.stopPropagation(),f(),t.showmodel=!0,t.btnText="长按保存至手机，再发到朋友圈炫耀"},t.goBack=function(t){t.stopPropagation(),o.history.back()},t.chengeText=function(){t.showmodel||(1==h&&1==g?$(".name-input-fixed-1").show():1==h&&2==g&&$(".name-input-fixed-2").show())},t.updateText=function(){i(),1==h&&1==g?$(".name-input-fixed-1").fadeOut(50):1==h&&2==g&&$(".name-input-fixed-2").fadeOut(50)},t.closeText=function(e){e.stopPropagation(),t.user.iscomplete=!0},$(function(){i()});var u=$(".hideImg").qrcode({width:200,height:200,correctLevel:0,text:"http://syrapi.yueyishujia.com/yueAssistant/build/html/homePage/"+t.user.uuid}).hide(),p=u.find("canvas").get(0),x=p.toDataURL("image/jpg"),w=new Image;w.src=x}]);
