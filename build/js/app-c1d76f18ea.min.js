...
index.controller("holidayListCtrl",["$scope","$http","$window","$location","$rootScope","$routeParams",function(o,t,i,a,e,n){var s=n.num;o.dragon=s,o.imgList=[];for(var r=1;3>r;r++)o.imgList.push("../../assets/images/holiday/type"+s+"/img_"+r+".png");o.useMornTemplate=function(o){a.path("useHoliday/"+s+"/"+o)}}]);
