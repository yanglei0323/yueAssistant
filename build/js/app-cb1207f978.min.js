...
index.controller("morningNightCtrl",["$scope","$http","$window","$location","$rootScope",function(t,a,n,e,i){t.activeTab=1,i.activeTabMorn&&(t.activeTab=i.activeTabMorn),t.changeTab=function(a){switch(t.activeTab=a,a){case 1:i.activeTabMorn=1;break;case 2:i.activeTabMorn=2}},t.useMornTemplate=function(t){e.path("monList/"+t)},t.useNightTemplate=function(t){e.path("nightList/"+t)}}]);
