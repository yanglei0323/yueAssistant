...
index.controller("fastLoginCtrl",["$scope","$http","$window","$location","$interval","$timeout",function(e,o,t,n,d,i){function a(){return s.test(e.phone)?c.test(e.code)?1:(e.modalText="验证码输入错误",$(".prompt-container").show().fadeOut(2e3),-1):(e.modalText="手机号码有误！",$(".prompt-container").show().fadeOut(2e3),-1)}var s=/^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|18[0|1|2|3|5|6|7|8|9])\d{8}$/,c=/^\d{4}$/;e.sendCodeText="获取验证码",e.modalText="",e.getCode=function(){return e.sending?void 0:s.test(e.phone)?void o.post("/user/unl/sendlogin.json",{telephone:e.phone},postCfg).then(function(o){if(console.log(o),1===o.data.code){e.sending=!0;var t=60,n=d(function(){t>0?e.sendCodeText="重新发送("+t--+")":(e.sendCodeText="发送验证码",e.sending=!1,d.cancel(n))},1e3)}},function(e){}):(e.modalText="手机号码有误！",void $(".prompt-container").show().fadeOut(2e3))},e.confirmLogin=function(){if(-1!==a()){var n={telephone:e.phone,check:e.code,type:1};o.post("/user/unl/loginbytel.json",n,postCfg).then(function(o){if(1===o.data.code){var n=o.data.data;sessionStorage.setItem("user",JSON.stringify(n)),console.log(n),i(function(){t.history.back()})}else 0===o.data.code&&(e.modalText=o.data.reason,$(".prompt-container").show().fadeOut(2e3))},function(e){})}}}]);
...
index.controller("holidayCtrl",["$scope","$http","$window","$location","$rootScope",function(a,t,e,i,o){a.activeTab=1,o.activeTabMorn&&(a.activeTab=o.activeTabMorn),a.changeTab=function(t){switch(a.activeTab=t,t){case 1:o.activeTabMorn=1;break;case 2:o.activeTabMorn=2}},a.useMornTemplate=function(a){i.path("holidayList/"+a)},a.useNightTemplate=function(a){i.path("greetList/"+a)}}]);
...
index.controller("jokeshowCtrl",["$scope","$http","$window","$location","$rootScope",function(o,t,e,n,c){o.useTemplate=function(o){n.path("jokeList/"+o)}}]);
