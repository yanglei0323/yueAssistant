...
index.controller("noticeCtrl",["$scope","$http","$window","$location","$rootScope",function(t,e,a,c,i){t.activeTab=1,i.activeTabMorn&&(t.activeTab=i.activeTabMorn),t.changeTab=function(e){switch(t.activeTab=e,e){case 1:i.activeTabMorn=1;break;case 2:i.activeTabMorn=2}},t.useMornTemplate=function(t){c.path("noticeList/"+t)},t.useNightTemplate=function(t){c.path("useActive/"+t)}}]);
