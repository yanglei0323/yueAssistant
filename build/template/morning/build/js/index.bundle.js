...
/***/ function(module, exports, __webpack_require__) {
	...
	Zepto(function() {
        ...
        $('#word').data("src",'../../../assets/images/morning/type'+type+'/img_'+imgNum+'.png');
        startLoading();
        var wordimg  = new Image();
        wordimg.src = '../../../assets/images/morning/type'+type+'/img_'+imgNum+'.png';
	    ...
	    $('#btnGenerate').on('touchstart', function() {
	    	if(!startLoading()) {
	            return;
	        }
	        $first.hide();
	...
	function generatePoster() {
	    ...
	    qrcodeImg.onload=function(){
		    if (navigator.userAgent.match(/iphone/i)) {
            	if(type == 1){
	            	//读取用户的文本
		            ctx.font = "normal bold "+36/750*canvasWidth+"px myFirstFont";
		            //设置用户文本填充颜色
		            ctx.fillStyle = "black";
		            ctx.textAlign="right";
		            //从坐标点(50,50)开始绘制文字
		            ...
		            ctx.fillText("BY"+user.name,text11X,text11Y);
	            }else if(type == 2){
	            	//读取用户的文本
		            ctx.font = "normal bold "+30/750*canvasWidth+"px myFirstFont";
		            //设置用户文本填充颜色
		            ctx.fillStyle = "black";
		            //从坐标点(50,50)开始绘制文字
		            ...
		            ctx.fillText("BY"+user.name,text22X,text22Y);
		            //设置时间填充颜色
		            // mainCtx.font = "small-caps bold 0.24rem STXinwei";
		            ctx.fillText(date,text22X,text22Yy);
	            }else if(type == 3){
	            	//读取用户的文本
		            ctx.font = "normal bold "+100/750*canvasWidth+"px myFirstFont";
		            //设置用户文本填充颜色
		            ctx.fillStyle = "white";
		            //从坐标点(50,50)开始绘制文字
		            ...
		            ctx.fillText(mydate.getDate(),text33X,text33Y);
		            //设置时间填充颜色
		            ctx.font = "normal bold "+30/750*canvasWidth+"px myFirstFont";
		            ctx.fillText(mm+'.'+week,text33X,text33Yy);
		            ctx.fillText("BY"+user.name,text33X,text33Yyy);
	            }else if(type == 4){
	            	//读取用户的文本
		            ctx.font = "normal bold "+34/750*canvasWidth+"px myFirstFont";
		            //设置用户文本填充颜色
		            ctx.fillStyle = "black";
		            ctx.textAlign="right"; 
		            //从坐标点(50,50)开始绘制文字
		            ...
		            ctx.fillText(date,text44X,text44Y);
		            //设置时间填充颜色
		            // mainCtx.font = "small-caps bold 0.4rem STXinwei";
		            ctx.fillText(week,text44X,text44Yy);
		            ctx.fillText("BY"+user.name,text44X,text44Yyy);
	            }else if(type == 5){
	            	//读取用户的文本
		            ctx.font = "normal bold "+34/750*canvasWidth+"px myFirstFont";
		            //设置用户文本填充颜色
		            ctx.fillStyle = "#7a8776";
		            ctx.textAlign="right"; 
		            //从坐标点(50,50)开始绘制文字
		            var text55X=Math.floor(clientWidth*0.933);
		            var text55Y=Math.floor(canvasHeight*0.736);
		            ctx.fillText("BY"+user.name,text55X,text55Y);
		            //设置时间填充颜色
	            }else if(type == 6){
	            	//读取用户的文本
		            ctx.font = "normal bold "+34/750*canvasWidth+"px myFirstFont";
		            ...
		            ctx.fillText("BY"+user.name,text66X,text66Y);
		            //设置时间填充颜色
	            }else if(type == 7){
	            	//读取用户的文本
		            ctx.font = "normal bold "+30/750*canvasWidth+"px myFirstFont";
		            ...
		            ctx.fillText(date,text77X,text77Y);
		            ctx.fillText(week,text77X,text77Yy);
		            ctx.fillText("BY"+user.name,text77X,text77Yyy);
	            }else if(type == 8){
	            	//读取用户的文本
	            	ctx.font = "normal bold "+100/750*canvasWidth+"px myFirstFont";
		            //设置用户文本填充颜色
		            ctx.fillStyle = "#96bfad";
		            //从坐标点(50,50)开始绘制文字
		            ...
		            ctx.fillText(mydate.getDate(),text88X,text88Y);
		            ctx.font = "normal bold "+30/750*canvasWidth+"px myFirstFont";
		            ctx.fillText(week,text88X,text88Yy);
		            ctx.fillText("BY"+user.name,text88X,text88Yyy);
	            }
        	}else{
        		if(type == 1){
	            	//读取用户的文本
		            ctx.font = "normal bold 0.48rem myFirstFont";
		            //设置用户文本填充颜色
		            ctx.fillStyle = "black";
		            //从坐标点(50,50)开始绘制文字
		            var text1X=Math.floor(clientWidth*0.544);
		            var text1Y=Math.floor(canvasHeight*0.95);
		            ctx.fillText("BY"+user.name,text1X,text1Y);
	            }else if(type == 2){
	            	//读取用户的文本
		            ctx.font = "normal bold 0.4rem myFirstFont";
		            //设置用户文本填充颜色
		            ctx.fillStyle = "black";
		            //从坐标点(50,50)开始绘制文字
		            ...
		            ctx.fillText("BY"+user.name,text2X,text2Y);
		            //设置时间填充颜色
		            // mainCtx.font = "small-caps bold 0.24rem STXinwei";
		            ctx.fillText(date,text2X,text2Yy);
	            }else if(type == 3){
	            	//读取用户的文本
		            ctx.font = "normal bold 1.333333rem myFirstFont";
		            //设置用户文本填充颜色
		            ctx.fillStyle = "white";
		            //从坐标点(50,50)开始绘制文字
		            ...
		            ctx.fillText(mydate.getDate(),text3X,text3Y);
		            //设置时间填充颜色
		            ctx.font = "normal bold 0.4rem myFirstFont";
		            ctx.fillText(mm+'.'+week,text3X,text3Yy);
		            ctx.fillText("BY"+user.name,text3X,text3Yyy);
	            }else if(type == 4){
	            	//读取用户的文本
		            ctx.font = "normal bold 0.453333rem myFirstFont";
		            //设置用户文本填充颜色
		            ctx.fillStyle = "black";
		            ctx.textAlign="right"; 
		            //从坐标点(50,50)开始绘制文字
		            ...
		            ctx.fillText(date,text4X,text4Y);
		            //设置时间填充颜色
		            // mainCtx.font = "small-caps bold 0.4rem STXinwei";
		            ctx.fillText(week,text4X,text4Yy);
		            ctx.fillText("BY"+user.name,text4X,text4Yyy);
	            }else if(type == 5){
	            	//读取用户的文本
		            ctx.font = "normal bold 0.453333rem myFirstFont";
		            //设置用户文本填充颜色
		            ...
		            ctx.fillText("BY"+user.name,text5X,text5Y);
		            //设置时间填充颜色
	            }else if(type == 6){
	            	//读取用户的文本
		            ctx.font = "normal bold 0.46rem myFirstFont";
		            //设置用户文本填充颜色
		            ctx.fillStyle = "#fff";
		            //从坐标点(50,50)开始绘制文字
		            var text6X=Math.floor(clientWidth*0.047);
		            var text6Y=Math.floor(canvasHeight*0.915);
		            ctx.fillText("BY"+user.name,text6X,text6Y);
		            //设置时间填充颜色
	            }else if(type == 7){
	            	//读取用户的文本
		            ctx.font = "normal bold 0.4rem myFirstFont";
		            ...
		            ctx.fillText(date,text7X,text7Y);
		            ctx.fillText(week,text7X,text7Yy);
		            ctx.fillText("BY"+user.name,text7X,text7Yyy);
	            }else if(type == 8){
	            	//读取用户的文本
	            	ctx.font = "normal bold 1.333333rem myFirstFont";
		            //设置用户文本填充颜色
		            ...
		            ctx.fillText(mydate.getDate(),text8X,text8Y);
		            ctx.font = "normal bold 0.4rem myFirstFont";
		            ctx.fillText(week,text8X,text8Yy);
		            ctx.fillText("BY"+user.name,text8X,text8Yyy);
	            }
        	}
